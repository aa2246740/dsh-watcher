window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dshx-css-module:/agent/repos/dsh-watcher/src/client/Watcher.module.css.mjs
		const css$2 = ".qzKc3a_root{--watcher-panel-max-height:min(680px, calc(100vh - 112px));--watcher-motion-fast:.14s;--watcher-motion-panel:.18s;--watcher-motion-inspector:.2s;--watcher-motion-content-out:.12s;--watcher-ease-out:cubic-bezier(.2, .8, .2, 1);--watcher-ease-glide:cubic-bezier(.22, .61, .36, 1);position:relative}.qzKc3a_trigger{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:32px;height:32px;color:var(--dsw-alias-label-primary);cursor:pointer;transition:background-color var(--watcher-motion-fast) ease, border-color var(--watcher-motion-fast) ease, color var(--watcher-motion-fast) ease, transform .1s ease;background:0 0;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.qzKc3a_trigger:hover:not(:disabled),.qzKc3a_trigger:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_trigger:active{transform:scale(.96)}.qzKc3a_trigger:focus-visible{outline:2px solid var(--dsw-static-deepseek-450);outline-offset:2px}.qzKc3a_trigger[data-open]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-static-deepseek-450)}.qzKc3a_trigger[data-live]{color:var(--dsw-static-deepseek-450)}.qzKc3a_trigger[data-alert]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_eye,.qzKc3a_eyeBlink,.qzKc3a_eyePupil{transform-box:fill-box;transform-origin:50%;display:block}.qzKc3a_trigger[data-live] .qzKc3a_eyePupil{animation:qzKc3a_watcher-eye-scan 2.8s var(--watcher-ease-out) infinite}.qzKc3a_trigger[data-live] .qzKc3a_eyeBlink{animation:5.2s ease-in-out infinite qzKc3a_watcher-eye-blink}@keyframes qzKc3a_watcher-eye-scan{0%,12%,92%,to{transform:translate(0)}30%{transform:translate(1.35px)}54%{transform:translate(-1.2px)}74%{transform:translate(.8px)}}@keyframes qzKc3a_watcher-eye-blink{0%,42%,44.5%,to{transform:scaleY(1)}43.2%{transform:scaleY(.12)}}.qzKc3a_menu{z-index:1100;--watcher-panel-max-height:min(680px, calc(100vh - 24px));--watcher-motion-fast:.14s;--watcher-motion-panel:.18s;--watcher-motion-inspector:.2s;--watcher-motion-content-out:.12s;--watcher-ease-out:cubic-bezier(.2, .8, .2, 1);--watcher-ease-glide:cubic-bezier(.22, .61, .36, 1);box-sizing:border-box;max-width:calc(100vw - 24px);max-height:var(--watcher-panel-max-height);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);transform-origin:100% 0;animation:qzKc3a_watcher-panel-enter var(--watcher-motion-panel) var(--watcher-ease-out);isolation:isolate;border-radius:12px;align-items:stretch;font-size:13px;line-height:20px;display:flex;position:fixed;top:auto;left:auto;right:auto;overflow:hidden}.qzKc3a_menu[data-sized]{max-width:none}.qzKc3a_menu[data-sized] .qzKc3a_workPicture{flex:auto;width:auto;min-height:0;max-height:none}.qzKc3a_resizeEdgeRight,.qzKc3a_resizeEdgeBottom,.qzKc3a_resizeGrip{z-index:5;touch-action:none;position:absolute}.qzKc3a_resizeEdgeRight{cursor:ew-resize;width:8px;top:0;bottom:0;right:0}.qzKc3a_resizeEdgeBottom{cursor:ns-resize;height:8px;bottom:0;left:0;right:0}.qzKc3a_resizeGrip{cursor:nwse-resize;border-right:2px solid var(--dsw-alias-border-l2);border-bottom:2px solid var(--dsw-alias-border-l2);opacity:.55;border-bottom-right-radius:4px;width:14px;height:14px;transition:opacity .12s;bottom:3px;right:3px}.qzKc3a_resizeGrip:hover{opacity:1;border-color:var(--dsw-alias-label-secondary)}@keyframes qzKc3a_watcher-panel-enter{0%{opacity:0;transform:translateY(-5px)scale(.992)}to{opacity:1;transform:translateY(0)scale(1)}}.qzKc3a_workPicture{width:min(720px,100vw - 32px);min-width:0;min-height:290px;max-height:var(--watcher-panel-max-height);background:var(--dsw-specific-menu);flex-direction:column;flex:none;display:flex}.qzKc3a_pictureHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:flex-start;gap:12px;padding:16px 14px 14px 16px;display:flex}.qzKc3a_nowBlock{min-width:0}.qzKc3a_eyebrow{color:var(--dsw-static-deepseek-450);text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:5px;font-size:12px;font-weight:500;line-height:18px;display:flex;overflow:hidden}.qzKc3a_eyebrow[data-alert]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_now{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin-top:2px;font-size:17px;font-weight:600;line-height:24px;overflow:hidden}.qzKc3a_summary{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;align-items:center;margin-top:4px;font-size:12px;line-height:18px;display:flex}.qzKc3a_summary span+span:before{content:\"·\";color:var(--dsw-alias-label-dimmed);margin:0 6px}.qzKc3a_summary [data-partial]{color:var(--dsw-alias-state-warn-primary)}.qzKc3a_loadAllInlineBtn{background:var(--dsw-specific-menu);color:var(--dsw-static-deepseek-450);cursor:pointer;border:1px solid #4d6bfe66;border-radius:4px;align-items:center;margin-left:6px;padding:1px 7px;font-size:11px;font-weight:500;line-height:16px;transition:all .12s;display:inline-flex}.qzKc3a_loadAllInlineBtn:hover{background:var(--dsw-static-deepseek-450);color:#fff}.qzKc3a_sessionTiming{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex:none;grid-template-columns:repeat(3,minmax(0,1fr));margin:0;padding:9px 10px;display:grid}.qzKc3a_sessionTimingMetric{min-width:0;padding:0 8px}.qzKc3a_sessionTimingMetric+.qzKc3a_sessionTimingMetric{border-left:1px solid var(--dsw-alias-border-l2)}.qzKc3a_sessionTimingMetric dt,.qzKc3a_sessionTimingMetric dd{text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.qzKc3a_sessionTimingMetric dt{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.qzKc3a_sessionTimingMetric dd{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;line-height:19px}.qzKc3a_viewToolbar{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);flex-wrap:wrap;flex:none;justify-content:space-between;align-items:center;gap:6px 14px;min-height:42px;padding:6px 14px;display:flex}.qzKc3a_viewControl{align-items:center;gap:6px;min-width:0;display:flex}.qzKc3a_viewToolbarLabel{color:var(--dsw-alias-label-tertiary);white-space:nowrap;font-size:12px;line-height:18px}.qzKc3a_viewMode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:7px;flex:none;grid-template-columns:repeat(2,minmax(42px,1fr));padding:2px;display:inline-grid}.qzKc3a_viewMode button{min-height:26px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:5px;padding:2px 9px;font-size:12px;line-height:18px}.qzKc3a_viewMode button:hover{color:var(--dsw-alias-label-primary)}.qzKc3a_viewMode button[data-active]{background:var(--dsw-specific-menu);box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);font-weight:600}.qzKc3a_historyNotice{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex:none;align-items:center;gap:10px;min-height:48px;padding:7px 14px 8px 16px;display:flex}.qzKc3a_historyNoticeCopy{flex-direction:column;flex:1;min-width:0;display:flex}.qzKc3a_historyNoticeCopy strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;line-height:18px;overflow:hidden}.qzKc3a_historyNoticeCopy span{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:16px;overflow:hidden}.qzKc3a_historyNotice button{border:1px solid var(--dsw-alias-button-ghost-active-border);background:var(--dsw-specific-menu);min-height:28px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:7px;flex:none;padding:3px 9px;font-size:12px;line-height:18px}.qzKc3a_historyNotice button:hover:not(:disabled){background:var(--dsw-alias-button-ghost-active-hover)}.qzKc3a_historyNotice button:disabled{color:var(--dsw-alias-label-tertiary);cursor:progress}.qzKc3a_follow{white-space:nowrap;flex:none;margin-top:2px}.qzKc3a_unread{border:1px solid var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);width:calc(100% - 28px);min-height:34px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:8px;justify-content:center;align-items:center;gap:6px;margin:10px 14px 0;font-size:12px;display:inline-flex}.qzKc3a_unread:hover{background:var(--dsw-alias-button-ghost-active-hover)}.qzKc3a_unread:focus-visible,.qzKc3a_turnToggle:focus-visible,.qzKc3a_phaseToggle:focus-visible,.qzKc3a_stepToggle:focus-visible,.qzKc3a_analysisClusterToggle:focus-visible,.qzKc3a_modelStageToggle:focus-visible,.qzKc3a_reasoningToggle:focus-visible,.qzKc3a_groupedModelToggle:focus-visible,.qzKc3a_viewMode button:focus-visible,.qzKc3a_historyNotice button:focus-visible,.qzKc3a_overviewOccurrence:focus-visible,.qzKc3a_inspectorBack:focus-visible,.qzKc3a_occurrence:focus-visible,.qzKc3a_tab:focus-visible,.qzKc3a_copyRaw:focus-visible{outline:2px solid var(--dsw-static-deepseek-450);outline-offset:-2px}.qzKc3a_railViewport{overscroll-behavior:contain;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex:1;min-height:0;overflow:auto}.qzKc3a_turns{padding:8px 10px 18px}.qzKc3a_turn+.qzKc3a_turn{border-top:1px solid var(--dsw-alias-border-l2);margin-top:12px;padding-top:12px}.qzKc3a_turnHeader{padding:0 2px 2px}.qzKc3a_turnHeader h2{margin:0}.qzKc3a_turnToggle{box-sizing:border-box;width:100%;min-height:50px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:14px minmax(0,1fr) auto;align-items:center;gap:7px;padding:6px 8px;display:grid}.qzKc3a_turnToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_turnChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out);transform:rotate(0)}.qzKc3a_turnToggle[aria-expanded=true] .qzKc3a_turnChevron{transform:rotate(90deg)}.qzKc3a_turnCopy{flex-direction:column;min-width:0;display:flex}.qzKc3a_turnTitleLine{align-items:center;gap:6px;min-width:0;display:flex}.qzKc3a_turnTitle{color:var(--dsw-alias-label-secondary);font-size:13px;font-weight:600;line-height:20px}.qzKc3a_turnSummary,.qzKc3a_turnDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:400;line-height:18px}.qzKc3a_turnSummary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.qzKc3a_turnPerformance{white-space:nowrap;flex-direction:column;align-items:flex-end;min-width:62px;display:flex}.qzKc3a_turnDuration{white-space:nowrap}.qzKc3a_turnSpeed{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:500;line-height:18px}.qzKc3a_turnBody[hidden]{display:none}.qzKc3a_groupRail{padding-left:18px;position:relative}.qzKc3a_railLine{background:var(--dsw-alias-border-l2);pointer-events:none;width:1px;position:absolute;top:18px;bottom:18px;left:23px}.qzKc3a_phase{z-index:1;box-sizing:border-box;width:100%;padding:3px 0 11px;position:relative}.qzKc3a_phase+.qzKc3a_phase{margin-top:4px}.qzKc3a_phaseHeader{position:relative}.qzKc3a_phaseToggle{box-sizing:border-box;width:100%;min-height:42px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:7px;grid-template-columns:10px 12px minmax(0,1fr);align-items:center;gap:6px;padding:3px 8px 3px 0;display:grid;position:relative}.qzKc3a_phaseToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_phase[data-now]>.qzKc3a_phaseHeader .qzKc3a_phaseToggle{background:var(--dsw-alias-bg-layer-2);border-radius:7px}.qzKc3a_phaseChevron,.qzKc3a_stepChevron,.qzKc3a_analysisClusterChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out);transform:rotate(0)}.qzKc3a_phaseToggle[aria-expanded=true] .qzKc3a_phaseChevron,.qzKc3a_stepToggle[aria-expanded=true] .qzKc3a_stepChevron,.qzKc3a_analysisClusterToggle[aria-expanded=true] .qzKc3a_analysisClusterChevron{transform:rotate(90deg)}.qzKc3a_phaseMarker{box-sizing:border-box;background:var(--dsw-alias-label-tertiary);width:10px;height:10px;box-shadow:0 0 0 4px var(--dsw-specific-menu);border-radius:50%;display:block;position:relative}.qzKc3a_phaseMarker[data-state=active],.qzKc3a_phaseMarker[data-state=current]{background:var(--dsw-static-deepseek-450)}.qzKc3a_phaseMarker[data-state=waiting]{background:var(--dsw-alias-state-warn-primary)}.qzKc3a_phaseMarker[data-state=failure],.qzKc3a_phaseMarker[data-state=interrupted]{background:var(--dsw-alias-state-error-primary)}.qzKc3a_phaseMarker[data-state=partial]{border:1px dashed var(--dsw-alias-label-tertiary);background:var(--dsw-specific-menu)}.qzKc3a_neutralDot{border:1px solid var(--dsw-alias-label-tertiary);background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:10px;height:10px;display:inline-block;position:relative}.qzKc3a_neutralDot[data-status=unknown]{background:var(--dsw-specific-menu);border-style:dashed}.qzKc3a_phaseCopy,.qzKc3a_occurrenceCopy{flex-direction:column;min-width:0;display:flex}.qzKc3a_phaseTitleLine{align-items:center;gap:6px;min-width:0;display:flex}.qzKc3a_phaseTitle{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:550;line-height:21px;overflow:hidden}.qzKc3a_phaseMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;margin-top:1px;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_groupBadges{flex:none;align-items:center;gap:4px;display:inline-flex}.qzKc3a_groupBadges span,.qzKc3a_overviewTag,.qzKc3a_patternLabel,.qzKc3a_parallelLabel{border:1px solid var(--dsw-alias-border-l2);min-height:18px;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:999px;align-items:center;padding:0 5px;font-size:11px;font-weight:500;line-height:16px;display:inline-flex}.qzKc3a_groupBadges [data-kind=retry]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_groupBadges [data-kind=parallel],.qzKc3a_overviewTag[data-state=active],.qzKc3a_overviewTag[data-state=current]{color:var(--dsw-static-deepseek-450)}.qzKc3a_overviewTag[data-state=waiting]{color:var(--dsw-alias-state-warn-primary)}.qzKc3a_overviewTag[data-state=failure],.qzKc3a_overviewTag[data-state=interrupted]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_overviewTag[data-state=partial]{color:var(--dsw-alias-label-tertiary)}.qzKc3a_occurrenceChevron{color:var(--dsw-alias-label-dimmed);opacity:0;transition:opacity var(--watcher-motion-fast) ease, transform var(--watcher-motion-fast) ease;flex:none;transform:translate(-2px)}.qzKc3a_occurrence:hover .qzKc3a_occurrenceChevron,.qzKc3a_occurrence[data-selected] .qzKc3a_occurrenceChevron,.qzKc3a_occurrence:focus-visible .qzKc3a_occurrenceChevron{opacity:1;transform:translate(0)}.qzKc3a_stepTimeline{border-left:1px solid var(--dsw-alias-border-l2);margin:1px 8px 0 28px;padding-left:11px;position:relative}.qzKc3a_overviewStep{min-width:0;position:relative}.qzKc3a_overviewStep+.qzKc3a_overviewStep{margin-top:10px;padding-top:8px}.qzKc3a_overviewStep:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:13px;left:-12px}.qzKc3a_overviewStepHeader{min-height:29px}.qzKc3a_stepToggle{box-sizing:border-box;width:100%;min-height:29px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:6px;grid-template-columns:12px minmax(0,1fr) auto;align-items:center;gap:5px;padding:2px 4px 2px 0;display:grid}.qzKc3a_stepToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_overviewStepLabel,.qzKc3a_overviewStepSignals{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.qzKc3a_overviewStepLabel{min-width:0;font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.qzKc3a_overviewStepSignals{white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.qzKc3a_overviewOccurrences{position:relative}.qzKc3a_overviewStep[data-parallel] .qzKc3a_overviewOccurrences{border-left:1px solid var(--dsw-static-deepseek-450);padding-left:5px}.qzKc3a_modelStage{border-left:2px solid var(--dsw-static-deepseek-450);background:var(--dsw-alias-bg-layer-2);border-radius:0 7px 7px 0;min-width:0;margin:2px 2px 7px;overflow:hidden}.qzKc3a_modelStage[data-live]{box-shadow:inset 0 0 0 1px var(--dsw-alias-button-ghost-active-border)}.qzKc3a_modelStageToggle{box-sizing:border-box;width:100%;min-height:42px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px 8px minmax(0,1fr);align-items:center;gap:7px;padding:5px 9px 5px 7px;display:grid}.qzKc3a_modelStageToggle:hover,.qzKc3a_reasoningToggle:hover,.qzKc3a_groupedModelToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_modelStageChevron,.qzKc3a_reasoningChevron,.qzKc3a_groupedModelChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out)}.qzKc3a_modelStageToggle[aria-expanded=true] .qzKc3a_modelStageChevron,.qzKc3a_reasoningToggle[aria-expanded=true] .qzKc3a_reasoningChevron,.qzKc3a_groupedModelToggle[aria-expanded=true] .qzKc3a_groupedModelChevron{transform:rotate(90deg)}.qzKc3a_modelStageGlyph{background:var(--dsw-static-deepseek-450);width:7px;height:7px;box-shadow:0 0 0 3px var(--dsw-alias-button-ghost-active-fill);border-radius:999px}.qzKc3a_modelStageCopy{grid-template-columns:auto minmax(0,1fr);align-items:baseline;gap:8px;min-width:0;display:grid}.qzKc3a_modelStageTitle{color:var(--dsw-alias-label-primary);white-space:nowrap;font-size:13px;font-weight:600;line-height:20px}.qzKc3a_modelStageSummary{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_modelStageBody{padding:2px 10px 10px 20px}.qzKc3a_modelStageBar{background:var(--dsw-alias-border-l2);border-radius:999px;gap:2px;height:5px;margin:2px 0 10px;display:flex;overflow:hidden}.qzKc3a_modelStageBar>span{border-radius:inherit;min-width:3px}.qzKc3a_modelStageBar [data-segment=wait],.qzKc3a_modelStageSwatch[data-segment=wait]{background:var(--dsw-alias-label-dimmed)}.qzKc3a_modelStageBar [data-segment=reasoning],.qzKc3a_modelStageSwatch[data-segment=reasoning]{background:var(--dsw-static-deepseek-450)}.qzKc3a_modelStageBar [data-segment=output],.qzKc3a_modelStageSwatch[data-segment=output]{background:var(--dsw-alias-label-secondary)}.qzKc3a_modelStageBar [data-segment=unattributed],.qzKc3a_modelStageSwatch[data-segment=unattributed]{background:var(--dsw-alias-state-warn-primary)}.qzKc3a_modelStageLedger{grid-template-columns:minmax(0,1fr);gap:5px 12px;margin:0;display:grid}.qzKc3a_modelStageMetric{min-width:0;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;justify-content:space-between;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.qzKc3a_modelStageMetric dt,.qzKc3a_modelStageMetric dd{margin:0}.qzKc3a_modelStageMetric dt{align-items:center;gap:6px;min-width:0;display:inline-flex}.qzKc3a_modelStageMetric dd{color:var(--dsw-alias-label-secondary);text-align:right;flex:none}.qzKc3a_modelStageSwatch{border-radius:999px;flex:none;width:6px;height:6px}.qzKc3a_modelStageNote{color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:12px;line-height:18px}.qzKc3a_reasoningAttempts{border-top:1px solid var(--dsw-alias-border-l2);margin-top:8px;padding-top:1px}.qzKc3a_reasoningDisclosure{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:6px;min-width:0;margin-top:5px;overflow:hidden}.qzKc3a_reasoningToggle{box-sizing:border-box;width:100%;min-height:34px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px minmax(0,1fr);align-items:center;gap:6px;padding:5px 8px;display:grid}.qzKc3a_reasoningLabel{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:550;line-height:20px}.qzKc3a_reasoningMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-align:left;white-space:normal;grid-column:2;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_reasoningBody{box-sizing:border-box;border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);max-height:320px;color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);margin:0;padding:10px 12px;font-size:13px;line-height:1.6;overflow:auto}.qzKc3a_reasoningBody>*{margin-top:0;margin-bottom:8px}.qzKc3a_reasoningBody>:last-child{margin-bottom:0}.qzKc3a_reasoningBody .md-code-block{max-width:100%}.qzKc3a_groupedModelStages{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:7px;margin-bottom:9px;position:relative;overflow:hidden}.qzKc3a_groupedModelStages:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:20px;left:-12px}.qzKc3a_groupedModelToggle{box-sizing:border-box;width:100%;min-height:44px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px minmax(0,1fr);align-items:center;gap:7px;padding:5px 9px;display:grid}.qzKc3a_groupedModelToggle>span{justify-content:space-between;align-items:baseline;gap:10px;min-width:0;display:flex}.qzKc3a_groupedModelToggle strong{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.qzKc3a_groupedModelToggle small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_groupedModelList{border-top:1px solid var(--dsw-alias-border-l2);padding:0 7px 8px 22px}.qzKc3a_groupedModelStep{min-width:0;padding-top:8px}.qzKc3a_groupedModelStep+.qzKc3a_groupedModelStep{border-top:1px solid var(--dsw-alias-border-l2)}.qzKc3a_groupedModelStepLabel{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);margin:0 2px 4px;font-size:12px;line-height:18px;display:block}.qzKc3a_analysisClusters{border-left:1px solid var(--dsw-alias-border-l2);margin:1px 8px 0 28px;padding-left:11px;position:relative}.qzKc3a_analysisCluster,.qzKc3a_analysisSingleton{min-width:0;position:relative}.qzKc3a_analysisCluster+.qzKc3a_analysisCluster,.qzKc3a_analysisCluster+.qzKc3a_analysisSingleton,.qzKc3a_analysisSingleton+.qzKc3a_analysisCluster,.qzKc3a_analysisSingleton+.qzKc3a_analysisSingleton{margin-top:6px}.qzKc3a_analysisCluster:before,.qzKc3a_analysisSingleton:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:20px;left:-12px}.qzKc3a_analysisClusterToggle{box-sizing:border-box;width:100%;min-height:46px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;grid-template-columns:12px 10px minmax(0,1fr) auto;align-items:center;gap:7px;padding:5px 6px 5px 4px;display:grid}.qzKc3a_analysisClusterToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_analysisCluster[data-open]>.qzKc3a_analysisClusterToggle{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2)}.qzKc3a_analysisClusterDotSlot{width:10px;height:10px;display:block;position:relative}.qzKc3a_analysisClusterDot{inset:0;position:absolute!important}.qzKc3a_analysisClusterCopy{flex-direction:column;min-width:0;display:flex}.qzKc3a_analysisClusterTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:550;line-height:20px;overflow:hidden}.qzKc3a_analysisClusterMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_analysisClusterCount{min-width:28px;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;font-size:12px;font-weight:600;line-height:18px}.qzKc3a_analysisClusterItems{border-left:1px solid var(--dsw-alias-border-l2);margin:3px 0 8px 17px;padding-left:5px}.qzKc3a_overviewOccurrence{box-sizing:border-box;width:100%;min-height:45px;color:inherit;font:inherit;text-align:left;cursor:pointer;transition:background-color var(--watcher-motion-fast) var(--watcher-ease-out), border-color var(--watcher-motion-fast) var(--watcher-ease-out), box-shadow var(--watcher-motion-fast) var(--watcher-ease-out);animation:qzKc3a_watcher-live-append var(--watcher-motion-fast) var(--watcher-ease-out);background:0 0;border:1px solid #0000;border-radius:7px;grid-template-columns:22px 10px minmax(0,1fr) auto 12px;align-items:center;gap:7px;padding:5px 5px 5px 7px;display:grid;position:relative}.qzKc3a_overviewOccurrence+.qzKc3a_overviewOccurrence{margin-top:2px}.qzKc3a_overviewOccurrence:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_overviewOccurrence[data-current]:not([data-selected]){background:var(--dsw-alias-bg-layer-2)}.qzKc3a_overviewOccurrence[data-selected]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);box-shadow:inset 2px 0 0 var(--dsw-static-deepseek-450)}.qzKc3a_overviewOccurrenceIndex{color:var(--dsw-alias-label-dimmed);font-family:var(--dsw-font-mono);font-variant-numeric:tabular-nums;text-align:right;font-size:11px;line-height:18px}.qzKc3a_overviewOccurrenceDotSlot{width:10px;height:10px;display:block;position:relative}.qzKc3a_overviewOccurrenceDot{inset:0;position:absolute!important}.qzKc3a_overviewOccurrenceCopy{flex-direction:column;min-width:0;display:flex}.qzKc3a_overviewOccurrenceTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:550;line-height:20px;overflow:hidden}.qzKc3a_overviewOccurrenceMeta{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_overviewOccurrenceDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:12px;line-height:18px}.qzKc3a_overviewOccurrenceChevron{color:var(--dsw-alias-label-dimmed);opacity:0;transition:opacity var(--watcher-motion-fast) ease, transform var(--watcher-motion-fast) ease;transform:translate(-2px)}.qzKc3a_overviewOccurrence:hover .qzKc3a_overviewOccurrenceChevron,.qzKc3a_overviewOccurrence[data-selected] .qzKc3a_overviewOccurrenceChevron,.qzKc3a_overviewOccurrence:focus-visible .qzKc3a_overviewOccurrenceChevron{opacity:1;transform:translate(0)}@keyframes qzKc3a_watcher-live-append{0%{opacity:.5;transform:translateY(-2px)}to{opacity:1;transform:translateY(0)}}.qzKc3a_empty{min-height:250px;color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;padding:28px;display:flex}.qzKc3a_emptyEye{color:var(--dsw-alias-label-secondary);margin-bottom:12px;display:inline-flex}.qzKc3a_empty strong{color:var(--dsw-alias-label-secondary);font-size:14px;font-weight:600;line-height:21px}.qzKc3a_empty>span:last-child{margin-top:4px;font-size:12px;line-height:18px}.qzKc3a_inspector{width:438px;min-width:0;max-height:var(--watcher-panel-max-height);border-right:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;display:flex}@media (width>=861px){.qzKc3a_inspector{animation:qzKc3a_watcher-inspector-enter var(--watcher-motion-inspector) var(--watcher-ease-glide);overflow:hidden}.qzKc3a_inspector>*{box-sizing:border-box;width:438px;animation:qzKc3a_watcher-inspector-content-in var(--watcher-motion-content-out) var(--watcher-ease-glide) var(--watcher-motion-inspector) both}.qzKc3a_inspector[data-closing]{pointer-events:none;animation:qzKc3a_watcher-inspector-exit var(--watcher-motion-inspector) var(--watcher-ease-glide) var(--watcher-motion-content-out) forwards}.qzKc3a_inspector[data-closing]>*{animation:qzKc3a_watcher-inspector-content-out var(--watcher-motion-content-out) ease-in forwards}}@keyframes qzKc3a_watcher-inspector-enter{0%{width:0}}@keyframes qzKc3a_watcher-inspector-content-in{0%{opacity:0;transform:translate(16px)}}@keyframes qzKc3a_watcher-inspector-content-out{to{opacity:0;transform:translate(16px)}}@keyframes qzKc3a_watcher-inspector-exit{to{width:0}}.qzKc3a_inspectorHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;padding:16px 16px 14px}.qzKc3a_inspectorBack{min-height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:5px;margin:-4px 0 8px -6px;padding:0 7px 0 5px;font-size:12px;display:inline-flex}.qzKc3a_inspectorBack:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_statusLine,.qzKc3a_detailStatus{color:var(--dsw-alias-label-secondary);flex-wrap:wrap;align-items:center;gap:7px;font-size:12px;line-height:18px;display:flex}.qzKc3a_statusLine[data-status=failure],.qzKc3a_statusLine[data-status=interrupted],.qzKc3a_detailStatus[data-status=failure],.qzKc3a_detailStatus[data-status=interrupted]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_statusLine[data-status=running],.qzKc3a_detailStatus[data-status=running]{color:var(--dsw-static-deepseek-450)}.qzKc3a_statusLine[data-status=waiting],.qzKc3a_detailStatus[data-status=waiting]{color:var(--dsw-alias-state-warn-primary)}.qzKc3a_location{min-width:0;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;margin-left:auto}.qzKc3a_inspectorTitle{color:var(--dsw-alias-label-primary);margin:8px 0 0;font-size:18px;font-weight:600;line-height:25px}.qzKc3a_inspectorSummary{color:var(--dsw-alias-label-tertiary);margin:3px 0 0;font-size:12px;line-height:18px}.qzKc3a_groupSignals{flex-wrap:wrap;gap:6px;margin-top:10px;display:flex}.qzKc3a_groupSignals span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px}.qzKc3a_groupSignals span+span:before{content:\"·\";color:var(--dsw-alias-label-dimmed);margin-right:6px}.qzKc3a_groupSignals [data-retry]{color:var(--dsw-alias-state-warn-primary)}.qzKc3a_groupSignals [data-error]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_inspectorBody{overscroll-behavior:contain;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex:1;min-height:0;overflow:auto}.qzKc3a_executionSection{border-bottom:1px solid var(--dsw-alias-border-l2);padding:14px 16px 16px}.qzKc3a_sectionHeading{justify-content:space-between;align-items:center;gap:12px;margin-bottom:8px;display:flex}.qzKc3a_sectionHeading h3{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;font-weight:600;line-height:20px}.qzKc3a_sectionHeading>span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px}.qzKc3a_executionList{max-height:188px;padding-right:2px;overflow:auto}.qzKc3a_stepBlock+.qzKc3a_stepBlock{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:10px}.qzKc3a_stepHeading{min-height:22px;color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);font-variant-numeric:tabular-nums;justify-content:space-between;align-items:center;gap:8px;padding:0 3px;font-size:12px;display:flex}.qzKc3a_stepSignals{align-items:center;gap:6px;min-width:0;display:inline-flex}.qzKc3a_stepDuration{color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-family);font-variant-numeric:tabular-nums;white-space:nowrap}.qzKc3a_parallelLabel{color:var(--dsw-static-deepseek-450);font-family:var(--dsw-font-family)}.qzKc3a_occurrences{margin-top:4px;position:relative}.qzKc3a_stepBlock[data-parallel] .qzKc3a_occurrences{border-left:1px solid var(--dsw-static-deepseek-450);padding-left:10px}.qzKc3a_occurrence{box-sizing:border-box;width:100%;min-height:46px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:8px;grid-template-columns:10px minmax(0,1fr) auto 13px;align-items:center;gap:8px;padding:6px 7px;transition:background-color .14s,border-color .14s;display:grid}.qzKc3a_occurrenceDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:12px;line-height:18px}.qzKc3a_occurrence+.qzKc3a_occurrence{margin-top:2px}.qzKc3a_occurrence:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_occurrence[data-selected]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill)}.qzKc3a_occurrenceTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:550;line-height:19px;overflow:hidden}.qzKc3a_occurrenceMeta{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.qzKc3a_detailSection{padding:16px}.qzKc3a_detailHeader{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:14px;display:grid}.qzKc3a_detailIdentity{min-width:0}.qzKc3a_detailIdentity h3{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);margin:6px 0 0;font-size:16px;font-weight:600;line-height:23px}.qzKc3a_detailIdentity p{overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);margin:3px 0 0;font-size:12px;line-height:18px}.qzKc3a_patternLabel{color:var(--dsw-alias-state-warn-primary)}.qzKc3a_metrics{font-variant-numeric:tabular-nums;grid-template-columns:auto auto;gap:2px 8px;margin:0;font-size:12px;line-height:18px;display:grid}.qzKc3a_metrics dt{color:var(--dsw-alias-label-tertiary)}.qzKc3a_metrics dd{color:var(--dsw-alias-label-secondary);text-align:right;margin:0}.qzKc3a_metrics [data-error]{color:var(--dsw-alias-state-error-primary)}.qzKc3a_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:end;gap:4px;margin-top:16px;display:flex}.qzKc3a_tab{min-width:56px;min-height:36px;color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:0 10px;font-size:13px;position:relative}.qzKc3a_tab:hover{color:var(--dsw-alias-label-primary)}.qzKc3a_tab[data-active]{color:var(--dsw-alias-label-primary);font-weight:600}.qzKc3a_tab[data-active]:after{content:\"\";background:var(--dsw-static-deepseek-450);border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:9px;right:9px}.qzKc3a_tabPanel{--dsl-terminal-font:400 13px/22px var(--dsw-font-mono);min-height:116px;padding-top:12px}.qzKc3a_tabPanel>*{margin-top:0;margin-bottom:0}.qzKc3a_jsonSurface{font-size:13px;overflow:auto}.qzKc3a_jsonSurface [role=tree]{font-size:13px;line-height:20px}.qzKc3a_rawPanel pre{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-mono);tab-size:2;margin:0;font-size:13px;line-height:20px;overflow:auto}.qzKc3a_documentResult{min-width:0;color:var(--dsw-alias-label-primary);padding:2px 2px 8px}.qzKc3a_documentResult .md-code-block{max-width:100%}.qzKc3a_documentResult blockquote{color:var(--dsw-alias-label-secondary)}.qzKc3a_documentResult table{font-variant-numeric:tabular-nums}.qzKc3a_rawPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:8px;overflow:hidden}.qzKc3a_rawToolbar{border-bottom:1px solid var(--dsw-alias-border-l2);min-height:38px;color:var(--dsw-alias-label-tertiary);justify-content:space-between;align-items:center;gap:12px;padding:0 10px 0 12px;font-size:12px;display:flex}.qzKc3a_copyRaw{min-height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:5px;padding:0 6px;font-size:12px;display:inline-flex}.qzKc3a_copyRaw:hover{background:var(--dsw-alias-interactive-bg-hover)}.qzKc3a_rawPanel pre{white-space:pre;max-height:320px;padding:12px}.qzKc3a_artifactResult,.qzKc3a_detailEmpty{border:1px solid var(--dsw-alias-border-l2);min-height:116px;color:var(--dsw-alias-label-tertiary);text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;padding:18px;font-size:13px;display:flex}.qzKc3a_artifactResult strong{color:var(--dsw-alias-label-secondary);margin-top:6px;font-size:14px}.qzKc3a_artifactResult>span{margin-top:2px;font-size:12px}.qzKc3a_artifactResult .qzKc3a_jsonSurface{text-align:left;width:100%;margin-top:12px}.qzKc3a_artifactGlyph{color:var(--dsw-static-deepseek-450);font-size:24px;line-height:28px}.qzKc3a_inspectorFooter{border-top:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);flex:none;padding:9px 16px;font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.qzKc3a_inspector,.qzKc3a_inspector>*{animation:none}.qzKc3a_inspector[data-closing],.qzKc3a_inspector[data-closing]>*{animation-duration:.01ms;animation-delay:0s}.qzKc3a_menu,.qzKc3a_trigger[data-live] .qzKc3a_eyePupil,.qzKc3a_trigger[data-live] .qzKc3a_eyeBlink{animation:none}.qzKc3a_trigger,.qzKc3a_overviewOccurrence,.qzKc3a_turnChevron,.qzKc3a_phaseChevron,.qzKc3a_stepChevron,.qzKc3a_analysisClusterChevron,.qzKc3a_modelStageChevron,.qzKc3a_reasoningChevron,.qzKc3a_groupedModelChevron,.qzKc3a_occurrence,.qzKc3a_overviewOccurrenceChevron,.qzKc3a_occurrenceChevron{transition-duration:.01ms}.qzKc3a_overviewOccurrence{animation:none}.qzKc3a_root [data-state=ongoing] rect,.qzKc3a_menu [data-state=ongoing] rect{opacity:.55;animation:none!important}}@media (width<=860px){.qzKc3a_menu{flex-direction:column-reverse;width:min(720px,100vw - 24px);max-height:calc(100vh - 88px)}.qzKc3a_workPicture{width:auto;min-height:250px;max-height:none}.qzKc3a_menu:not(:has(.qzKc3a_inspector)){height:min(680px,100vh - 88px)}.qzKc3a_menu:not(:has(.qzKc3a_inspector)) .qzKc3a_workPicture{flex:auto}.qzKc3a_inspector{border-right:0;width:auto;max-height:none}.qzKc3a_menu:has(.qzKc3a_inspector){height:min(680px,100vh - 88px)}.qzKc3a_menu:has(.qzKc3a_inspector) .qzKc3a_workPicture{display:none}.qzKc3a_menu:has(.qzKc3a_inspector) .qzKc3a_inspector{flex:auto;min-height:0;max-height:none}.qzKc3a_inspectorBack svg{transform:rotate(180deg)}.qzKc3a_inspectorHeader{padding-top:14px}.qzKc3a_executionList{max-height:150px}}@media (width<=520px){.qzKc3a_menu{width:calc(100vw - 24px)}.qzKc3a_pictureHeader{padding:14px 12px}.qzKc3a_now{font-size:16px}.qzKc3a_turns{padding-inline:6px}.qzKc3a_groupBadges span:nth-child(n+2){display:none}.qzKc3a_inspectorHeader,.qzKc3a_executionSection,.qzKc3a_detailSection{padding-inline:12px}.qzKc3a_detailHeader{grid-template-columns:1fr}.qzKc3a_metrics{grid-template-columns:auto 1fr}.qzKc3a_metrics dd{text-align:left}.qzKc3a_modelStageCopy{grid-template-columns:1fr;gap:0}.qzKc3a_modelStageSummary{white-space:normal}.qzKc3a_modelStageLedger{grid-template-columns:1fr}.qzKc3a_reasoningToggle{grid-template-columns:12px minmax(0,1fr)}.qzKc3a_reasoningMeta{text-align:left;white-space:normal;grid-column:2}.qzKc3a_groupedModelToggle>span{gap:0;display:grid}.qzKc3a_groupedModelToggle small{white-space:normal}.qzKc3a_groupedModelList{padding-left:12px}}";
		...
		var Watcher_module_css_default = {
			"analysisCluster": "qzKc3a_analysisCluster",
			"analysisClusterChevron": "qzKc3a_analysisClusterChevron",
			"analysisClusterCopy": "qzKc3a_analysisClusterCopy",
			"analysisClusterCount": "qzKc3a_analysisClusterCount",
			"analysisClusterDot": "qzKc3a_analysisClusterDot",
			"analysisClusterDotSlot": "qzKc3a_analysisClusterDotSlot",
			"analysisClusterItems": "qzKc3a_analysisClusterItems",
			"analysisClusterMeta": "qzKc3a_analysisClusterMeta",
			"analysisClusters": "qzKc3a_analysisClusters",
			"analysisClusterTitle": "qzKc3a_analysisClusterTitle",
			"analysisClusterToggle": "qzKc3a_analysisClusterToggle",
			"analysisSingleton": "qzKc3a_analysisSingleton",
			"artifactGlyph": "qzKc3a_artifactGlyph",
			"artifactResult": "qzKc3a_artifactResult",
			"copyRaw": "qzKc3a_copyRaw",
			"detailEmpty": "qzKc3a_detailEmpty",
			"detailHeader": "qzKc3a_detailHeader",
			"detailIdentity": "qzKc3a_detailIdentity",
			"detailSection": "qzKc3a_detailSection",
			"detailStatus": "qzKc3a_detailStatus",
			"documentResult": "qzKc3a_documentResult",
			"empty": "qzKc3a_empty",
			"emptyEye": "qzKc3a_emptyEye",
			"executionList": "qzKc3a_executionList",
			"executionSection": "qzKc3a_executionSection",
			"eye": "qzKc3a_eye",
			"eyeBlink": "qzKc3a_eyeBlink",
			"eyebrow": "qzKc3a_eyebrow",
			"eyePupil": "qzKc3a_eyePupil",
			"follow": "qzKc3a_follow",
			"groupBadges": "qzKc3a_groupBadges",
			"groupedModelChevron": "qzKc3a_groupedModelChevron",
			"groupedModelList": "qzKc3a_groupedModelList",
			"groupedModelStages": "qzKc3a_groupedModelStages",
			"groupedModelStep": "qzKc3a_groupedModelStep",
			"groupedModelStepLabel": "qzKc3a_groupedModelStepLabel",
			"groupedModelToggle": "qzKc3a_groupedModelToggle",
			"groupRail": "qzKc3a_groupRail",
			"groupSignals": "qzKc3a_groupSignals",
			"historyNotice": "qzKc3a_historyNotice",
			"historyNoticeCopy": "qzKc3a_historyNoticeCopy",
			"inspector": "qzKc3a_inspector",
			"inspectorBack": "qzKc3a_inspectorBack",
			"inspectorBody": "qzKc3a_inspectorBody",
			"inspectorFooter": "qzKc3a_inspectorFooter",
			"inspectorHeader": "qzKc3a_inspectorHeader",
			"inspectorSummary": "qzKc3a_inspectorSummary",
			"inspectorTitle": "qzKc3a_inspectorTitle",
			"jsonSurface": "qzKc3a_jsonSurface",
			"loadAllInlineBtn": "qzKc3a_loadAllInlineBtn",
			"location": "qzKc3a_location",
			"menu": "qzKc3a_menu",
			"metrics": "qzKc3a_metrics",
			"modelStage": "qzKc3a_modelStage",
			"modelStageBar": "qzKc3a_modelStageBar",
			"modelStageBody": "qzKc3a_modelStageBody",
			"modelStageChevron": "qzKc3a_modelStageChevron",
			"modelStageCopy": "qzKc3a_modelStageCopy",
			"modelStageGlyph": "qzKc3a_modelStageGlyph",
			"modelStageLedger": "qzKc3a_modelStageLedger",
			"modelStageMetric": "qzKc3a_modelStageMetric",
			"modelStageNote": "qzKc3a_modelStageNote",
			"modelStageSummary": "qzKc3a_modelStageSummary",
			"modelStageSwatch": "qzKc3a_modelStageSwatch",
			"modelStageTitle": "qzKc3a_modelStageTitle",
			"modelStageToggle": "qzKc3a_modelStageToggle",
			"neutralDot": "qzKc3a_neutralDot",
			"now": "qzKc3a_now",
			"nowBlock": "qzKc3a_nowBlock",
			"occurrence": "qzKc3a_occurrence",
			"occurrenceChevron": "qzKc3a_occurrenceChevron",
			"occurrenceCopy": "qzKc3a_occurrenceCopy",
			"occurrenceDuration": "qzKc3a_occurrenceDuration",
			"occurrenceMeta": "qzKc3a_occurrenceMeta",
			"occurrences": "qzKc3a_occurrences",
			"occurrenceTitle": "qzKc3a_occurrenceTitle",
			"overviewOccurrence": "qzKc3a_overviewOccurrence",
			"overviewOccurrenceChevron": "qzKc3a_overviewOccurrenceChevron",
			"overviewOccurrenceCopy": "qzKc3a_overviewOccurrenceCopy",
			"overviewOccurrenceDot": "qzKc3a_overviewOccurrenceDot",
			"overviewOccurrenceDotSlot": "qzKc3a_overviewOccurrenceDotSlot",
			"overviewOccurrenceDuration": "qzKc3a_overviewOccurrenceDuration",
			"overviewOccurrenceIndex": "qzKc3a_overviewOccurrenceIndex",
			"overviewOccurrenceMeta": "qzKc3a_overviewOccurrenceMeta",
			"overviewOccurrences": "qzKc3a_overviewOccurrences",
			"overviewOccurrenceTitle": "qzKc3a_overviewOccurrenceTitle",
			"overviewStep": "qzKc3a_overviewStep",
			"overviewStepHeader": "qzKc3a_overviewStepHeader",
			"overviewStepLabel": "qzKc3a_overviewStepLabel",
			"overviewStepSignals": "qzKc3a_overviewStepSignals",
			"overviewTag": "qzKc3a_overviewTag",
			"parallelLabel": "qzKc3a_parallelLabel",
			"patternLabel": "qzKc3a_patternLabel",
			"phase": "qzKc3a_phase",
			"phaseChevron": "qzKc3a_phaseChevron",
			"phaseCopy": "qzKc3a_phaseCopy",
			"phaseHeader": "qzKc3a_phaseHeader",
			"phaseMarker": "qzKc3a_phaseMarker",
			"phaseMeta": "qzKc3a_phaseMeta",
			"phaseTitle": "qzKc3a_phaseTitle",
			"phaseTitleLine": "qzKc3a_phaseTitleLine",
			"phaseToggle": "qzKc3a_phaseToggle",
			"pictureHeader": "qzKc3a_pictureHeader",
			"railLine": "qzKc3a_railLine",
			"railViewport": "qzKc3a_railViewport",
			"rawPanel": "qzKc3a_rawPanel",
			"rawToolbar": "qzKc3a_rawToolbar",
			"reasoningAttempts": "qzKc3a_reasoningAttempts",
			"reasoningBody": "qzKc3a_reasoningBody",
			"reasoningChevron": "qzKc3a_reasoningChevron",
			"reasoningDisclosure": "qzKc3a_reasoningDisclosure",
			"reasoningLabel": "qzKc3a_reasoningLabel",
			"reasoningMeta": "qzKc3a_reasoningMeta",
			"reasoningToggle": "qzKc3a_reasoningToggle",
			"resizeEdgeBottom": "qzKc3a_resizeEdgeBottom",
			"resizeEdgeRight": "qzKc3a_resizeEdgeRight",
			"resizeGrip": "qzKc3a_resizeGrip",
			"root": "qzKc3a_root",
			"sectionHeading": "qzKc3a_sectionHeading",
			"sessionTiming": "qzKc3a_sessionTiming",
			"sessionTimingMetric": "qzKc3a_sessionTimingMetric",
			"statusLine": "qzKc3a_statusLine",
			"stepBlock": "qzKc3a_stepBlock",
			"stepChevron": "qzKc3a_stepChevron",
			"stepDuration": "qzKc3a_stepDuration",
			"stepHeading": "qzKc3a_stepHeading",
			"stepSignals": "qzKc3a_stepSignals",
			"stepTimeline": "qzKc3a_stepTimeline",
			"stepToggle": "qzKc3a_stepToggle",
			"summary": "qzKc3a_summary",
			"tab": "qzKc3a_tab",
			"tabPanel": "qzKc3a_tabPanel",
			"tabs": "qzKc3a_tabs",
			"trigger": "qzKc3a_trigger",
			"turn": "qzKc3a_turn",
			"turnBody": "qzKc3a_turnBody",
			"turnChevron": "qzKc3a_turnChevron",
			"turnCopy": "qzKc3a_turnCopy",
			"turnDuration": "qzKc3a_turnDuration",
			"turnHeader": "qzKc3a_turnHeader",
			"turnPerformance": "qzKc3a_turnPerformance",
			"turns": "qzKc3a_turns",
			"turnSpeed": "qzKc3a_turnSpeed",
			"turnSummary": "qzKc3a_turnSummary",
			"turnTitle": "qzKc3a_turnTitle",
			"turnTitleLine": "qzKc3a_turnTitleLine",
			"turnToggle": "qzKc3a_turnToggle",
			"unread": "qzKc3a_unread",
			"viewControl": "qzKc3a_viewControl",
			"viewMode": "qzKc3a_viewMode",
			"viewToolbar": "qzKc3a_viewToolbar",
			"viewToolbarLabel": "qzKc3a_viewToolbarLabel",
			"watcher-eye-blink": "qzKc3a_watcher-eye-blink",
			"watcher-eye-scan": "qzKc3a_watcher-eye-scan",
			"watcher-inspector-content-in": "qzKc3a_watcher-inspector-content-in",
			"watcher-inspector-content-out": "qzKc3a_watcher-inspector-content-out",
			"watcher-inspector-enter": "qzKc3a_watcher-inspector-enter",
			"watcher-inspector-exit": "qzKc3a_watcher-inspector-exit",
			"watcher-live-append": "qzKc3a_watcher-live-append",
			"watcher-panel-enter": "qzKc3a_watcher-panel-enter",
			"workPicture": "qzKc3a_workPicture"
		};
		//#endregion
		...
		*/
		...
		function localeOf(lang) {
			return String(lang ?? "").trim().toLowerCase().startsWith("en") ? "en" : "zh";
		}
		...
		*/
		const DEFAULT_PRICING_TABLE = Object.freeze({
			currency: "USD",
			unit: PRICING_UNIT,
		...
		function cloneTable(table) {
			const models = {};
			for (const [id, row] of Object.entries(table?.models ?? {})) models[id] = {
				aliases: [...row.aliases ?? []],
		...
		*/
		function parsePricingYaml(text) {
		...
		function lookupRates(model, table) {
		...
		function mergePricing(base, overlay) {
			...
			const incoming = overlay.models && typeof overlay.models === "object" && !Array.isArray(overlay.models) ? overlay.models : overlay;
			...
			for (const [id, row] of Object.entries(incoming ?? {})) {
				...
				const prev = next.models[id] ?? {
					aliases: [],
					currency: next.currency
				};
				const aliases = [.../* @__PURE__ */ new Set([...prev.aliases ?? [], ...(row.aliases ?? []).filter((a) => typeof a === "string")])];
				next.models[id] = {
					aliases,
					currency: typeof row.currency === "string" && row.currency.trim() ? row.currency.trim() : prev.currency,
					input: row.input !== void 0 ? rateOf(row.input) : prev.input,
					output: row.output !== void 0 ? rateOf(row.output) : prev.output,
					cache: row.cache !== void 0 ? rateOf(row.cache) : prev.cache,
					cacheWrite: row.cacheWrite !== void 0 ? rateOf(row.cacheWrite) : prev.cacheWrite
				};
			}
		...
		*/
		function estimateModelUsage(usage, table) {
			...
			if (bucketSum === 0 && reported > 0) return {
				status: "unknown",
				usd: null,
				unknown: true,
				totalTokens,
				reason: "unsplit-tokens",
				parts: []
			};
			const parts = {
			...
			if (reported > bucketSum) {
				unknown = true;
				parts.unallocated = {
					tokens: reported - bucketSum,
					usd: null,
					unknown: true
				};
			}
			if (unknown && usd === 0) return {
				status: "unknown",
				usd: null,
				unknown: true,
				totalTokens,
		...
		function estimateUsageRows(rows, table) {
		...
		function estimateFromInsights(view, stats, scope, selectedModel, currentRoute, table) {
			if (selectedModel) return estimateModelUsage(selectedModel, table);
			if (scope === "turn") return estimateModelUsage({
				...stats,
				model: view?.turn?.route?.model ?? currentRoute?.model
			}, table);
			if (Array.isArray(view?.models) && view.models.length > 0) return estimateUsageRows(view.models, table);
			return estimateModelUsage({
				...stats,
		...
		function formatUsd(amount) {
			...
			if (abs < 1e-4) return `$${amount.toFixed(6)}`.replace(/(\.\d*?)0+$/, "$1").replace(/\.$/, "");
			if (abs < .01) return `$${amount.toFixed(4)}`;
			if (abs < 1) return `$${amount.toFixed(3)}`;
			return `$${amount.toFixed(2)}`;
		}
		function formatEstimate(result, locale = "zh") {
		...
		function formatEstimateNote(result, locale = "zh") {
			const copy = costCopy(locale);
			return result?.status === "partial" ? copy.someUnpriced : "";
		}
		function estimateDisclaimer(locale = "zh") {
			const copy = costCopy(locale);
			return locale === "en" ? `${copy.estimateNotBill} / 估算，非账单` : `${copy.estimateNotBill} / Estimate, not a bill`;
		}
		function parseOverride(raw) {
			...
			if (text.startsWith("{") || text.startsWith("[")) {
				...
				if (parsed == null || typeof parsed !== "object" || Array.isArray(parsed)) throw new TypeError("override must be a JSON object");
				return parsed;
			}
		...
		function serializeModelRow(row) {
			...
			if (row?.input !== void 0) out.input = row.input;
			if (row?.output !== void 0) out.output = row.output;
			if (row?.cache !== void 0) out.cache = row.cache;
			if (row?.cacheWrite !== void 0) out.cacheWrite = row.cacheWrite;
			return out;
		}
		/** Stable pretty JSON of the effective table (no `_index`). Model keys sorted. */
		function serializeEffectivePricing(table) {
			const models = {};
			for (const id of Object.keys(table?.models ?? {}).sort()) models[id] = serializeModelRow(table.models[id]);
		...
		function effectivePricingText(storage) {
		...
		*/
		function diffPricing(base, edited) {
			if (edited == null || typeof edited !== "object" || Array.isArray(edited)) return null;
			const baseTable = base?.models && typeof base.models === "object" ? base : {
				models: {},
				currency: "USD",
				unit: PRICING_UNIT
			};
			const incoming = edited.models && typeof edited.models === "object" && !Array.isArray(edited.models) ? edited.models : edited;
			const overlay = {};
			if (typeof edited.currency === "string" && edited.currency.trim() && edited.currency.trim() !== (baseTable.currency ?? "USD")) overlay.currency = edited.currency.trim();
			if (typeof edited.unit === "string" && edited.unit.trim() && edited.unit.trim() !== (baseTable.unit ?? "per_1m_tokens")) overlay.unit = edited.unit.trim();
			const models = {};
			for (const [id, row] of Object.entries(incoming ?? {})) {
				if (!id || !row || typeof row !== "object" || Array.isArray(row)) continue;
				...
				if (typeof row.currency === "string" && row.currency.trim() && row.currency.trim() !== (prev?.currency ?? baseTable.currency ?? "USD")) next.currency = row.currency.trim();
				for (const field of [
					"input",
					"output",
					"cache",
		...
		function persistPricingEditor(raw, storage) {
		...
		function clearPricingEditor(storage) {
			storage?.removeItem?.(PRICING_STORAGE_KEY);
			return serializeEffectivePricing(defaultPricing());
		}
		//#endregion
		//#region \0dshx-css-module:/agent/repos/dsh-watcher/src/client/Insights.module.css.mjs
		const css$1 = "._3jWyTq_hudBox{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);width:100%;font-family:var(--dsw-font-family);flex:none}._3jWyTq_hudTop{background:var(--dsw-alias-bg-layer-2);border-bottom:1px solid var(--dsw-alias-border-l2);flex-wrap:nowrap;justify-content:space-between;align-items:center;gap:12px;padding:8px 14px;display:flex}._3jWyTq_hudTopLeft{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:flex}._3jWyTq_hudHeading{color:var(--dsw-alias-label-secondary);white-space:nowrap;font-size:11px;font-weight:600}._3jWyTq_currentModelTag{background:var(--dsw-alias-interactive-bg-hover);white-space:nowrap;border-radius:4px;flex-shrink:1;align-items:center;gap:5px;min-width:0;max-width:100%;padding:1px 6px;font-size:11px;display:inline-flex}._3jWyTq_modelTagText{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-weight:600;overflow:hidden}._3jWyTq_effortTag{color:var(--dsw-static-deepseek-450,#5686fe);white-space:nowrap;background:#5686fe1f;border-radius:3px;flex-shrink:0;padding:0 5px;font-size:10px;font-weight:600;line-height:14px}._3jWyTq_contextTag{color:var(--dsw-alias-label-secondary,#5f636d);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e2e8f0);font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:4px;flex-shrink:0;padding:1px 7px;font-size:11px}._3jWyTq_hudTopRight{flex-shrink:0;align-items:center;gap:10px;display:flex}._3jWyTq_collapseBtn{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:4px;justify-content:center;align-items:center;padding:0;line-height:1;display:inline-flex}._3jWyTq_collapseBtn:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._3jWyTq_collapseChevron{font-size:11px;transition:transform .12s;display:inline-block}._3jWyTq_hudBox[data-collapsed] ._3jWyTq_collapseChevron{transform:rotate(-90deg)}._3jWyTq_hudBox[data-collapsed] ._3jWyTq_hudTop{border-bottom:none}._3jWyTq_tokenStat{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:11px}._3jWyTq_tokenStat strong{color:var(--dsw-alias-label-primary)}._3jWyTq_costStat{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:11px}._3jWyTq_costStat strong{color:var(--dsw-alias-label-primary)}._3jWyTq_scopeGroup{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:5px;gap:1px;padding:1px;display:inline-flex}._3jWyTq_scopeBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;white-space:nowrap;background:0 0;border:0;border-radius:3px;padding:2px 7px;font-size:11px;line-height:14px;transition:all .12s}._3jWyTq_scopeBtn[data-active]{background:var(--dsw-specific-menu);color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv1);font-weight:600}._3jWyTq_modelTabBar{background:var(--dsw-alias-bg-layer-1);border-bottom:1px solid var(--dsw-alias-border-l2);gap:4px;padding:6px 14px;display:flex;overflow-x:auto}._3jWyTq_modelTabBtn{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;border-radius:4px;padding:2px 8px;font-size:11px;transition:all .12s}._3jWyTq_modelTabBtn[data-active]{background:var(--dsw-static-deepseek-450,#5686fe);color:#fff;border-color:var(--dsw-static-deepseek-450,#5686fe);font-weight:600}._3jWyTq_hudBody{padding:10px 14px}._3jWyTq_alertSection{flex-direction:column;gap:6px;margin-top:8px;display:flex}._3jWyTq_alertCard{border-radius:6px;justify-content:space-between;align-items:center;gap:8px;padding:8px 10px;display:flex}._3jWyTq_alertCardDanger{background:#e5484d14;border:1px solid #e5484d40}._3jWyTq_alertCardWarn{background:#f59e0b14;border:1px solid #f59e0b40}._3jWyTq_alertLeft{align-items:center;gap:8px;min-width:0;display:flex}._3jWyTq_alertTag{color:#fff;border-radius:3px;flex:none;padding:1px 5px;font-size:10px;font-weight:600}._3jWyTq_tagDanger{background:var(--dsw-alias-state-error-primary,#e5484d)}._3jWyTq_tagWarn{background:#f59e0b}._3jWyTq_alertTexts{flex-direction:column;min-width:0;display:flex}._3jWyTq_alertMainText{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:600}._3jWyTq_alertSubText{color:var(--dsw-alias-label-secondary);font-size:11px}._3jWyTq_alertActionBtn{color:var(--dsw-static-deepseek-450,#5686fe);cursor:pointer;white-space:nowrap;background:0 0;border:none;padding:2px 6px;font-size:11px;font-weight:600}._3jWyTq_settingsContainer{width:100%;min-width:0;max-width:100%;color:var(--dsw-alias-label-primary);box-sizing:border-box;flex-direction:column;gap:14px;padding:0 0 24px;display:flex;overflow-x:hidden}._3jWyTq_cockpitHeader{flex-wrap:wrap;justify-content:space-between;align-items:flex-end;gap:10px;display:flex}._3jWyTq_cockpitTitleArea h2{color:var(--dsw-alias-label-primary);letter-spacing:-.3px;margin:0;font-size:17px;font-weight:700}._3jWyTq_cockpitSubTitle{color:var(--dsw-alias-label-tertiary);margin:3px 0 0;font-size:12px}._3jWyTq_headerRightControls{align-items:center;gap:8px;display:flex}._3jWyTq_rangeSwitchGroup{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:2px;display:flex}._3jWyTq_rangeBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:4px;padding:3px 10px;font-size:11px;font-weight:600;transition:all .12s}._3jWyTq_rangeBtn[data-active]{background:var(--dsw-specific-menu);color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv1)}._3jWyTq_settingsScanBtn{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:6px;padding:4px 10px;font-size:11px;font-weight:500;transition:all .12s}._3jWyTq_heroStatsRow{border-bottom:1px solid var(--dsw-alias-border-l2);flex-wrap:wrap;justify-content:space-between;align-items:baseline;gap:10px;padding-bottom:10px;display:flex}._3jWyTq_heroPair{flex-wrap:wrap;align-items:flex-start;gap:40px;min-width:0;display:flex}._3jWyTq_heroMetric{flex-direction:column;align-items:flex-start;gap:2px;min-width:0;display:flex}._3jWyTq_heroCaption{color:var(--dsw-alias-label-secondary);font-size:11px;font-weight:600;line-height:1.2}._3jWyTq_heroValue{letter-spacing:-.5px;color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:26px;font-weight:800;line-height:1.15}._3jWyTq_heroFootnote{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:1.3}._3jWyTq_heroMetaCol{color:var(--dsw-alias-label-secondary);white-space:nowrap;flex-wrap:nowrap;gap:14px;font-size:12px;display:flex}._3jWyTq_heroMetaCol strong{color:var(--dsw-alias-label-primary)}._3jWyTq_roastGrid{box-sizing:border-box;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;width:100%;display:grid}@media (width<=440px){._3jWyTq_roastGrid{grid-template-columns:1fr}}._3jWyTq_roastItem{background:var(--dsw-specific-menu);border:1px solid var(--dsw-alias-border-l2);min-height:136px;box-shadow:var(--dsw-shadow-lv1);cursor:pointer;user-select:none;box-sizing:border-box;border-radius:8px;flex-direction:column;justify-content:space-between;padding:12px 14px;transition:all .12s;display:flex}._3jWyTq_roastItem:hover{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-border-l3);transform:translateY(-1px)}._3jWyTq_roastItemActive{background:var(--dsw-alias-bg-layer-2);box-shadow:0 0 0 1px var(--dsw-static-deepseek-450,#5686fe);border-color:var(--dsw-static-deepseek-450,#5686fe)!important}._3jWyTq_roastHead{justify-content:space-between;align-items:center;margin-bottom:4px;display:flex}._3jWyTq_roastTag{letter-spacing:.3px;font-size:11px;font-weight:700}._3jWyTq_roastCategoryBadge{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1,#0000000f);border-radius:3px;padding:1px 4px;font-size:9px;line-height:1.2}._3jWyTq_roastTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:700;line-height:18px;overflow:hidden}._3jWyTq_roastDesc{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin-top:2px;font-size:10px;line-height:15px;overflow:hidden}._3jWyTq_roastVal{font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;margin-top:6px;font-size:12px;font-weight:700;overflow:hidden}._3jWyTq_roastFooter{border-top:1px dashed var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);justify-content:space-between;align-items:center;margin-top:10px;padding-top:8px;font-size:10px;line-height:1;display:flex}._3jWyTq_roastFooterLeft{text-overflow:ellipsis;white-space:nowrap;max-width:110px;overflow:hidden}._3jWyTq_roastAction{color:var(--dsw-alias-label-secondary);flex-shrink:0;font-weight:600;transition:color .12s}._3jWyTq_roastItem:hover ._3jWyTq_roastAction,._3jWyTq_roastItemActive ._3jWyTq_roastAction{color:var(--dsw-static-deepseek-450,#5686fe)}._3jWyTq_drilldownPanel{background:var(--dsw-specific-menu);border:1px solid var(--dsw-static-deepseek-450,#5686fe);box-shadow:var(--dsw-shadow-lv2,0 4px 12px #00000014);border-radius:10px;flex-direction:column;gap:12px;min-width:0;padding:14px 16px;animation:.15s ease-out _3jWyTq_slideDown;display:flex}@keyframes _3jWyTq_slideDown{0%{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}}._3jWyTq_drilldownHead{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:center;gap:12px;min-width:0;padding-bottom:8px;display:flex}._3jWyTq_drilldownTitleGroup{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}._3jWyTq_drilldownTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:700;overflow:hidden}._3jWyTq_drilldownSub{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;overflow:hidden}._3jWyTq_drilldownCloseBtn{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:4px;flex-shrink:0;padding:3px 8px;font-size:11px;transition:all .12s}._3jWyTq_drilldownCloseBtn:hover{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l3)}._3jWyTq_drilldownEmpty{text-align:center;color:var(--dsw-alias-label-tertiary);padding:16px;font-size:12px}._3jWyTq_rankList{flex-direction:column;gap:8px;display:flex}._3jWyTq_rankItem{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1,#0000000f);border-radius:6px;flex-direction:column;gap:6px;min-width:0;padding:8px 12px;display:flex}._3jWyTq_rankItemTop{justify-content:space-between;align-items:center;gap:8px;min-width:0;display:flex}._3jWyTq_rankItemLeft{flex:1;align-items:center;gap:8px;min-width:0;display:flex}._3jWyTq_rankBadge{color:var(--dsw-alias-label-secondary);background:var(--dsw-specific-menu);border:1px solid var(--dsw-alias-border-l2);font-variant-numeric:tabular-nums;border-radius:3px;flex-shrink:0;padding:1px 5px;font-size:10px;font-weight:700;line-height:1.2}._3jWyTq_rankBadgeGold{color:#d97706;background:#f59e0b1f;border-color:#f59e0b66}._3jWyTq_rankName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}._3jWyTq_rankValMain{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;white-space:nowrap;flex-shrink:0;font-size:12px;font-weight:700}._3jWyTq_rankTrack{background:var(--dsw-specific-menu);border-radius:3px;width:100%;height:6px;overflow:hidden}._3jWyTq_rankBar{border-radius:3px;height:100%;transition:width .2s}._3jWyTq_rankSubText{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;justify-content:space-between;align-items:center;gap:8px;font-size:10px;line-height:1.2;display:flex;overflow:hidden}._3jWyTq_rankSubText strong{color:var(--dsw-alias-label-primary)}._3jWyTq_toolDrillSection{flex-direction:column;gap:12px;min-width:0;display:flex}._3jWyTq_toolCompoundBox{flex-direction:column;gap:6px;display:flex}._3jWyTq_toolCompoundTrack{background:var(--dsw-alias-bg-layer-2);border-radius:4px;gap:1px;height:10px;display:flex;overflow:hidden}._3jWyTq_toolSliceBash{background:var(--dsw-static-green-500,#10b981);height:100%}._3jWyTq_toolSliceFile{background:#0ea5e9;height:100%}._3jWyTq_toolCompoundLegend{color:var(--dsw-alias-label-secondary);flex-wrap:wrap;gap:16px;font-size:11px;display:flex}._3jWyTq_toolCompoundLegend span{align-items:center;gap:6px;display:flex}._3jWyTq_toolCompoundLegend strong{color:var(--dsw-alias-label-primary)}._3jWyTq_toolGridCards{grid-template-columns:1fr 1fr;gap:10px;display:grid}@media (width<=600px){._3jWyTq_toolGridCards{grid-template-columns:1fr}}._3jWyTq_toolMiniCard{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;flex-direction:column;gap:4px;min-width:0;padding:10px 12px;display:flex}._3jWyTq_toolMiniTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:6px;font-size:11px;font-weight:600;display:flex;overflow:hidden}._3jWyTq_toolMiniNum{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;margin:2px 0;font-size:15px;font-weight:700}._3jWyTq_toolMiniDesc{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:14px}._3jWyTq_toolTopList{border-top:1px dashed var(--dsw-alias-border-l2);flex-direction:column;gap:6px;padding-top:8px;display:flex}._3jWyTq_toolTopListTitle{color:var(--dsw-alias-label-secondary);margin-bottom:2px;font-size:11px;font-weight:600}._3jWyTq_errorDrillSection{flex-direction:column;gap:8px;display:flex}._3jWyTq_errorAllGoodBox{color:var(--dsw-static-green-500,#10b981);text-align:center;background:#10b98114;border:1px solid #10b9814d;border-radius:6px;padding:16px;font-size:12px;font-weight:600}._3jWyTq_errorSessionList{flex-direction:column;gap:6px;display:flex}._3jWyTq_errorSessionRow{background:var(--dsw-alias-bg-layer-2);font-variant-numeric:tabular-nums;border-radius:4px;grid-template-columns:28px 110px 1fr 75px 75px;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:11px;display:grid}._3jWyTq_vizSplitGrid{box-sizing:border-box;grid-template-columns:1fr;gap:12px;width:100%;display:grid}._3jWyTq_vizPanel{background:var(--dsw-specific-menu);border:1px solid var(--dsw-alias-border-l2);box-shadow:var(--dsw-shadow-lv1);box-sizing:border-box;border-radius:10px;flex-direction:column;gap:10px;width:100%;min-width:0;padding:12px 14px;display:flex;overflow:hidden}._3jWyTq_vizHead{justify-content:space-between;align-items:center;font-size:12px;display:flex}._3jWyTq_vizTitle{color:var(--dsw-alias-label-primary);font-weight:700}._3jWyTq_vizSub{color:var(--dsw-alias-label-secondary);font-size:10px}._3jWyTq_donutWrap{box-sizing:border-box;flex-direction:row;align-items:center;gap:20px;width:100%;display:flex}@media (width<=480px){._3jWyTq_donutWrap{flex-direction:column;align-items:center}}._3jWyTq_donutSvgBox{width:140px;height:140px;position:relative}._3jWyTq_donutSvg{width:100%;height:100%}._3jWyTq_donutCenterText{text-align:center;pointer-events:none;flex-direction:column;justify-content:center;align-items:center;width:68px;display:flex;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._3jWyTq_donutCenterNum{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:17px;font-weight:800;line-height:1.1}._3jWyTq_donutCenterSub{color:var(--dsw-alias-label-tertiary);white-space:nowrap;margin-top:2px;font-size:10px;font-weight:500;line-height:1}._3jWyTq_donutLegendList{flex-direction:column;flex:1;gap:3px;width:100%;min-width:0;display:flex}._3jWyTq_donutLegendRow{cursor:pointer;border-radius:4px;justify-content:space-between;align-items:center;min-width:0;padding:3px 6px;font-size:11px;transition:background .12s;display:flex}._3jWyTq_donutLegendRow:hover,._3jWyTq_donutLegendRowActive{background:var(--dsw-alias-bg-layer-2)}._3jWyTq_dlLeft{flex:1;align-items:center;gap:6px;min-width:0;margin-right:8px;display:flex}._3jWyTq_dlDot{border-radius:2px;flex-shrink:0;width:8px;height:8px}._3jWyTq_dlName{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-primary);min-width:0;overflow:hidden}._3jWyTq_dlRight{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex-shrink:0;font-weight:600}._3jWyTq_donutInspectBar{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;align-items:center;gap:8px;min-width:0;margin-top:2px;padding:6px 10px;font-size:11px;display:flex}._3jWyTq_donutInspectName{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-weight:600;overflow:hidden}._3jWyTq_donutInspectTag{color:var(--dsw-static-deepseek-450,#5686fe);background:#5686fe1f;border-radius:3px;flex-shrink:0;padding:1px 5px;font-size:9px;font-weight:600;line-height:1.2}._3jWyTq_donutInspectVal{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex-shrink:0;font-size:11px;font-weight:600}._3jWyTq_dayStack{align-items:stretch;gap:3px;min-width:0;height:160px;display:flex}._3jWyTq_dayStackWeek{justify-content:center;gap:12px}._3jWyTq_dayStackWeek ._3jWyTq_dayCol{max-width:48px}._3jWyTq_dayCol{flex-direction:column;flex:1 1 0;align-items:stretch;gap:4px;min-width:0;display:flex}._3jWyTq_dayColFill{background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex-direction:column-reverse;flex:1;justify-content:flex-start;min-height:0;transition:filter .12s;display:flex;overflow:hidden}._3jWyTq_dayColFill:hover{filter:brightness(1.1)}._3jWyTq_daySeg{flex:none;width:100%;min-height:0}._3jWyTq_dayEmptyDot{background:var(--dsw-alias-border-l2);border-radius:2px;width:100%;height:3px;margin-top:auto}._3jWyTq_dayLabel{color:var(--dsw-alias-label-tertiary);text-align:center;white-space:nowrap;font-size:10px;line-height:1;overflow:hidden}._3jWyTq_chartAreaBox{width:100%;height:180px;position:relative}._3jWyTq_chartSvg{width:100%;height:100%;overflow:visible}._3jWyTq_chartAxisLabel{fill:var(--dsw-alias-label-tertiary);font-size:9px}._3jWyTq_chartGridLine{stroke:var(--dsw-alias-border-l2);stroke-dasharray:2 3}._3jWyTq_chartFoot{color:var(--dsw-alias-label-tertiary);border-top:1px solid var(--dsw-alias-border-l2);padding-top:6px;font-size:10px}._3jWyTq_tableTitleGroup{flex-direction:column;gap:2px;min-width:0;display:flex}._3jWyTq_tableSortGroup{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;flex-shrink:0;gap:2px;padding:2px;display:flex}._3jWyTq_sortBtn{color:var(--dsw-alias-label-tertiary);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:4px;padding:2px 7px;font-size:10px;line-height:16px;transition:all .12s}._3jWyTq_sortBtn:hover{color:var(--dsw-alias-label-primary)}._3jWyTq_sortBtn[data-active]{background:var(--dsw-specific-menu);color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv1);font-weight:600}._3jWyTq_sessionTableBox{box-sizing:border-box;flex-direction:column;gap:4px;width:100%;display:flex}._3jWyTq_sessionTableHeader{color:var(--dsw-alias-label-tertiary);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-sizing:border-box;border-radius:6px;grid-template-columns:minmax(0,1.2fr) minmax(0,1.3fr) minmax(0,1fr) minmax(0,.7fr) minmax(0,.7fr) 14px;align-items:center;gap:6px;padding:6px 10px;font-size:10px;font-weight:600;display:grid}._3jWyTq_sessionItemRow{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:6px;transition:border-color .12s;overflow:hidden}._3jWyTq_sessionItemRow:hover{border-color:var(--dsw-alias-border-l3)}._3jWyTq_tableRankNum{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;margin-right:4px;font-size:10px}._3jWyTq_sessionItemHead{width:100%;color:inherit;text-align:left;cursor:pointer;font-variant-numeric:tabular-nums;box-sizing:border-box;background:0 0;border:0;grid-template-columns:minmax(0,1.2fr) minmax(0,1.3fr) minmax(0,1fr) minmax(0,.7fr) minmax(0,.7fr) 14px;align-items:center;gap:6px;padding:8px 10px;font-size:11px;display:grid}._3jWyTq_sessionTokenCell{flex-direction:column;align-items:flex-end;gap:2px;min-width:0;display:flex}._3jWyTq_sessionTokenBar{background:var(--dsw-static-deepseek-450,#5686fe);border-radius:1px;max-width:100%;height:2px}._3jWyTq_sessionModelCell{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._3jWyTq_statusOk{color:var(--dsw-static-green-500,#10b981)}._3jWyTq_statusWarn{color:#b45309}._3jWyTq_statusBad{color:var(--dsw-alias-state-error-primary,#ef4444);font-weight:600}._3jWyTq_sessionIdTag{color:var(--dsw-alias-label-primary);font-family:ui-monospace,monospace;font-size:11px;font-weight:600}._3jWyTq_arrowIcon{color:var(--dsw-alias-label-tertiary);transition:transform .12s}._3jWyTq_sessionItemOpen ._3jWyTq_arrowIcon{transform:rotate(90deg)}._3jWyTq_sessionItemDrawer{background:var(--dsw-specific-menu);border-top:1px dashed var(--dsw-alias-border-l2);padding:10px 12px;font-size:11px}._3jWyTq_drawerTitle{color:var(--dsw-alias-label-primary);margin-bottom:6px;font-weight:600}._3jWyTq_drawerBarTrack{background:var(--dsw-alias-bg-layer-2);border-radius:4px;gap:1px;height:8px;margin-bottom:6px;display:flex;overflow:hidden}._3jWyTq_drawerSliceModel{background:var(--dsw-static-deepseek-450,#5686fe);height:100%}._3jWyTq_drawerSliceTool{background:var(--dsw-static-green-500,#10b981);height:100%}._3jWyTq_drawerMetaRow{color:var(--dsw-alias-label-secondary);flex-wrap:wrap;justify-content:space-between;gap:6px;font-size:10px;display:flex}._3jWyTq_settingsDrawer{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-menu);border-radius:8px;padding:8px 12px;font-size:11px}._3jWyTq_settingsSummary{cursor:pointer;color:var(--dsw-alias-label-secondary);font-weight:500}._3jWyTq_settingsDrawerContent{flex-wrap:wrap;align-items:center;gap:14px;padding-top:10px;display:flex}._3jWyTq_priceOverrideHelp,._3jWyTq_priceOverridePath{width:100%;color:var(--dsw-alias-label-secondary);margin:0;font-size:11px;line-height:1.45}._3jWyTq_priceOverrideInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;min-height:120px;color:var(--dsw-alias-label-primary);resize:vertical;border-radius:6px;padding:8px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:11px}._3jWyTq_priceOverrideError{width:100%;color:var(--dsw-alias-state-error-primary,#e5484d);margin:0;font-size:11px}._3jWyTq_priceOverrideActions{align-items:center;gap:8px;display:flex}._3jWyTq_settingsResetBtn{color:var(--dsw-alias-label-secondary);border:1px solid var(--dsw-alias-border-l2);cursor:pointer;background:0 0;border-radius:4px;padding:3px 10px;font-size:11px}._3jWyTq_settingInlineItem{align-items:center;gap:6px;display:flex}._3jWyTq_settingsMiniInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:50px;color:var(--dsw-alias-label-primary);text-align:right;border-radius:4px;outline:none;padding:3px 6px;font-size:11px}._3jWyTq_settingsMiniSaveBtn{background:var(--dsw-static-deepseek-450,#5686fe);color:#fff;cursor:pointer;border:none;border-radius:4px;padding:3px 10px;font-size:11px}._3jWyTq_emptyScan{text-align:center;color:var(--dsw-alias-label-tertiary);padding:20px;font-size:12px}._3jWyTq_chartLegend{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;flex-wrap:wrap;align-items:center;gap:8px;margin-bottom:8px;padding:5px 8px;display:flex}._3jWyTq_chartLegendItem{color:var(--dsw-alias-label-secondary);align-items:center;gap:5px;min-width:0;font-size:11px;display:flex}._3jWyTq_chartLegendDot{border-radius:50%;flex-shrink:0;width:7px;height:7px}._3jWyTq_chartLegendName{text-overflow:ellipsis;white-space:nowrap;max-width:130px;color:var(--dsw-alias-label-primary);font-weight:500;overflow:hidden}._3jWyTq_chartLegendVal{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary);font-size:10px;font-weight:600}._3jWyTq_chartInteractiveWrap{width:100%;position:relative}._3jWyTq_dayBarTopLabel{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-secondary);text-align:center;white-space:nowrap;text-overflow:ellipsis;min-height:14px;font-size:9px;font-weight:600;line-height:14px;overflow:hidden}._3jWyTq_dayColFillActive{box-shadow:0 0 0 2px var(--dsw-static-deepseek-450,#5686fe);filter:brightness(1.2)!important}._3jWyTq_dayLabelToday{font-weight:700;color:var(--dsw-static-deepseek-450,#5686fe)!important}._3jWyTq_chartTooltipBox{z-index:50;pointer-events:none;background:var(--dsw-specific-menu);border:1px solid var(--dsw-alias-border-l1);backdrop-filter:blur(8px);border-radius:8px;min-width:150px;max-width:260px;padding:8px 10px;transition:opacity .12s,transform .12s;position:absolute;box-shadow:0 6px 20px #00000047}._3jWyTq_chartTooltipBox._3jWyTq_chartTooltipPortal{z-index:1200;visibility:hidden;position:fixed;top:0;left:0}._3jWyTq_chartTooltipDate{color:var(--dsw-alias-label-primary);justify-content:space-between;align-items:center;gap:6px;margin-bottom:4px;font-size:11px;font-weight:700;display:flex}._3jWyTq_chartTooltipDateBadge{color:var(--dsw-static-deepseek-450,#5686fe);background:#5686fe26;border-radius:3px;flex-shrink:0;padding:1px 5px;font-size:9px;font-weight:600}._3jWyTq_chartTooltipTotal{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;align-items:baseline;gap:5px;margin-bottom:4px;font-size:13px;font-weight:800;display:flex}._3jWyTq_chartTooltipSessions{color:var(--dsw-alias-label-tertiary);font-size:10px;font-weight:500}._3jWyTq_chartTooltipDivider{background:var(--dsw-alias-border-l2);height:1px;margin:5px 0}._3jWyTq_chartTooltipModelList{flex-direction:column;gap:3px;display:flex}._3jWyTq_chartTooltipModelRow{justify-content:space-between;align-items:center;gap:8px;font-size:10px;display:flex}._3jWyTq_chartTooltipModelLeft{flex:1;align-items:center;gap:5px;min-width:0;display:flex}._3jWyTq_chartTooltipModelDot{border-radius:50%;flex-shrink:0;width:6px;height:6px}._3jWyTq_chartTooltipModelName{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-secondary);overflow:hidden}._3jWyTq_chartTooltipModelRight{font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary);white-space:nowrap;flex-shrink:0;font-weight:600}._3jWyTq_lineChartWrap{user-select:none;width:100%;min-width:0;height:170px;position:relative}._3jWyTq_lineChartSvg{width:100%;height:100%;display:block;overflow:visible}._3jWyTq_lineGrid{stroke:var(--dsw-alias-border-l2);stroke-dasharray:2 3}._3jWyTq_lineAxisText{fill:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:9px}._3jWyTq_lineCursor{stroke:var(--dsw-static-deepseek-450,#5686fe);stroke-dasharray:3 3;stroke-width:1.5px;pointer-events:none}._3jWyTq_lineActiveOuter{fill:#5686fe40;pointer-events:none;animation:1.5s ease-in-out infinite _3jWyTq_linePulse}@keyframes _3jWyTq_linePulse{0%,to{opacity:.8;transform:scale(1)}50%{opacity:.4;transform:scale(1.3)}}._3jWyTq_lineActiveInner{fill:var(--dsw-static-deepseek-450,#5686fe);stroke:#fff;stroke-width:1.5px;pointer-events:none}._3jWyTq_viewSwitchGroup{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:5px;gap:2px;padding:2px;display:flex}._3jWyTq_viewSwitchBtn{color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:3px;padding:2px 7px;font-size:10px;font-weight:600;transition:all .12s}._3jWyTq_viewSwitchBtn[data-active]{background:var(--dsw-specific-menu);color:var(--dsw-alias-label-primary);box-shadow:var(--dsw-shadow-lv1)}._3jWyTq_heatmapPanel{background:var(--dsw-specific-menu);border:1px solid var(--dsw-alias-border-l2);box-shadow:var(--dsw-shadow-lv1);box-sizing:border-box;border-radius:10px;flex-direction:column;gap:10px;width:100%;min-width:0;margin-top:12px;padding:14px 16px;display:flex}._3jWyTq_heatmapHead{flex-wrap:wrap;justify-content:space-between;align-items:flex-start;gap:8px;display:flex}._3jWyTq_heatmapTitleGroup{flex-direction:column;gap:2px;display:flex}._3jWyTq_heatmapTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:700}._3jWyTq_heatmapSub{color:var(--dsw-alias-label-secondary);font-size:11px}._3jWyTq_heatmapStatsRow{color:var(--dsw-alias-label-secondary);flex-wrap:wrap;gap:14px;font-size:11px;display:flex}._3jWyTq_heatmapStatsRow strong{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-weight:700}._3jWyTq_heatmapScrollArea{box-sizing:border-box;width:100%;padding:8px 4px 14px;overflow:auto visible}._3jWyTq_heatmapContainer{flex-direction:column;gap:6px;width:max-content;display:flex;position:relative}._3jWyTq_heatmapMonthsRow{height:16px;margin-left:32px;display:block;position:relative}._3jWyTq_heatmapMonthLabel{color:var(--dsw-alias-label-tertiary);white-space:nowrap;font-size:10px;font-weight:600;position:absolute}._3jWyTq_heatmapGrid{gap:8px;display:flex}._3jWyTq_heatmapWeekdaysCol{width:24px;height:109px;color:var(--dsw-alias-label-tertiary);user-select:none;flex-direction:column;flex-shrink:0;justify-content:space-between;padding:0;font-size:9px;display:flex}._3jWyTq_heatmapWeeksRow{gap:3px;display:flex}._3jWyTq_heatmapWeekCol{flex-direction:column;gap:3px;display:flex}._3jWyTq_heatmapCell{box-sizing:border-box;cursor:pointer;border-radius:2px;width:13px;height:13px;transition:outline .1s,box-shadow .1s,filter .1s;position:relative}._3jWyTq_heatmapCellToday{outline-offset:1px;z-index:5;outline:1.5px solid var(--dsw-static-deepseek-450,#5686fe)!important}._3jWyTq_heatmapCell[data-level=\"0\"]{background:var(--dsw-alias-bg-layer-2,#ffffff09);border:1px solid var(--dsw-alias-border-l2,#ffffff14)}._3jWyTq_heatmapCell[data-level=\"1\"]{background:#5686fe38;border:1px solid #5686fe59}._3jWyTq_heatmapCell[data-level=\"2\"]{background:#5686fe73;border:1px solid #5686fe99}._3jWyTq_heatmapCell[data-level=\"3\"]{background:#5686feb8;border:1px solid #5686fee0;box-shadow:0 0 6px #5686fe40}._3jWyTq_heatmapCell[data-level=\"4\"]{background:var(--dsw-static-deepseek-450,#5686fe);border:1px solid #9bb8ff;box-shadow:0 0 10px #5686fe8c}._3jWyTq_heatmapCell[data-future=true]{opacity:.28;cursor:default;background:0 0!important;border:1px dashed #ffffff26!important}._3jWyTq_heatmapCell:hover:not([data-future=true]),._3jWyTq_heatmapCellActive{outline-offset:1px;filter:brightness(1.25);z-index:10;transform:none;outline:2px solid #fff!important;box-shadow:0 0 12px #5686fed9!important}._3jWyTq_heatmapLiveHud{color:var(--dsw-alias-label-primary);background:#5686fe1f;border:1px solid #5686fe47;border-radius:6px;align-items:center;gap:8px;padding:3px 8px;font-size:11px;display:flex}._3jWyTq_heatmapLiveDate{color:var(--dsw-static-deepseek-450,#5686fe);font-weight:700}._3jWyTq_heatmapLiveTokens{font-variant-numeric:tabular-nums;font-weight:700}._3jWyTq_heatmapLiveModel{color:var(--dsw-alias-label-secondary);font-size:10px}._3jWyTq_heatmapFoot{color:var(--dsw-alias-label-tertiary);border-top:1px solid var(--dsw-alias-border-l2);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:8px;margin-top:4px;padding-top:8px;font-size:10px;display:flex}._3jWyTq_heatmapLegend{color:var(--dsw-alias-label-tertiary);align-items:center;gap:4px;font-size:10px;display:flex}._3jWyTq_heatmapLegendCell{border-radius:2px;width:10px;height:10px}";
		...
		var Insights_module_css_default = {
			"alertActionBtn": "_3jWyTq_alertActionBtn",
			"alertCard": "_3jWyTq_alertCard",
			"alertCardDanger": "_3jWyTq_alertCardDanger",
			"alertCardWarn": "_3jWyTq_alertCardWarn",
			"alertLeft": "_3jWyTq_alertLeft",
			"alertMainText": "_3jWyTq_alertMainText",
			"alertSection": "_3jWyTq_alertSection",
			"alertSubText": "_3jWyTq_alertSubText",
			"alertTag": "_3jWyTq_alertTag",
			"alertTexts": "_3jWyTq_alertTexts",
			"arrowIcon": "_3jWyTq_arrowIcon",
			"chartAreaBox": "_3jWyTq_chartAreaBox",
			"chartAxisLabel": "_3jWyTq_chartAxisLabel",
			"chartFoot": "_3jWyTq_chartFoot",
			"chartGridLine": "_3jWyTq_chartGridLine",
			"chartInteractiveWrap": "_3jWyTq_chartInteractiveWrap",
			"chartLegend": "_3jWyTq_chartLegend",
			"chartLegendDot": "_3jWyTq_chartLegendDot",
			"chartLegendItem": "_3jWyTq_chartLegendItem",
			"chartLegendName": "_3jWyTq_chartLegendName",
			"chartLegendVal": "_3jWyTq_chartLegendVal",
			"chartSvg": "_3jWyTq_chartSvg",
			"chartTooltipBox": "_3jWyTq_chartTooltipBox",
			"chartTooltipDate": "_3jWyTq_chartTooltipDate",
			"chartTooltipDateBadge": "_3jWyTq_chartTooltipDateBadge",
			"chartTooltipDivider": "_3jWyTq_chartTooltipDivider",
			"chartTooltipModelDot": "_3jWyTq_chartTooltipModelDot",
			"chartTooltipModelLeft": "_3jWyTq_chartTooltipModelLeft",
			"chartTooltipModelList": "_3jWyTq_chartTooltipModelList",
			"chartTooltipModelName": "_3jWyTq_chartTooltipModelName",
			"chartTooltipModelRight": "_3jWyTq_chartTooltipModelRight",
			"chartTooltipModelRow": "_3jWyTq_chartTooltipModelRow",
			"chartTooltipPortal": "_3jWyTq_chartTooltipPortal",
			"chartTooltipSessions": "_3jWyTq_chartTooltipSessions",
			"chartTooltipTotal": "_3jWyTq_chartTooltipTotal",
			"cockpitHeader": "_3jWyTq_cockpitHeader",
			"cockpitSubTitle": "_3jWyTq_cockpitSubTitle",
			"cockpitTitleArea": "_3jWyTq_cockpitTitleArea",
			"collapseBtn": "_3jWyTq_collapseBtn",
			"collapseChevron": "_3jWyTq_collapseChevron",
			"contextTag": "_3jWyTq_contextTag",
			"costStat": "_3jWyTq_costStat",
			"currentModelTag": "_3jWyTq_currentModelTag",
			"dayBarTopLabel": "_3jWyTq_dayBarTopLabel",
			"dayCol": "_3jWyTq_dayCol",
			"dayColFill": "_3jWyTq_dayColFill",
			"dayColFillActive": "_3jWyTq_dayColFillActive",
			"dayEmptyDot": "_3jWyTq_dayEmptyDot",
			"dayLabel": "_3jWyTq_dayLabel",
			"dayLabelToday": "_3jWyTq_dayLabelToday",
			"daySeg": "_3jWyTq_daySeg",
			"dayStack": "_3jWyTq_dayStack",
			"dayStackWeek": "_3jWyTq_dayStackWeek",
			"dlDot": "_3jWyTq_dlDot",
			"dlLeft": "_3jWyTq_dlLeft",
			"dlName": "_3jWyTq_dlName",
			"dlRight": "_3jWyTq_dlRight",
			"donutCenterNum": "_3jWyTq_donutCenterNum",
			"donutCenterSub": "_3jWyTq_donutCenterSub",
			"donutCenterText": "_3jWyTq_donutCenterText",
			"donutInspectBar": "_3jWyTq_donutInspectBar",
			"donutInspectName": "_3jWyTq_donutInspectName",
			"donutInspectTag": "_3jWyTq_donutInspectTag",
			"donutInspectVal": "_3jWyTq_donutInspectVal",
			"donutLegendList": "_3jWyTq_donutLegendList",
			"donutLegendRow": "_3jWyTq_donutLegendRow",
			"donutLegendRowActive": "_3jWyTq_donutLegendRowActive",
			"donutSvg": "_3jWyTq_donutSvg",
			"donutSvgBox": "_3jWyTq_donutSvgBox",
			"donutWrap": "_3jWyTq_donutWrap",
			"drawerBarTrack": "_3jWyTq_drawerBarTrack",
			"drawerMetaRow": "_3jWyTq_drawerMetaRow",
			"drawerSliceModel": "_3jWyTq_drawerSliceModel",
			"drawerSliceTool": "_3jWyTq_drawerSliceTool",
			"drawerTitle": "_3jWyTq_drawerTitle",
			"drilldownCloseBtn": "_3jWyTq_drilldownCloseBtn",
			"drilldownEmpty": "_3jWyTq_drilldownEmpty",
			"drilldownHead": "_3jWyTq_drilldownHead",
			"drilldownPanel": "_3jWyTq_drilldownPanel",
			"drilldownSub": "_3jWyTq_drilldownSub",
			"drilldownTitle": "_3jWyTq_drilldownTitle",
			"drilldownTitleGroup": "_3jWyTq_drilldownTitleGroup",
			"effortTag": "_3jWyTq_effortTag",
			"emptyScan": "_3jWyTq_emptyScan",
			"errorAllGoodBox": "_3jWyTq_errorAllGoodBox",
			"errorDrillSection": "_3jWyTq_errorDrillSection",
			"errorSessionList": "_3jWyTq_errorSessionList",
			"errorSessionRow": "_3jWyTq_errorSessionRow",
			"headerRightControls": "_3jWyTq_headerRightControls",
			"heatmapCell": "_3jWyTq_heatmapCell",
			"heatmapCellActive": "_3jWyTq_heatmapCellActive",
			"heatmapCellToday": "_3jWyTq_heatmapCellToday",
			"heatmapContainer": "_3jWyTq_heatmapContainer",
			"heatmapFoot": "_3jWyTq_heatmapFoot",
			"heatmapGrid": "_3jWyTq_heatmapGrid",
			"heatmapHead": "_3jWyTq_heatmapHead",
			"heatmapLegend": "_3jWyTq_heatmapLegend",
			"heatmapLegendCell": "_3jWyTq_heatmapLegendCell",
			"heatmapLiveDate": "_3jWyTq_heatmapLiveDate",
			"heatmapLiveHud": "_3jWyTq_heatmapLiveHud",
			"heatmapLiveModel": "_3jWyTq_heatmapLiveModel",
			"heatmapLiveTokens": "_3jWyTq_heatmapLiveTokens",
			"heatmapMonthLabel": "_3jWyTq_heatmapMonthLabel",
			"heatmapMonthsRow": "_3jWyTq_heatmapMonthsRow",
			"heatmapPanel": "_3jWyTq_heatmapPanel",
			"heatmapScrollArea": "_3jWyTq_heatmapScrollArea",
			"heatmapStatsRow": "_3jWyTq_heatmapStatsRow",
			"heatmapSub": "_3jWyTq_heatmapSub",
			"heatmapTitle": "_3jWyTq_heatmapTitle",
			"heatmapTitleGroup": "_3jWyTq_heatmapTitleGroup",
			"heatmapWeekCol": "_3jWyTq_heatmapWeekCol",
			"heatmapWeekdaysCol": "_3jWyTq_heatmapWeekdaysCol",
			"heatmapWeeksRow": "_3jWyTq_heatmapWeeksRow",
			"heroCaption": "_3jWyTq_heroCaption",
			"heroFootnote": "_3jWyTq_heroFootnote",
			"heroMetaCol": "_3jWyTq_heroMetaCol",
			"heroMetric": "_3jWyTq_heroMetric",
			"heroPair": "_3jWyTq_heroPair",
			"heroStatsRow": "_3jWyTq_heroStatsRow",
			"heroValue": "_3jWyTq_heroValue",
			"hudBody": "_3jWyTq_hudBody",
			"hudBox": "_3jWyTq_hudBox",
			"hudHeading": "_3jWyTq_hudHeading",
			"hudTop": "_3jWyTq_hudTop",
			"hudTopLeft": "_3jWyTq_hudTopLeft",
			"hudTopRight": "_3jWyTq_hudTopRight",
			"lineActiveInner": "_3jWyTq_lineActiveInner",
			"lineActiveOuter": "_3jWyTq_lineActiveOuter",
			"lineAxisText": "_3jWyTq_lineAxisText",
			"lineChartSvg": "_3jWyTq_lineChartSvg",
			"lineChartWrap": "_3jWyTq_lineChartWrap",
			"lineCursor": "_3jWyTq_lineCursor",
			"lineGrid": "_3jWyTq_lineGrid",
			"linePulse": "_3jWyTq_linePulse",
			"modelTabBar": "_3jWyTq_modelTabBar",
			"modelTabBtn": "_3jWyTq_modelTabBtn",
			"modelTagText": "_3jWyTq_modelTagText",
			"priceOverrideActions": "_3jWyTq_priceOverrideActions",
			"priceOverrideError": "_3jWyTq_priceOverrideError",
			"priceOverrideHelp": "_3jWyTq_priceOverrideHelp",
			"priceOverrideInput": "_3jWyTq_priceOverrideInput",
			"priceOverridePath": "_3jWyTq_priceOverridePath",
			"rangeBtn": "_3jWyTq_rangeBtn",
			"rangeSwitchGroup": "_3jWyTq_rangeSwitchGroup",
			"rankBadge": "_3jWyTq_rankBadge",
			"rankBadgeGold": "_3jWyTq_rankBadgeGold",
			"rankBar": "_3jWyTq_rankBar",
			"rankItem": "_3jWyTq_rankItem",
			"rankItemLeft": "_3jWyTq_rankItemLeft",
			"rankItemTop": "_3jWyTq_rankItemTop",
			"rankList": "_3jWyTq_rankList",
			"rankName": "_3jWyTq_rankName",
			"rankSubText": "_3jWyTq_rankSubText",
			"rankTrack": "_3jWyTq_rankTrack",
			"rankValMain": "_3jWyTq_rankValMain",
			"roastAction": "_3jWyTq_roastAction",
			"roastCategoryBadge": "_3jWyTq_roastCategoryBadge",
			"roastDesc": "_3jWyTq_roastDesc",
			"roastFooter": "_3jWyTq_roastFooter",
			"roastFooterLeft": "_3jWyTq_roastFooterLeft",
			"roastGrid": "_3jWyTq_roastGrid",
			"roastHead": "_3jWyTq_roastHead",
			"roastItem": "_3jWyTq_roastItem",
			"roastItemActive": "_3jWyTq_roastItemActive",
			"roastTag": "_3jWyTq_roastTag",
			"roastTitle": "_3jWyTq_roastTitle",
			"roastVal": "_3jWyTq_roastVal",
			"scopeBtn": "_3jWyTq_scopeBtn",
			"scopeGroup": "_3jWyTq_scopeGroup",
			"sessionIdTag": "_3jWyTq_sessionIdTag",
			"sessionItemDrawer": "_3jWyTq_sessionItemDrawer",
			"sessionItemHead": "_3jWyTq_sessionItemHead",
			"sessionItemOpen": "_3jWyTq_sessionItemOpen",
			"sessionItemRow": "_3jWyTq_sessionItemRow",
			"sessionModelCell": "_3jWyTq_sessionModelCell",
			"sessionTableBox": "_3jWyTq_sessionTableBox",
			"sessionTableHeader": "_3jWyTq_sessionTableHeader",
			"sessionTokenBar": "_3jWyTq_sessionTokenBar",
			"sessionTokenCell": "_3jWyTq_sessionTokenCell",
			"settingInlineItem": "_3jWyTq_settingInlineItem",
			"settingsContainer": "_3jWyTq_settingsContainer",
			"settingsDrawer": "_3jWyTq_settingsDrawer",
			"settingsDrawerContent": "_3jWyTq_settingsDrawerContent",
			"settingsMiniInput": "_3jWyTq_settingsMiniInput",
			"settingsMiniSaveBtn": "_3jWyTq_settingsMiniSaveBtn",
			"settingsResetBtn": "_3jWyTq_settingsResetBtn",
			"settingsScanBtn": "_3jWyTq_settingsScanBtn",
			"settingsSummary": "_3jWyTq_settingsSummary",
			"slideDown": "_3jWyTq_slideDown",
			"sortBtn": "_3jWyTq_sortBtn",
			"statusBad": "_3jWyTq_statusBad",
			"statusOk": "_3jWyTq_statusOk",
			"statusWarn": "_3jWyTq_statusWarn",
			"tableRankNum": "_3jWyTq_tableRankNum",
			"tableSortGroup": "_3jWyTq_tableSortGroup",
			"tableTitleGroup": "_3jWyTq_tableTitleGroup",
			"tagDanger": "_3jWyTq_tagDanger",
			"tagWarn": "_3jWyTq_tagWarn",
			"tokenStat": "_3jWyTq_tokenStat",
			"toolCompoundBox": "_3jWyTq_toolCompoundBox",
			"toolCompoundLegend": "_3jWyTq_toolCompoundLegend",
			"toolCompoundTrack": "_3jWyTq_toolCompoundTrack",
			"toolDrillSection": "_3jWyTq_toolDrillSection",
			"toolGridCards": "_3jWyTq_toolGridCards",
			"toolMiniCard": "_3jWyTq_toolMiniCard",
			"toolMiniDesc": "_3jWyTq_toolMiniDesc",
			"toolMiniNum": "_3jWyTq_toolMiniNum",
			"toolMiniTitle": "_3jWyTq_toolMiniTitle",
			"toolSliceBash": "_3jWyTq_toolSliceBash",
			"toolSliceFile": "_3jWyTq_toolSliceFile",
			"toolTopList": "_3jWyTq_toolTopList",
			"toolTopListTitle": "_3jWyTq_toolTopListTitle",
			"viewSwitchBtn": "_3jWyTq_viewSwitchBtn",
			"viewSwitchGroup": "_3jWyTq_viewSwitchGroup",
			"vizHead": "_3jWyTq_vizHead",
			"vizPanel": "_3jWyTq_vizPanel",
			"vizSplitGrid": "_3jWyTq_vizSplitGrid",
			"vizSub": "_3jWyTq_vizSub",
			"vizTitle": "_3jWyTq_vizTitle"
		};
		//#endregion
		//#region \0dshx-css-module:/agent/repos/dsh-watcher/src/client/TimingPanel.module.css.mjs
		const css = ".Oecg3G_panelBox{--c-ttft:#94a3b8;--c-think:#3b82f6;--c-output:#38bdf8;--c-bash:#059669;--c-file:#34d399;box-sizing:border-box;background:var(--dsw-alias-bg-layer-2,#f5f6f8);border:1px solid var(--dsw-alias-border-l2,#e2e8f0);border-radius:8px;width:100%;padding:12px 14px;position:relative}body[data-ds-dark-theme] .Oecg3G_panelBox{--c-ttft:#64748b;--c-think:#60a5fa;--c-output:#38bdf8;--c-bash:#10b981;--c-file:#6ee7b7}.Oecg3G_topRow{white-space:nowrap;justify-content:space-between;align-items:center;gap:12px;margin-bottom:8px;font-size:11px;display:flex}.Oecg3G_titleArea{white-space:nowrap;flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:flex}.Oecg3G_mainTitle{color:var(--dsw-alias-label-primary,#17181c);white-space:nowrap;font-size:12px;font-weight:700}.Oecg3G_liveSpeed{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e2e8f0);color:var(--dsw-alias-label-primary,#17181c);font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:4px;align-items:center;gap:4px;padding:1px 6px;font-size:10px;font-weight:600;display:inline-flex}.Oecg3G_speedDot{background:var(--c-output);border-radius:50%;width:5px;height:5px;animation:1.5s infinite Oecg3G_pulse}.Oecg3G_totalDuration{color:var(--dsw-alias-label-secondary,#5f636d);font-variant-numeric:tabular-nums;white-space:nowrap}.Oecg3G_bottleneckText{color:var(--dsw-alias-label-primary,#17181c);font-variant-numeric:tabular-nums;white-space:nowrap;flex-shrink:0;font-size:11px;font-weight:600}.Oecg3G_chartBox{width:100%;margin-bottom:8px;position:relative}.Oecg3G_barTrack{background:var(--dsw-alias-bg-layer-1,#e2e8f0);cursor:crosshair;border-radius:5px;gap:1px;width:100%;height:20px;display:flex;overflow:hidden;box-shadow:inset 0 1px 2px #0000000a}.Oecg3G_modelCluster,.Oecg3G_toolCluster{height:100%;transition:opacity .12s;display:flex;position:relative}.Oecg3G_slice{cursor:pointer;height:100%;transition:all .12s;position:relative}.Oecg3G_slice:hover{filter:brightness(1.15);z-index:5;box-shadow:0 0 6px #0003}.Oecg3G_slice+.Oecg3G_slice{border-left:1px solid #ffffff59}.Oecg3G_sliceTtft{background:var(--c-ttft)}.Oecg3G_sliceThink{background:var(--c-think)}.Oecg3G_sliceOutput{background:var(--c-output)}.Oecg3G_sliceBash{background:var(--c-bash)}.Oecg3G_sliceFile{background:var(--c-file)}.Oecg3G_legendRow{color:var(--dsw-alias-label-secondary,#5f636d);white-space:nowrap;flex-wrap:nowrap;justify-content:space-between;align-items:center;gap:8px;font-size:11px;display:flex}.Oecg3G_legendGroup{white-space:nowrap;flex-wrap:nowrap;align-items:center;gap:12px;display:flex}.Oecg3G_legendItem{cursor:pointer;white-space:nowrap;align-items:center;gap:4px;transition:opacity .12s;display:flex}.Oecg3G_legendItem:hover{opacity:.75}.Oecg3G_dot{border-radius:2px;flex-shrink:0;width:7px;height:7px}.Oecg3G_statusPill{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;gap:4px;padding:1px 7px;font-size:10px;font-weight:600;display:inline-flex}.Oecg3G_statusOk{color:var(--dsw-static-green-500,#15803d)}.Oecg3G_statusWarn{color:#b45309;background:#f59e0b1f}.Oecg3G_statusDanger{color:#b91c1c;background:#ef44441f}.Oecg3G_popover{color:#f8fafc;pointer-events:none;z-index:50;box-sizing:border-box;white-space:nowrap;background:#0f172a;border-radius:8px;width:360px;max-width:calc(100% - 16px);padding:10px 14px;font-size:11px;animation:.12s ease-out Oecg3G_popIn;position:absolute;top:auto;bottom:calc(100% + 8px);box-shadow:0 8px 24px #00000059}.Oecg3G_popover:after{content:\"\";bottom:-5px;left:var(--arrow-left,50%);border:5px solid #0000;border-top-color:#0f172a;border-bottom-width:0;position:absolute;transform:translate(-50%)}.Oecg3G_popTitle{white-space:nowrap;border-bottom:1px solid #ffffff26;justify-content:space-between;align-items:center;gap:16px;margin-bottom:6px;padding-bottom:5px;font-weight:600;display:flex}.Oecg3G_popList{flex-direction:column;gap:3px;display:flex}.Oecg3G_popRow{white-space:nowrap;justify-content:space-between;align-items:center;gap:16px;padding:2px 0;display:flex}.Oecg3G_popLeft{color:#ffffffd9;white-space:nowrap;flex-shrink:0;align-items:center;gap:6px;display:flex}.Oecg3G_popRight{font-variant-numeric:tabular-nums;color:#fff;white-space:nowrap;text-align:right;flex-shrink:0;font-weight:600}.Oecg3G_activeVal{color:#fbbf24;font-weight:700}@keyframes Oecg3G_pulse{0%,to{opacity:1;transform:scale(1)}50%{opacity:.4;transform:scale(.85)}}@keyframes Oecg3G_popIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}";
		...
		var TimingPanel_module_css_default = {
			"activeVal": "Oecg3G_activeVal",
			"barTrack": "Oecg3G_barTrack",
			"bottleneckText": "Oecg3G_bottleneckText",
			"chartBox": "Oecg3G_chartBox",
			"dot": "Oecg3G_dot",
			"legendGroup": "Oecg3G_legendGroup",
			"legendItem": "Oecg3G_legendItem",
			"legendRow": "Oecg3G_legendRow",
			"liveSpeed": "Oecg3G_liveSpeed",
			"mainTitle": "Oecg3G_mainTitle",
			"modelCluster": "Oecg3G_modelCluster",
			"panelBox": "Oecg3G_panelBox",
			"popIn": "Oecg3G_popIn",
			"popLeft": "Oecg3G_popLeft",
			"popList": "Oecg3G_popList",
			"popover": "Oecg3G_popover",
			"popRight": "Oecg3G_popRight",
			"popRow": "Oecg3G_popRow",
			"popTitle": "Oecg3G_popTitle",
			"pulse": "Oecg3G_pulse",
			"slice": "Oecg3G_slice",
			"sliceBash": "Oecg3G_sliceBash",
			"sliceFile": "Oecg3G_sliceFile",
			"sliceOutput": "Oecg3G_sliceOutput",
			"sliceThink": "Oecg3G_sliceThink",
			"sliceTtft": "Oecg3G_sliceTtft",
			"speedDot": "Oecg3G_speedDot",
			"statusDanger": "Oecg3G_statusDanger",
			"statusOk": "Oecg3G_statusOk",
			"statusPill": "Oecg3G_statusPill",
			"statusWarn": "Oecg3G_statusWarn",
			"titleArea": "Oecg3G_titleArea",
			"toolCluster": "Oecg3G_toolCluster",
			"topRow": "Oecg3G_topRow",
			"totalDuration": "Oecg3G_totalDuration"
		};
		//#endregion
									...
									hoverSlice === "file" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "其它工具总耗时" })]
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												className: TimingPanel_module_css_default.popRight,
												children: [
													duration(fileMs),
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: TimingPanel_module_css_default.popLeft,
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "全部工具单次平均耗时" })
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												className: TimingPanel_module_css_default.popRight,
												children: [Math.round(toolTotalMs / Math.max(1, stats.tools)), " ms / 次"]
											})]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: TimingPanel_module_css_default.popRow,
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: TimingPanel_module_css_default.popLeft,
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "其它工具评价" })
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: TimingPanel_module_css_default.popRight,
												children: fileMs < 2e3 ? "毫秒级极速执行，无性能损耗" : "调用较为密集，轻微耗时累积"
											})]
										})
									] })
								]
		...
		function useUiLocale() {
			const [locale, setLocale] = (0, react.useState)(detectLocale);
			(0, react.useEffect)(() => {
		...
		function usePricingTable() {
			const [table, setTable] = (0, react.useState)(() => mergePricing(defaultPricing(), readStoredOverride(globalThis.localStorage)));
			(0, react.useEffect)(() => {
		...
		*/
		function ChartTooltip({ anchor, children }) {
			...
			(0, react.useLayoutEffect)(() => {
				...
				const place = () => {
					...
					const left = Math.min(Math.max(pointX - width / 2, TOOLTIP_MARGIN), Math.max(TOOLTIP_MARGIN, viewportWidth - width - TOOLTIP_MARGIN));
					...
					const chosen = anchor.side === "above" ? fitsAbove ? preferred : flipped : fitsBelow ? preferred : flipped;
					const top = Math.min(Math.max(chosen, TOOLTIP_MARGIN), Math.max(TOOLTIP_MARGIN, viewportHeight - height - TOOLTIP_MARGIN));
			...
			return (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				ref: cardRef,
				className: `${Insights_module_css_default.chartTooltipBox} ${Insights_module_css_default.chartTooltipPortal}`,
				children
			}), document.body);
		}
		...
		function SessionInsights({ value, now, running, waiting, onEvidence }) {
			...
			const [collapsed, setCollapsed] = (0, react.useState)(() => {
				try {
					return globalThis.localStorage?.getItem("dsh-watcher:hud-collapsed") === "1";
				} catch {
					return false;
				}
			});
			const toggleCollapsed = () => {
				setCollapsed((c) => {
					try {
						globalThis.localStorage?.setItem("dsh-watcher:hud-collapsed", c ? "0" : "1");
					} catch {}
					return !c;
				});
			};
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: Insights_module_css_default.costStat,
									title: costTitle,
									"aria-label": `${copy.estimatedCost}: ${costText}`,
									children: [
										copy.estimatedCost,
										" ",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: costText })
									]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: Insights_module_css_default.collapseBtn,
									"aria-expanded": !collapsed,
									"aria-label": collapsed ? "展开耗时统计" : "收起耗时统计",
									title: collapsed ? "展开耗时统计" : "收起耗时统计",
									onClick: toggleCollapsed,
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: Insights_module_css_default.collapseChevron,
										"aria-hidden": "true",
										children: "▾"
									})
								})
					...
					!collapsed && scope === "session" && isMultiModel ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					collapsed ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function InsightsSettings(props) {
			...
			const [overrideText, setOverrideText] = (0, react.useState)(() => effectivePricingText(globalThis.localStorage));
			const [overrideError, setOverrideError] = (0, react.useState)("");
			const [overrideSaved, setOverrideSaved] = (0, react.useState)(false);
			const userPickedRange = (0, react.useRef)(false);
			...
			const [hoveredDayAnchor, setHoveredDayAnchor] = (0, react.useState)(null);
			const [hoveredLineIdx, setHoveredLineIdx] = (0, react.useState)(null);
			const [hoveredLineAnchor, setHoveredLineAnchor] = (0, react.useState)(null);
			const [hoveredHeatmapDay, setHoveredHeatmapDay] = (0, react.useState)(null);
			const [hoveredHeatmapAnchor, setHoveredHeatmapAnchor] = (0, react.useState)(null);
			...
			const refresh = () => {
				...
				setLoading(true);
				scanSessions(props.remote, { limit: 300 }).then((res) => {
					if (mountedRef.current) setSessions(res);
				}).catch(console.error).finally(() => {
			...
			const analytics = (0, react.useMemo)(() => {
				...
				const daySeries = keys.map((key) => {
					...
					const dObj = /* @__PURE__ */ new Date(key + "T00:00:00");
				...
				heatmapStart.setDate(currentWeekSunday.getDate() - 181);
				...
				for (let w = 0; w < numWeeks; w++) {
					const daysInWeek = [];
					let monthStartingInThisWeek = null;
					for (let d = 0; d < 7; d++) {
						...
						if (cur.getDate() === 1) monthStartingInThisWeek = month;
					...
					if (monthStartingInThisWeek !== null) heatmapMonthLabels.push({
						colIndex: w,
						label: `${monthStartingInThisWeek + 1}月`
					});
					heatmapWeeks.push({
						weekIndex: w,
						days: daysInWeek
				...
				const estimatedCost = estimateUsageRows(uniqueModels.length > 0 ? uniqueModels : [{
					model: "未标注",
					tokens: totalTokens,
					input: totalInput,
					output: totalOutput,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: Insights_module_css_default.heroPair,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Insights_module_css_default.heroMetric,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: Insights_module_css_default.heroCaption,
									children: "Token"
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
									className: Insights_module_css_default.heroValue,
									children: analytics ? fmtCompact(analytics.totalTokens) : "-"
								})]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Insights_module_css_default.heroMetric,
								title: heroCostTitle,
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: Insights_module_css_default.heroCaption,
										children: copy.estimatedCost
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
										className: Insights_module_css_default.heroValue,
										children: heroCostText
									}),
									heroCostNote ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: Insights_module_css_default.heroFootnote,
										children: heroCostNote
									}) : null
								]
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								activeViewMode === "bar" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: analytics && analytics.daySeries.length > 0 && (() => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [hoveredPoint && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ChartTooltip, {
					...
					analytics && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								}), hoveredHeatmapDay ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: Insights_module_css_default.heatmapLiveHud,
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: Insights_module_css_default.heatmapLiveDate,
											children: [
												hoveredHeatmapDay.date,
												" ",
												hoveredHeatmapDay.isToday ? "(今天)" : "",
												" · ",
												hoveredHeatmapDay.weekday
											]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											className: Insights_module_css_default.heatmapLiveTokens,
											children: hoveredHeatmapDay.tokens > 0 ? `${fmtCompact(hoveredHeatmapDay.tokens)} Token · ${hoveredHeatmapDay.sessions} 个会话` : "无调用活动"
										}),
										hoveredHeatmapDay.models[0] && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: Insights_module_css_default.heatmapLiveModel,
											children: [
												"主力: ",
												hoveredHeatmapDay.models[0].model,
												" (",
												hoveredHeatmapDay.models[0].pct,
												"%)"
											]
										})
									]
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: Insights_module_css_default.chartInteractiveWrap,
								onMouseLeave: () => {
									setHoveredHeatmapDay(null);
									setHoveredHeatmapAnchor(null);
								},
								children: [hoveredHeatmapDay && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ChartTooltip, {
									anchor: hoveredHeatmapAnchor,
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: Insights_module_css_default.chartTooltipDate,
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: analytics.heatmapWeeks.map((w) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
													...
													children: w.days.map((d) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
														className: `${Insights_module_css_default.heatmapCell} ${d.isToday ? Insights_module_css_default.heatmapCellToday : ""} ${hoveredHeatmapDay?.date === d.date ? Insights_module_css_default.heatmapCellActive : ""}`,
														"data-level": d.level,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "只读汇总本地已缓存对话。方块深浅代表当天 Token 消耗强度（自适应四分位数分阶）。" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											...
											style: {
												...
												border: "1px solid rgba(86, 134, 254, 0.35)"
											}
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: Insights_module_css_default.heatmapLegendCell,
											style: {
												background: "rgba(86, 134, 254, 0.45)",
												border: "1px solid rgba(86, 134, 254, 0.60)"
											}
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: Insights_module_css_default.heatmapLegendCell,
											style: {
												background: "rgba(86, 134, 254, 0.72)",
												border: "1px solid rgba(86, 134, 254, 0.88)"
											}
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: Insights_module_css_default.heatmapLegendCell,
											style: {
												...
												boxShadow: "0 0 6px rgba(86, 134, 254, 0.45)"
											}
										}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
							...
							children: copy.priceOverrideTitle
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: Insights_module_css_default.settingsDrawerContent,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: Insights_module_css_default.priceOverrideHelp,
									children: copy.priceOverrideHelp
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
									className: Insights_module_css_default.priceOverrideInput,
									rows: 8,
									spellCheck: false,
								...
								overrideError ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									className: Insights_module_css_default.priceOverrideError,
									children: overrideError
								}) : null,
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: Insights_module_css_default.priceOverrideActions,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										...
										onClick: () => {
											try {
												...
												setTimeout(() => setOverrideSaved(false), 2e3);
											} catch {
												setOverrideError(copy.priceOverrideInvalid);
											}
										},
										children: overrideSaved ? copy.priceOverrideSaved : copy.priceOverrideSave
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: Insights_module_css_default.settingsResetBtn,
										onClick: () => {
											setOverrideText(clearPricingEditor(globalThis.localStorage));
											window.dispatchEvent(new CustomEvent("watcher-pricing-settings"));
											setOverrideError("");
										},
										children: copy.priceOverrideReset
									})]
								})
							]
						})]
		...
		*/
		...
		const INSPECTOR_EXIT_FALLBACK_MS = 570;
		...
		function ExecutionInspector({ group, selectedItemId, live, now, closing, onSelectItem, onBack, onExited }) {
		...
		function ReadyWatcher({ useSession, useSessionStatus, useProjection, sessionId, loadAllHistory, chat, views }) {
			...
			const [inspectorClosing, setInspectorClosing] = (0, react.useState)(false);
			const inspectorExitTimer = (0, react.useRef)(null);
			const inspectorExitToLatest = (0, react.useRef)(false);
			const [panelPin, setPanelPin] = (0, react.useState)(null);
			const panelPinTimer = (0, react.useRef)(null);
			...
			const resizeStart = (0, react.useRef)(null);
			/** The natural size the panel opened at — the floor; resize can only grow. */
			const resizeMin = (0, react.useRef)(null);
			...
			*/
			const locateEvidence = (e) => {
				pinForDisclosure();
				setDisclosure(chooseDisclosureDepth("detail"));
				const turn = picture.turns.find((t) => t.turn === e.turn);
				const group = turn?.groups.find((g) => g.items.some((i) => i.status === "failure" && e.steps.includes(i.step ?? -1)));
				...
				} else requestAnimationFrame(() => document.getElementById(`watcher-turn-${e.turn}`)?.scrollIntoView({ block: "nearest" }));
			};
			const onRailScroll = () => {
			...
			*/
			const onResizeStart = (event, axes) => {
				...
				if (panelPos === null) setPanelPos({
					left: rect.left,
					top: rect.top
				});
				setPanelPin(null);
				if (resizeMin.current === null) resizeMin.current = {
					w: rect.width,
					h: rect.height
				};
				resizeStart.current = {
			...
			*/
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					style: (() => {
						const pos = panelPos !== null ? panelPos : panelPin === null ? panelPosition ?? UNPLACED_PANEL_STYLE : {
							top: panelPin.top,
							right: panelPin.right,
							left: "auto"
						};
						return panelSize === null ? pos : {
							...pos,
					...
					"data-sized": panelSize !== null ? "" : void 0,
					...
					children: [
						selected === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ExecutionInspector, {
							group: selected,
							selectedItemId,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [
								...
								!ui.follow && ui.unread > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									...
									onClick: selected === void 0 ? backToLatest : () => closeInspector(true),
									children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Watcher_module_css_default.resizeEdgeRight,
							"aria-hidden": "true",
							onPointerDown: (e) => onResizeStart(e, "x")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Watcher_module_css_default.resizeEdgeBottom,
							"aria-hidden": "true",
							onPointerDown: (e) => onResizeStart(e, "y")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Watcher_module_css_default.resizeGrip,
							"aria-hidden": "true",
							title: "拖动调整大小",
