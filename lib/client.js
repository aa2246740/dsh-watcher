	...
	factory: (require) => {
		...
		*/
		...
		var Insights_module_css_default = {
			...
			"heatmapCellToday": "rj7JOq_heatmapCellToday",
			...
			"heatmapLiveDate": "rj7JOq_heatmapLiveDate",
			"heatmapLiveHud": "rj7JOq_heatmapLiveHud",
			"heatmapLiveModel": "rj7JOq_heatmapLiveModel",
			"heatmapLiveTokens": "rj7JOq_heatmapLiveTokens",
									...
									children: analytics && analytics.daySeries.length > 0 && (() => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [hoveredPoint && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												style: {
													left: `${leftPos}%`,
													top: (hoveredPoint.modelStacks[hoveredPoint.modelStacks.length - 1]?.topY ?? 60) < 90 ? `${(hoveredPoint.modelStacks[hoveredPoint.modelStacks.length - 1]?.topY ?? 60) + 16}px` : `${(hoveredPoint.modelStacks[hoveredPoint.modelStacks.length - 1]?.topY ?? 60) - 12}px`,
													transform: (hoveredPoint.modelStacks[hoveredPoint.modelStacks.length - 1]?.topY ?? 60) < 90 ? "translateX(-50%)" : "translate(-50%, -100%)"
												},
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
														className: Insights_module_css_default.chartTooltipDate,
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [hoveredHeatmapDay && hoveredHeatmapPos && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									style: {
										...
										top: hoveredHeatmapPos.flipDown ? `${hoveredHeatmapPos.y + 24}px` : `${hoveredHeatmapPos.y - 12}px`,
										transform: hoveredHeatmapPos.flipDown ? "translate(-50%, 0)" : "translate(-50%, -100%)"
									},
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: Insights_module_css_default.chartTooltipDate,
