window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dshx-css-module:/Users/wu/Documents/ChatGPT/dsgx/issue-audit/watcher/src/client/Watcher.module.css.mjs
		const css = ".lEimMq_root{--watcher-panel-max-height:min(680px, calc(100vh - 112px));--watcher-motion-fast:.14s;--watcher-motion-panel:.18s;--watcher-ease-out:cubic-bezier(.2, .8, .2, 1);position:relative}.lEimMq_trigger{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:32px;height:32px;color:var(--dsw-alias-label-primary);cursor:pointer;transition:background-color var(--watcher-motion-fast) ease, border-color var(--watcher-motion-fast) ease, color var(--watcher-motion-fast) ease, transform .1s ease;background:0 0;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.lEimMq_trigger:hover:not(:disabled),.lEimMq_trigger:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_trigger:active{transform:scale(.96)}.lEimMq_trigger:focus-visible{outline:2px solid var(--dsw-static-deepseek-450);outline-offset:2px}.lEimMq_trigger[data-open]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-static-deepseek-450)}.lEimMq_trigger[data-live]{color:var(--dsw-static-deepseek-450)}.lEimMq_trigger[data-alert]{color:var(--dsw-alias-state-error-primary)}.lEimMq_eye,.lEimMq_eyeBlink,.lEimMq_eyePupil{transform-box:fill-box;transform-origin:50%;display:block}.lEimMq_trigger[data-live] .lEimMq_eyePupil{animation:lEimMq_watcher-eye-scan 2.8s var(--watcher-ease-out) infinite}.lEimMq_trigger[data-live] .lEimMq_eyeBlink{animation:5.2s ease-in-out infinite lEimMq_watcher-eye-blink}@keyframes lEimMq_watcher-eye-scan{0%,12%,92%,to{transform:translate(0)}30%{transform:translate(1.35px)}54%{transform:translate(-1.2px)}74%{transform:translate(.8px)}}@keyframes lEimMq_watcher-eye-blink{0%,42%,44.5%,to{transform:scaleY(1)}43.2%{transform:scaleY(.12)}}.lEimMq_menu{z-index:1100;--watcher-panel-max-height:min(680px, calc(100vh - 24px));--watcher-motion-fast:.14s;--watcher-motion-panel:.18s;--watcher-ease-out:cubic-bezier(.2, .8, .2, 1);box-sizing:border-box;max-width:calc(100vw - 24px);max-height:var(--watcher-panel-max-height);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);transform-origin:100% 0;animation:lEimMq_watcher-panel-enter var(--watcher-motion-panel) var(--watcher-ease-out);isolation:isolate;border-radius:12px;align-items:stretch;font-size:13px;line-height:20px;display:flex;position:fixed;top:auto;left:auto;right:auto;overflow:hidden}@keyframes lEimMq_watcher-panel-enter{0%{opacity:0;transform:translateY(-5px)scale(.992)}to{opacity:1;transform:translateY(0)scale(1)}}.lEimMq_workPicture{width:374px;min-width:0;min-height:290px;max-height:var(--watcher-panel-max-height);background:var(--dsw-specific-menu);flex-direction:column;flex:none;display:flex}.lEimMq_pictureHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:flex-start;gap:12px;padding:16px 14px 14px 16px;display:flex}.lEimMq_nowBlock{min-width:0}.lEimMq_eyebrow{color:var(--dsw-static-deepseek-450);text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:5px;font-size:12px;font-weight:500;line-height:18px;display:flex;overflow:hidden}.lEimMq_eyebrow[data-alert]{color:var(--dsw-alias-state-error-primary)}.lEimMq_now{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin-top:2px;font-size:17px;font-weight:600;line-height:24px;overflow:hidden}.lEimMq_summary{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;align-items:center;margin-top:4px;font-size:12px;line-height:18px;display:flex}.lEimMq_summary span+span:before{content:\"·\";color:var(--dsw-alias-label-dimmed);margin:0 6px}.lEimMq_summary [data-partial]{color:var(--dsw-alias-state-warn-primary)}.lEimMq_sessionTiming{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex:none;grid-template-columns:repeat(3,minmax(0,1fr));margin:0;padding:9px 10px;display:grid}.lEimMq_sessionTimingMetric{min-width:0;padding:0 8px}.lEimMq_sessionTimingMetric+.lEimMq_sessionTimingMetric{border-left:1px solid var(--dsw-alias-border-l2)}.lEimMq_sessionTimingMetric dt,.lEimMq_sessionTimingMetric dd{text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.lEimMq_sessionTimingMetric dt{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.lEimMq_sessionTimingMetric dd{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;line-height:19px}.lEimMq_viewToolbar{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);flex-wrap:wrap;flex:none;justify-content:space-between;align-items:center;gap:6px 14px;min-height:42px;padding:6px 14px;display:flex}.lEimMq_viewControl{align-items:center;gap:6px;min-width:0;display:flex}.lEimMq_viewToolbarLabel{color:var(--dsw-alias-label-tertiary);white-space:nowrap;font-size:12px;line-height:18px}.lEimMq_viewMode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:7px;flex:none;grid-template-columns:repeat(2,minmax(42px,1fr));padding:2px;display:inline-grid}.lEimMq_viewMode button{min-height:26px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:5px;padding:2px 9px;font-size:12px;line-height:18px}.lEimMq_viewMode button:hover{color:var(--dsw-alias-label-primary)}.lEimMq_viewMode button[data-active]{background:var(--dsw-specific-menu);box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);font-weight:600}.lEimMq_historyNotice{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex:none;align-items:center;gap:10px;min-height:48px;padding:7px 14px 8px 16px;display:flex}.lEimMq_historyNoticeCopy{flex-direction:column;flex:1;min-width:0;display:flex}.lEimMq_historyNoticeCopy strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;line-height:18px;overflow:hidden}.lEimMq_historyNoticeCopy span{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:16px;overflow:hidden}.lEimMq_historyNotice button{border:1px solid var(--dsw-alias-button-ghost-active-border);background:var(--dsw-specific-menu);min-height:28px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:7px;flex:none;padding:3px 9px;font-size:12px;line-height:18px}.lEimMq_historyNotice button:hover:not(:disabled){background:var(--dsw-alias-button-ghost-active-hover)}.lEimMq_historyNotice button:disabled{color:var(--dsw-alias-label-tertiary);cursor:progress}.lEimMq_follow{white-space:nowrap;flex:none;margin-top:2px}.lEimMq_unread{border:1px solid var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);width:calc(100% - 28px);min-height:34px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:8px;justify-content:center;align-items:center;gap:6px;margin:10px 14px 0;font-size:12px;display:inline-flex}.lEimMq_unread:hover{background:var(--dsw-alias-button-ghost-active-hover)}.lEimMq_unread:focus-visible,.lEimMq_turnToggle:focus-visible,.lEimMq_phaseToggle:focus-visible,.lEimMq_stepToggle:focus-visible,.lEimMq_analysisClusterToggle:focus-visible,.lEimMq_modelStageToggle:focus-visible,.lEimMq_reasoningToggle:focus-visible,.lEimMq_groupedModelToggle:focus-visible,.lEimMq_viewMode button:focus-visible,.lEimMq_historyNotice button:focus-visible,.lEimMq_overviewOccurrence:focus-visible,.lEimMq_inspectorBack:focus-visible,.lEimMq_occurrence:focus-visible,.lEimMq_tab:focus-visible,.lEimMq_copyRaw:focus-visible{outline:2px solid var(--dsw-static-deepseek-450);outline-offset:-2px}.lEimMq_railViewport{overscroll-behavior:contain;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex:1;min-height:0;overflow:auto}.lEimMq_turns{padding:8px 10px 18px}.lEimMq_turn+.lEimMq_turn{border-top:1px solid var(--dsw-alias-border-l2);margin-top:12px;padding-top:12px}.lEimMq_turnHeader{padding:0 2px 2px}.lEimMq_turnHeader h2{margin:0}.lEimMq_turnToggle{box-sizing:border-box;width:100%;min-height:50px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:14px minmax(0,1fr) auto;align-items:center;gap:7px;padding:6px 8px;display:grid}.lEimMq_turnToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_turnChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out);transform:rotate(0)}.lEimMq_turnToggle[aria-expanded=true] .lEimMq_turnChevron{transform:rotate(90deg)}.lEimMq_turnCopy{flex-direction:column;min-width:0;display:flex}.lEimMq_turnTitleLine{align-items:center;gap:6px;min-width:0;display:flex}.lEimMq_turnTitle{color:var(--dsw-alias-label-secondary);font-size:13px;font-weight:600;line-height:20px}.lEimMq_turnSummary,.lEimMq_turnDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:400;line-height:18px}.lEimMq_turnSummary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.lEimMq_turnPerformance{white-space:nowrap;flex-direction:column;align-items:flex-end;min-width:62px;display:flex}.lEimMq_turnDuration{white-space:nowrap}.lEimMq_turnSpeed{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:500;line-height:18px}.lEimMq_turnMetrics{background:var(--dsw-alias-bg-layer-2);border-radius:7px;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin:2px 8px 9px 36px;padding:7px 9px;display:grid}.lEimMq_turnMetric{min-width:0}.lEimMq_turnMetric dt,.lEimMq_turnMetric dd{text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.lEimMq_turnMetric dt{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:17px}.lEimMq_turnMetric dd{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;line-height:19px}.lEimMq_turnBody[hidden]{display:none}.lEimMq_groupRail{padding-left:18px;position:relative}.lEimMq_railLine{background:var(--dsw-alias-border-l2);pointer-events:none;width:1px;position:absolute;top:18px;bottom:18px;left:23px}.lEimMq_phase{z-index:1;box-sizing:border-box;width:100%;padding:3px 0 11px;position:relative}.lEimMq_phase+.lEimMq_phase{margin-top:4px}.lEimMq_phaseHeader{position:relative}.lEimMq_phaseToggle{box-sizing:border-box;width:100%;min-height:42px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:7px;grid-template-columns:10px 12px minmax(0,1fr);align-items:center;gap:6px;padding:3px 8px 3px 0;display:grid;position:relative}.lEimMq_phaseToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_phase[data-now]>.lEimMq_phaseHeader .lEimMq_phaseToggle{background:var(--dsw-alias-bg-layer-2);border-radius:7px}.lEimMq_phaseChevron,.lEimMq_stepChevron,.lEimMq_analysisClusterChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out);transform:rotate(0)}.lEimMq_phaseToggle[aria-expanded=true] .lEimMq_phaseChevron,.lEimMq_stepToggle[aria-expanded=true] .lEimMq_stepChevron,.lEimMq_analysisClusterToggle[aria-expanded=true] .lEimMq_analysisClusterChevron{transform:rotate(90deg)}.lEimMq_phaseMarker{box-sizing:border-box;background:var(--dsw-alias-label-tertiary);width:10px;height:10px;box-shadow:0 0 0 4px var(--dsw-specific-menu);border-radius:50%;display:block;position:relative}.lEimMq_phaseMarker[data-state=active],.lEimMq_phaseMarker[data-state=current]{background:var(--dsw-static-deepseek-450)}.lEimMq_phaseMarker[data-state=waiting]{background:var(--dsw-alias-state-warn-primary)}.lEimMq_phaseMarker[data-state=failure],.lEimMq_phaseMarker[data-state=interrupted]{background:var(--dsw-alias-state-error-primary)}.lEimMq_phaseMarker[data-state=partial]{border:1px dashed var(--dsw-alias-label-tertiary);background:var(--dsw-specific-menu)}.lEimMq_neutralDot{border:1px solid var(--dsw-alias-label-tertiary);background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:10px;height:10px;display:inline-block;position:relative}.lEimMq_neutralDot[data-status=unknown]{background:var(--dsw-specific-menu);border-style:dashed}.lEimMq_phaseCopy,.lEimMq_occurrenceCopy{flex-direction:column;min-width:0;display:flex}.lEimMq_phaseTitleLine{align-items:center;gap:6px;min-width:0;display:flex}.lEimMq_phaseTitle{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:550;line-height:21px;overflow:hidden}.lEimMq_phaseMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;margin-top:1px;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_groupBadges{flex:none;align-items:center;gap:4px;display:inline-flex}.lEimMq_groupBadges span,.lEimMq_overviewTag,.lEimMq_patternLabel,.lEimMq_parallelLabel{border:1px solid var(--dsw-alias-border-l2);min-height:18px;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:999px;align-items:center;padding:0 5px;font-size:11px;font-weight:500;line-height:16px;display:inline-flex}.lEimMq_groupBadges [data-kind=retry]{color:var(--dsw-alias-state-error-primary)}.lEimMq_groupBadges [data-kind=parallel],.lEimMq_overviewTag[data-state=active],.lEimMq_overviewTag[data-state=current]{color:var(--dsw-static-deepseek-450)}.lEimMq_overviewTag[data-state=waiting]{color:var(--dsw-alias-state-warn-primary)}.lEimMq_overviewTag[data-state=failure],.lEimMq_overviewTag[data-state=interrupted]{color:var(--dsw-alias-state-error-primary)}.lEimMq_overviewTag[data-state=partial]{color:var(--dsw-alias-label-tertiary)}.lEimMq_occurrenceChevron{color:var(--dsw-alias-label-dimmed);opacity:0;transition:opacity var(--watcher-motion-fast) ease, transform var(--watcher-motion-fast) ease;flex:none;transform:translate(-2px)}.lEimMq_occurrence:hover .lEimMq_occurrenceChevron,.lEimMq_occurrence[data-selected] .lEimMq_occurrenceChevron,.lEimMq_occurrence:focus-visible .lEimMq_occurrenceChevron{opacity:1;transform:translate(0)}.lEimMq_stepTimeline{border-left:1px solid var(--dsw-alias-border-l2);margin:1px 8px 0 28px;padding-left:11px;position:relative}.lEimMq_overviewStep{min-width:0;position:relative}.lEimMq_overviewStep+.lEimMq_overviewStep{margin-top:10px;padding-top:8px}.lEimMq_overviewStep:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:13px;left:-12px}.lEimMq_overviewStepHeader{min-height:29px}.lEimMq_stepToggle{box-sizing:border-box;width:100%;min-height:29px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:6px;grid-template-columns:12px minmax(0,1fr) auto;align-items:center;gap:5px;padding:2px 4px 2px 0;display:grid}.lEimMq_stepToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_overviewStepLabel,.lEimMq_overviewStepSignals{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.lEimMq_overviewStepLabel{min-width:0;font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.lEimMq_overviewStepSignals{white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.lEimMq_overviewOccurrences{position:relative}.lEimMq_overviewStep[data-parallel] .lEimMq_overviewOccurrences{border-left:1px solid var(--dsw-static-deepseek-450);padding-left:5px}.lEimMq_modelStage{border-left:2px solid var(--dsw-static-deepseek-450);background:var(--dsw-alias-bg-layer-2);border-radius:0 7px 7px 0;min-width:0;margin:2px 2px 7px;overflow:hidden}.lEimMq_modelStage[data-live]{box-shadow:inset 0 0 0 1px var(--dsw-alias-button-ghost-active-border)}.lEimMq_modelStageToggle{box-sizing:border-box;width:100%;min-height:42px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px 8px minmax(0,1fr);align-items:center;gap:7px;padding:5px 9px 5px 7px;display:grid}.lEimMq_modelStageToggle:hover,.lEimMq_reasoningToggle:hover,.lEimMq_groupedModelToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_modelStageChevron,.lEimMq_reasoningChevron,.lEimMq_groupedModelChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out)}.lEimMq_modelStageToggle[aria-expanded=true] .lEimMq_modelStageChevron,.lEimMq_reasoningToggle[aria-expanded=true] .lEimMq_reasoningChevron,.lEimMq_groupedModelToggle[aria-expanded=true] .lEimMq_groupedModelChevron{transform:rotate(90deg)}.lEimMq_modelStageGlyph{background:var(--dsw-static-deepseek-450);width:7px;height:7px;box-shadow:0 0 0 3px var(--dsw-alias-button-ghost-active-fill);border-radius:999px}.lEimMq_modelStageCopy{grid-template-columns:auto minmax(0,1fr);align-items:baseline;gap:8px;min-width:0;display:grid}.lEimMq_modelStageTitle{color:var(--dsw-alias-label-primary);white-space:nowrap;font-size:13px;font-weight:600;line-height:20px}.lEimMq_modelStageSummary{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_modelStageBody{padding:2px 10px 10px 20px}.lEimMq_modelStageBar{background:var(--dsw-alias-border-l2);border-radius:999px;gap:2px;height:5px;margin:2px 0 10px;display:flex;overflow:hidden}.lEimMq_modelStageBar>span{border-radius:inherit;min-width:3px}.lEimMq_modelStageBar [data-segment=wait],.lEimMq_modelStageSwatch[data-segment=wait]{background:var(--dsw-alias-label-dimmed)}.lEimMq_modelStageBar [data-segment=reasoning],.lEimMq_modelStageSwatch[data-segment=reasoning]{background:var(--dsw-static-deepseek-450)}.lEimMq_modelStageBar [data-segment=output],.lEimMq_modelStageSwatch[data-segment=output]{background:var(--dsw-alias-label-secondary)}.lEimMq_modelStageBar [data-segment=unattributed],.lEimMq_modelStageSwatch[data-segment=unattributed]{background:var(--dsw-alias-state-warn-primary)}.lEimMq_modelStageLedger{grid-template-columns:minmax(0,1fr);gap:5px 12px;margin:0;display:grid}.lEimMq_modelStageMetric{min-width:0;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;justify-content:space-between;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.lEimMq_modelStageMetric dt,.lEimMq_modelStageMetric dd{margin:0}.lEimMq_modelStageMetric dt{align-items:center;gap:6px;min-width:0;display:inline-flex}.lEimMq_modelStageMetric dd{color:var(--dsw-alias-label-secondary);text-align:right;flex:none}.lEimMq_modelStageSwatch{border-radius:999px;flex:none;width:6px;height:6px}.lEimMq_modelStageNote{color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:12px;line-height:18px}.lEimMq_reasoningAttempts{border-top:1px solid var(--dsw-alias-border-l2);margin-top:8px;padding-top:1px}.lEimMq_reasoningDisclosure{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:6px;min-width:0;margin-top:5px;overflow:hidden}.lEimMq_reasoningToggle{box-sizing:border-box;width:100%;min-height:34px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px minmax(0,1fr);align-items:center;gap:6px;padding:5px 8px;display:grid}.lEimMq_reasoningLabel{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:550;line-height:20px}.lEimMq_reasoningMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-align:left;white-space:normal;grid-column:2;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_reasoningBody{box-sizing:border-box;border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);max-height:320px;color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);margin:0;padding:10px 12px;font-size:13px;line-height:1.6;overflow:auto}.lEimMq_reasoningBody>*{margin-top:0;margin-bottom:8px}.lEimMq_reasoningBody>:last-child{margin-bottom:0}.lEimMq_reasoningBody .md-code-block{max-width:100%}.lEimMq_groupedModelStages{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:7px;margin-bottom:9px;position:relative;overflow:hidden}.lEimMq_groupedModelStages:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:20px;left:-12px}.lEimMq_groupedModelToggle{box-sizing:border-box;width:100%;min-height:44px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px minmax(0,1fr);align-items:center;gap:7px;padding:5px 9px;display:grid}.lEimMq_groupedModelToggle>span{justify-content:space-between;align-items:baseline;gap:10px;min-width:0;display:flex}.lEimMq_groupedModelToggle strong{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.lEimMq_groupedModelToggle small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_groupedModelList{border-top:1px solid var(--dsw-alias-border-l2);padding:0 7px 8px 22px}.lEimMq_groupedModelStep{min-width:0;padding-top:8px}.lEimMq_groupedModelStep+.lEimMq_groupedModelStep{border-top:1px solid var(--dsw-alias-border-l2)}.lEimMq_groupedModelStepLabel{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);margin:0 2px 4px;font-size:12px;line-height:18px;display:block}.lEimMq_analysisClusters{border-left:1px solid var(--dsw-alias-border-l2);margin:1px 8px 0 28px;padding-left:11px;position:relative}.lEimMq_analysisCluster,.lEimMq_analysisSingleton{min-width:0;position:relative}.lEimMq_analysisCluster+.lEimMq_analysisCluster,.lEimMq_analysisCluster+.lEimMq_analysisSingleton,.lEimMq_analysisSingleton+.lEimMq_analysisCluster,.lEimMq_analysisSingleton+.lEimMq_analysisSingleton{margin-top:6px}.lEimMq_analysisCluster:before,.lEimMq_analysisSingleton:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:20px;left:-12px}.lEimMq_analysisClusterToggle{box-sizing:border-box;width:100%;min-height:46px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;grid-template-columns:12px 10px minmax(0,1fr) auto;align-items:center;gap:7px;padding:5px 6px 5px 4px;display:grid}.lEimMq_analysisClusterToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_analysisCluster[data-open]>.lEimMq_analysisClusterToggle{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2)}.lEimMq_analysisClusterDotSlot{width:10px;height:10px;display:block;position:relative}.lEimMq_analysisClusterDot{inset:0;position:absolute!important}.lEimMq_analysisClusterCopy{flex-direction:column;min-width:0;display:flex}.lEimMq_analysisClusterTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:550;line-height:20px;overflow:hidden}.lEimMq_analysisClusterMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_analysisClusterCount{min-width:28px;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;font-size:12px;font-weight:600;line-height:18px}.lEimMq_analysisClusterItems{border-left:1px solid var(--dsw-alias-border-l2);margin:3px 0 8px 17px;padding-left:5px}.lEimMq_overviewOccurrence{box-sizing:border-box;width:100%;min-height:45px;color:inherit;font:inherit;text-align:left;cursor:pointer;transition:background-color var(--watcher-motion-fast) var(--watcher-ease-out), border-color var(--watcher-motion-fast) var(--watcher-ease-out), box-shadow var(--watcher-motion-fast) var(--watcher-ease-out);animation:lEimMq_watcher-live-append var(--watcher-motion-fast) var(--watcher-ease-out);background:0 0;border:1px solid #0000;border-radius:7px;grid-template-columns:22px 10px minmax(0,1fr) auto 12px;align-items:center;gap:7px;padding:5px 5px 5px 7px;display:grid;position:relative}.lEimMq_overviewOccurrence+.lEimMq_overviewOccurrence{margin-top:2px}.lEimMq_overviewOccurrence:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_overviewOccurrence[data-current]:not([data-selected]){background:var(--dsw-alias-bg-layer-2)}.lEimMq_overviewOccurrence[data-selected]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);box-shadow:inset 2px 0 0 var(--dsw-static-deepseek-450)}.lEimMq_overviewOccurrenceIndex{color:var(--dsw-alias-label-dimmed);font-family:var(--dsw-font-mono);font-variant-numeric:tabular-nums;text-align:right;font-size:11px;line-height:18px}.lEimMq_overviewOccurrenceDotSlot{width:10px;height:10px;display:block;position:relative}.lEimMq_overviewOccurrenceDot{inset:0;position:absolute!important}.lEimMq_overviewOccurrenceCopy{flex-direction:column;min-width:0;display:flex}.lEimMq_overviewOccurrenceTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:550;line-height:20px;overflow:hidden}.lEimMq_overviewOccurrenceMeta{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_overviewOccurrenceDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:12px;line-height:18px}.lEimMq_overviewOccurrenceChevron{color:var(--dsw-alias-label-dimmed);opacity:0;transition:opacity var(--watcher-motion-fast) ease, transform var(--watcher-motion-fast) ease;transform:translate(-2px)}.lEimMq_overviewOccurrence:hover .lEimMq_overviewOccurrenceChevron,.lEimMq_overviewOccurrence[data-selected] .lEimMq_overviewOccurrenceChevron,.lEimMq_overviewOccurrence:focus-visible .lEimMq_overviewOccurrenceChevron{opacity:1;transform:translate(0)}@keyframes lEimMq_watcher-live-append{0%{opacity:.5;transform:translateY(-2px)}to{opacity:1;transform:translateY(0)}}.lEimMq_empty{min-height:250px;color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;padding:28px;display:flex}.lEimMq_emptyEye{color:var(--dsw-alias-label-secondary);margin-bottom:12px;display:inline-flex}.lEimMq_empty strong{color:var(--dsw-alias-label-secondary);font-size:14px;font-weight:600;line-height:21px}.lEimMq_empty>span:last-child{margin-top:4px;font-size:12px;line-height:18px}.lEimMq_inspector{width:438px;min-width:0;max-height:var(--watcher-panel-max-height);border-right:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;display:flex}.lEimMq_inspectorHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;padding:16px 16px 14px}.lEimMq_inspectorBack{min-height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:5px;margin:-4px 0 8px -6px;padding:0 7px 0 5px;font-size:12px;display:none}.lEimMq_inspectorBack:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_inspectorBack svg{transform:rotate(180deg)}.lEimMq_statusLine,.lEimMq_detailStatus{color:var(--dsw-alias-label-secondary);align-items:center;gap:7px;font-size:12px;line-height:18px;display:flex}.lEimMq_statusLine[data-status=failure],.lEimMq_statusLine[data-status=interrupted],.lEimMq_detailStatus[data-status=failure],.lEimMq_detailStatus[data-status=interrupted]{color:var(--dsw-alias-state-error-primary)}.lEimMq_statusLine[data-status=running],.lEimMq_detailStatus[data-status=running]{color:var(--dsw-static-deepseek-450)}.lEimMq_statusLine[data-status=waiting],.lEimMq_detailStatus[data-status=waiting]{color:var(--dsw-alias-state-warn-primary)}.lEimMq_location{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;margin-left:auto}.lEimMq_inspectorTitle{color:var(--dsw-alias-label-primary);margin:8px 0 0;font-size:18px;font-weight:600;line-height:25px}.lEimMq_inspectorSummary{color:var(--dsw-alias-label-tertiary);margin:3px 0 0;font-size:12px;line-height:18px}.lEimMq_groupSignals{flex-wrap:wrap;gap:6px;margin-top:10px;display:flex}.lEimMq_groupSignals span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px}.lEimMq_groupSignals span+span:before{content:\"·\";color:var(--dsw-alias-label-dimmed);margin-right:6px}.lEimMq_groupSignals [data-retry]{color:var(--dsw-alias-state-warn-primary)}.lEimMq_groupSignals [data-error]{color:var(--dsw-alias-state-error-primary)}.lEimMq_inspectorBody{overscroll-behavior:contain;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex:1;min-height:0;overflow:auto}.lEimMq_executionSection{border-bottom:1px solid var(--dsw-alias-border-l2);padding:14px 16px 16px}.lEimMq_sectionHeading{justify-content:space-between;align-items:center;gap:12px;margin-bottom:8px;display:flex}.lEimMq_sectionHeading h3{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;font-weight:600;line-height:20px}.lEimMq_sectionHeading>span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px}.lEimMq_executionList{max-height:188px;padding-right:2px;overflow:auto}.lEimMq_stepBlock+.lEimMq_stepBlock{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:10px}.lEimMq_stepHeading{min-height:22px;color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);font-variant-numeric:tabular-nums;justify-content:space-between;align-items:center;gap:8px;padding:0 3px;font-size:12px;display:flex}.lEimMq_stepSignals{align-items:center;gap:6px;min-width:0;display:inline-flex}.lEimMq_stepDuration{color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-family);font-variant-numeric:tabular-nums;white-space:nowrap}.lEimMq_parallelLabel{color:var(--dsw-static-deepseek-450);font-family:var(--dsw-font-family)}.lEimMq_occurrences{margin-top:4px;position:relative}.lEimMq_stepBlock[data-parallel] .lEimMq_occurrences{border-left:1px solid var(--dsw-static-deepseek-450);padding-left:10px}.lEimMq_occurrence{box-sizing:border-box;width:100%;min-height:46px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:8px;grid-template-columns:10px minmax(0,1fr) auto 13px;align-items:center;gap:8px;padding:6px 7px;transition:background-color .14s,border-color .14s;display:grid}.lEimMq_occurrenceDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:12px;line-height:18px}.lEimMq_occurrence+.lEimMq_occurrence{margin-top:2px}.lEimMq_occurrence:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_occurrence[data-selected]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill)}.lEimMq_occurrenceTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:550;line-height:19px;overflow:hidden}.lEimMq_occurrenceMeta{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.lEimMq_detailSection{padding:16px}.lEimMq_detailHeader{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:14px;display:grid}.lEimMq_detailIdentity{min-width:0}.lEimMq_detailIdentity h3{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);margin:6px 0 0;font-size:16px;font-weight:600;line-height:23px}.lEimMq_detailIdentity p{overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);margin:3px 0 0;font-size:12px;line-height:18px}.lEimMq_patternLabel{color:var(--dsw-alias-state-warn-primary)}.lEimMq_metrics{font-variant-numeric:tabular-nums;grid-template-columns:auto auto;gap:2px 8px;margin:0;font-size:12px;line-height:18px;display:grid}.lEimMq_metrics dt{color:var(--dsw-alias-label-tertiary)}.lEimMq_metrics dd{color:var(--dsw-alias-label-secondary);text-align:right;margin:0}.lEimMq_metrics [data-error]{color:var(--dsw-alias-state-error-primary)}.lEimMq_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:end;gap:4px;margin-top:16px;display:flex}.lEimMq_tab{min-width:56px;min-height:36px;color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:0 10px;font-size:13px;position:relative}.lEimMq_tab:hover{color:var(--dsw-alias-label-primary)}.lEimMq_tab[data-active]{color:var(--dsw-alias-label-primary);font-weight:600}.lEimMq_tab[data-active]:after{content:\"\";background:var(--dsw-static-deepseek-450);border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:9px;right:9px}.lEimMq_tabPanel{--dsl-terminal-font:400 13px/22px var(--dsw-font-mono);min-height:116px;padding-top:12px}.lEimMq_tabPanel>*{margin-top:0;margin-bottom:0}.lEimMq_jsonSurface{font-size:13px;overflow:auto}.lEimMq_jsonSurface [role=tree]{font-size:13px;line-height:20px}.lEimMq_rawPanel pre{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-mono);tab-size:2;margin:0;font-size:13px;line-height:20px;overflow:auto}.lEimMq_documentResult{min-width:0;color:var(--dsw-alias-label-primary);padding:2px 2px 8px}.lEimMq_documentResult .md-code-block{max-width:100%}.lEimMq_documentResult blockquote{color:var(--dsw-alias-label-secondary)}.lEimMq_documentResult table{font-variant-numeric:tabular-nums}.lEimMq_rawPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:8px;overflow:hidden}.lEimMq_rawToolbar{border-bottom:1px solid var(--dsw-alias-border-l2);min-height:38px;color:var(--dsw-alias-label-tertiary);justify-content:space-between;align-items:center;gap:12px;padding:0 10px 0 12px;font-size:12px;display:flex}.lEimMq_copyRaw{min-height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:5px;padding:0 6px;font-size:12px;display:inline-flex}.lEimMq_copyRaw:hover{background:var(--dsw-alias-interactive-bg-hover)}.lEimMq_rawPanel pre{white-space:pre;max-height:320px;padding:12px}.lEimMq_artifactResult,.lEimMq_detailEmpty{border:1px solid var(--dsw-alias-border-l2);min-height:116px;color:var(--dsw-alias-label-tertiary);text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;padding:18px;font-size:13px;display:flex}.lEimMq_artifactResult strong{color:var(--dsw-alias-label-secondary);margin-top:6px;font-size:14px}.lEimMq_artifactResult>span{margin-top:2px;font-size:12px}.lEimMq_artifactResult .lEimMq_jsonSurface{text-align:left;width:100%;margin-top:12px}.lEimMq_artifactGlyph{color:var(--dsw-static-deepseek-450);font-size:24px;line-height:28px}.lEimMq_inspectorFooter{border-top:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);flex:none;padding:9px 16px;font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.lEimMq_menu,.lEimMq_trigger[data-live] .lEimMq_eyePupil,.lEimMq_trigger[data-live] .lEimMq_eyeBlink{animation:none}.lEimMq_trigger,.lEimMq_overviewOccurrence,.lEimMq_turnChevron,.lEimMq_phaseChevron,.lEimMq_stepChevron,.lEimMq_analysisClusterChevron,.lEimMq_modelStageChevron,.lEimMq_reasoningChevron,.lEimMq_groupedModelChevron,.lEimMq_occurrence,.lEimMq_overviewOccurrenceChevron,.lEimMq_occurrenceChevron{transition-duration:.01ms}.lEimMq_overviewOccurrence{animation:none}.lEimMq_root [data-state=ongoing] rect,.lEimMq_menu [data-state=ongoing] rect{opacity:.55;animation:none!important}}@media (width<=860px){.lEimMq_menu{flex-direction:column-reverse;width:min(500px,100vw - 24px);max-height:calc(100vh - 88px)}.lEimMq_workPicture{width:auto;min-height:250px;max-height:none}.lEimMq_menu:not(:has(.lEimMq_inspector)){height:min(680px,100vh - 88px)}.lEimMq_menu:not(:has(.lEimMq_inspector)) .lEimMq_workPicture{flex:auto}.lEimMq_inspector{border-right:0;width:auto;max-height:none}.lEimMq_menu:has(.lEimMq_inspector){height:min(680px,100vh - 88px)}.lEimMq_menu:has(.lEimMq_inspector) .lEimMq_workPicture{display:none}.lEimMq_menu:has(.lEimMq_inspector) .lEimMq_inspector{flex:auto;min-height:0;max-height:none}.lEimMq_inspectorBack{display:inline-flex}.lEimMq_inspectorHeader{padding-top:14px}.lEimMq_executionList{max-height:150px}}@media (width<=520px){.lEimMq_menu{width:calc(100vw - 24px)}.lEimMq_pictureHeader{padding:14px 12px}.lEimMq_now{font-size:16px}.lEimMq_turns{padding-inline:6px}.lEimMq_groupBadges span:nth-child(n+2){display:none}.lEimMq_inspectorHeader,.lEimMq_executionSection,.lEimMq_detailSection{padding-inline:12px}.lEimMq_detailHeader{grid-template-columns:1fr}.lEimMq_metrics{grid-template-columns:auto 1fr}.lEimMq_metrics dd{text-align:left}.lEimMq_modelStageCopy{grid-template-columns:1fr;gap:0}.lEimMq_modelStageSummary{white-space:normal}.lEimMq_modelStageLedger{grid-template-columns:1fr}.lEimMq_reasoningToggle{grid-template-columns:12px minmax(0,1fr)}.lEimMq_reasoningMeta{text-align:left;white-space:normal;grid-column:2}.lEimMq_groupedModelToggle>span{gap:0;display:grid}.lEimMq_groupedModelToggle small{white-space:normal}.lEimMq_groupedModelList{padding-left:12px}}";
		...
		var Watcher_module_css_default = {
			"analysisCluster": "lEimMq_analysisCluster",
			"analysisClusterChevron": "lEimMq_analysisClusterChevron",
			"analysisClusterCopy": "lEimMq_analysisClusterCopy",
			"analysisClusterCount": "lEimMq_analysisClusterCount",
			"analysisClusterDot": "lEimMq_analysisClusterDot",
			"analysisClusterDotSlot": "lEimMq_analysisClusterDotSlot",
			"analysisClusterItems": "lEimMq_analysisClusterItems",
			"analysisClusterMeta": "lEimMq_analysisClusterMeta",
			"analysisClusters": "lEimMq_analysisClusters",
			"analysisClusterTitle": "lEimMq_analysisClusterTitle",
			"analysisClusterToggle": "lEimMq_analysisClusterToggle",
			"analysisSingleton": "lEimMq_analysisSingleton",
			"artifactGlyph": "lEimMq_artifactGlyph",
			"artifactResult": "lEimMq_artifactResult",
			"copyRaw": "lEimMq_copyRaw",
			"detailEmpty": "lEimMq_detailEmpty",
			"detailHeader": "lEimMq_detailHeader",
			"detailIdentity": "lEimMq_detailIdentity",
			"detailSection": "lEimMq_detailSection",
			"detailStatus": "lEimMq_detailStatus",
			"documentResult": "lEimMq_documentResult",
			"empty": "lEimMq_empty",
			"emptyEye": "lEimMq_emptyEye",
			"executionList": "lEimMq_executionList",
			"executionSection": "lEimMq_executionSection",
			"eye": "lEimMq_eye",
			"eyeBlink": "lEimMq_eyeBlink",
			"eyebrow": "lEimMq_eyebrow",
			"eyePupil": "lEimMq_eyePupil",
			"follow": "lEimMq_follow",
			"groupBadges": "lEimMq_groupBadges",
			"groupedModelChevron": "lEimMq_groupedModelChevron",
			"groupedModelList": "lEimMq_groupedModelList",
			"groupedModelStages": "lEimMq_groupedModelStages",
			"groupedModelStep": "lEimMq_groupedModelStep",
			"groupedModelStepLabel": "lEimMq_groupedModelStepLabel",
			"groupedModelToggle": "lEimMq_groupedModelToggle",
			"groupRail": "lEimMq_groupRail",
			"groupSignals": "lEimMq_groupSignals",
			"historyNotice": "lEimMq_historyNotice",
			"historyNoticeCopy": "lEimMq_historyNoticeCopy",
			"inspector": "lEimMq_inspector",
			"inspectorBack": "lEimMq_inspectorBack",
			"inspectorBody": "lEimMq_inspectorBody",
			"inspectorFooter": "lEimMq_inspectorFooter",
			"inspectorHeader": "lEimMq_inspectorHeader",
			"inspectorSummary": "lEimMq_inspectorSummary",
			"inspectorTitle": "lEimMq_inspectorTitle",
			"jsonSurface": "lEimMq_jsonSurface",
			"location": "lEimMq_location",
			"menu": "lEimMq_menu",
			"metrics": "lEimMq_metrics",
			"modelStage": "lEimMq_modelStage",
			"modelStageBar": "lEimMq_modelStageBar",
			"modelStageBody": "lEimMq_modelStageBody",
			"modelStageChevron": "lEimMq_modelStageChevron",
			"modelStageCopy": "lEimMq_modelStageCopy",
			"modelStageGlyph": "lEimMq_modelStageGlyph",
			"modelStageLedger": "lEimMq_modelStageLedger",
			"modelStageMetric": "lEimMq_modelStageMetric",
			"modelStageNote": "lEimMq_modelStageNote",
			"modelStageSummary": "lEimMq_modelStageSummary",
			"modelStageSwatch": "lEimMq_modelStageSwatch",
			"modelStageTitle": "lEimMq_modelStageTitle",
			"modelStageToggle": "lEimMq_modelStageToggle",
			"neutralDot": "lEimMq_neutralDot",
			"now": "lEimMq_now",
			"nowBlock": "lEimMq_nowBlock",
			"occurrence": "lEimMq_occurrence",
			"occurrenceChevron": "lEimMq_occurrenceChevron",
			"occurrenceCopy": "lEimMq_occurrenceCopy",
			"occurrenceDuration": "lEimMq_occurrenceDuration",
			"occurrenceMeta": "lEimMq_occurrenceMeta",
			"occurrences": "lEimMq_occurrences",
			"occurrenceTitle": "lEimMq_occurrenceTitle",
			"overviewOccurrence": "lEimMq_overviewOccurrence",
			"overviewOccurrenceChevron": "lEimMq_overviewOccurrenceChevron",
			"overviewOccurrenceCopy": "lEimMq_overviewOccurrenceCopy",
			"overviewOccurrenceDot": "lEimMq_overviewOccurrenceDot",
			"overviewOccurrenceDotSlot": "lEimMq_overviewOccurrenceDotSlot",
			"overviewOccurrenceDuration": "lEimMq_overviewOccurrenceDuration",
			"overviewOccurrenceIndex": "lEimMq_overviewOccurrenceIndex",
			"overviewOccurrenceMeta": "lEimMq_overviewOccurrenceMeta",
			"overviewOccurrences": "lEimMq_overviewOccurrences",
			"overviewOccurrenceTitle": "lEimMq_overviewOccurrenceTitle",
			"overviewStep": "lEimMq_overviewStep",
			"overviewStepHeader": "lEimMq_overviewStepHeader",
			"overviewStepLabel": "lEimMq_overviewStepLabel",
			"overviewStepSignals": "lEimMq_overviewStepSignals",
			"overviewTag": "lEimMq_overviewTag",
			"parallelLabel": "lEimMq_parallelLabel",
			"patternLabel": "lEimMq_patternLabel",
			"phase": "lEimMq_phase",
			"phaseChevron": "lEimMq_phaseChevron",
			"phaseCopy": "lEimMq_phaseCopy",
			"phaseHeader": "lEimMq_phaseHeader",
			"phaseMarker": "lEimMq_phaseMarker",
			"phaseMeta": "lEimMq_phaseMeta",
			"phaseTitle": "lEimMq_phaseTitle",
			"phaseTitleLine": "lEimMq_phaseTitleLine",
			"phaseToggle": "lEimMq_phaseToggle",
			"pictureHeader": "lEimMq_pictureHeader",
			"railLine": "lEimMq_railLine",
			"railViewport": "lEimMq_railViewport",
			"rawPanel": "lEimMq_rawPanel",
			"rawToolbar": "lEimMq_rawToolbar",
			"reasoningAttempts": "lEimMq_reasoningAttempts",
			"reasoningBody": "lEimMq_reasoningBody",
			"reasoningChevron": "lEimMq_reasoningChevron",
			"reasoningDisclosure": "lEimMq_reasoningDisclosure",
			"reasoningLabel": "lEimMq_reasoningLabel",
			"reasoningMeta": "lEimMq_reasoningMeta",
			"reasoningToggle": "lEimMq_reasoningToggle",
			"root": "lEimMq_root",
			"sectionHeading": "lEimMq_sectionHeading",
			"sessionTiming": "lEimMq_sessionTiming",
			"sessionTimingMetric": "lEimMq_sessionTimingMetric",
			"statusLine": "lEimMq_statusLine",
			"stepBlock": "lEimMq_stepBlock",
			"stepChevron": "lEimMq_stepChevron",
			"stepDuration": "lEimMq_stepDuration",
			"stepHeading": "lEimMq_stepHeading",
			"stepSignals": "lEimMq_stepSignals",
			"stepTimeline": "lEimMq_stepTimeline",
			"stepToggle": "lEimMq_stepToggle",
			"summary": "lEimMq_summary",
			"tab": "lEimMq_tab",
			"tabPanel": "lEimMq_tabPanel",
			"tabs": "lEimMq_tabs",
			"trigger": "lEimMq_trigger",
			"turn": "lEimMq_turn",
			"turnBody": "lEimMq_turnBody",
			"turnChevron": "lEimMq_turnChevron",
			"turnCopy": "lEimMq_turnCopy",
			"turnDuration": "lEimMq_turnDuration",
			"turnHeader": "lEimMq_turnHeader",
			"turnMetric": "lEimMq_turnMetric",
			"turnMetrics": "lEimMq_turnMetrics",
			"turnPerformance": "lEimMq_turnPerformance",
			"turns": "lEimMq_turns",
			"turnSpeed": "lEimMq_turnSpeed",
			"turnSummary": "lEimMq_turnSummary",
			"turnTitle": "lEimMq_turnTitle",
			"turnTitleLine": "lEimMq_turnTitleLine",
			"turnToggle": "lEimMq_turnToggle",
			"unread": "lEimMq_unread",
			"viewControl": "lEimMq_viewControl",
			"viewMode": "lEimMq_viewMode",
			"viewToolbar": "lEimMq_viewToolbar",
			"viewToolbarLabel": "lEimMq_viewToolbarLabel",
			"watcher-eye-blink": "lEimMq_watcher-eye-blink",
			"watcher-eye-scan": "lEimMq_watcher-eye-scan",
			"watcher-live-append": "lEimMq_watcher-live-append",
			"watcher-panel-enter": "lEimMq_watcher-panel-enter",
			"workPicture": "lEimMq_workPicture"
		};
		//#endregion
		...
		*/
		...
		function Watcher(props) {
			if (props.useConversation((state) => state.views.get("chat")) === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				role: "status",
				children: "Watcher 正在等待会话记录…"
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ReadyWatcher, { ...props });
		}
		function ReadyWatcher({ useSession, useConversation, useSessionPendingInteraction, useProjection, sessionId, loadAllHistory }) {
