window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const PRICING_OVERRIDE_FILE = '$DSH_HOME/profiles/web/dsh-watcher-pricing.override.json';
		...
		function pricingTableFrom(override) {
		...
		*/
		...
		var Insights_module_css_default = {
			...
			"heroCost": "o55MTq_heroCost",
			"heroCostHint": "o55MTq_heroCostHint",
			"heroCostLabel": "o55MTq_heroCostLabel",
			"heroCostValue": "o55MTq_heroCostValue",
		...
		*/
		...
		function InsightsSettings(props) {
			...
			const analytics = (0, react.useMemo)(() => {
				...
				const costRows = uniqueModels.length > 0 ? uniqueModels : [{
					model: "未标注",
					tokens: totalTokens,
					input: totalInput,
					output: totalOutput,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								className: Insights_module_css_default.heroMetric,
								title: analytics ? [estimateDisclaimer(locale), formatEstimateNote(analytics.estimatedCost, locale)].filter(Boolean).join(" · ") : copy.estimateNotBill,
								"aria-label": `${copy.estimatedCost}: ${analytics ? formatEstimate(analytics.estimatedCost, locale) : "-"}`,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: Insights_module_css_default.heroCaption,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
										className: Insights_module_css_default.heroValue,
										children: analytics ? formatEstimate(analytics.estimatedCost, locale) : "-"
									}),
									analytics && formatEstimateNote(analytics.estimatedCost, locale) ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: Insights_module_css_default.heroFootnote,
										children: formatEstimateNote(analytics.estimatedCost, locale)
									}) : null
								]
							})]
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
