window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css = ".iDtwVG_panelBox{--c-ttft:#94a3b8;--c-think:#3b82f6;--c-output:#38bdf8;--c-bash:#059669;--c-file:#34d399;box-sizing:border-box;background:var(--dsw-alias-bg-layer-2,#f5f6f8);border:1px solid var(--dsw-alias-border-l2,#e2e8f0);border-radius:8px;width:100%;padding:12px 14px;position:relative}body[data-ds-dark-theme] .iDtwVG_panelBox{--c-ttft:#64748b;--c-think:#60a5fa;--c-output:#38bdf8;--c-bash:#10b981;--c-file:#6ee7b7}.iDtwVG_topRow{justify-content:space-between;align-items:center;gap:8px;margin-bottom:8px;font-size:11px;display:flex}.iDtwVG_titleArea{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.iDtwVG_mainTitle{color:var(--dsw-alias-label-primary,#17181c);white-space:nowrap;font-size:12px;font-weight:700}.iDtwVG_liveSpeed{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e2e8f0);color:var(--dsw-alias-label-primary,#17181c);font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:4px;align-items:center;gap:4px;padding:1px 6px;font-size:10px;font-weight:600;display:inline-flex}.iDtwVG_speedDot{background:var(--c-output);border-radius:50%;width:5px;height:5px;animation:1.5s infinite iDtwVG_pulse}.iDtwVG_totalDuration{color:var(--dsw-alias-label-secondary,#5f636d);font-variant-numeric:tabular-nums;white-space:nowrap}.iDtwVG_bottleneckText{color:var(--dsw-alias-label-primary,#17181c);font-variant-numeric:tabular-nums;white-space:nowrap;flex-shrink:0;font-size:11px;font-weight:600}.iDtwVG_chartBox{width:100%;margin-bottom:8px;position:relative}.iDtwVG_barTrack{background:var(--dsw-alias-bg-layer-1,#e2e8f0);cursor:crosshair;border-radius:5px;gap:1px;width:100%;height:20px;display:flex;overflow:hidden;box-shadow:inset 0 1px 2px #0000000a}.iDtwVG_modelCluster,.iDtwVG_toolCluster{height:100%;transition:opacity .12s;display:flex;position:relative}.iDtwVG_slice{cursor:pointer;height:100%;transition:all .12s;position:relative}.iDtwVG_slice:hover{filter:brightness(1.15);z-index:5;box-shadow:0 0 6px #0003}.iDtwVG_slice+.iDtwVG_slice{border-left:1px solid #ffffff59}.iDtwVG_sliceTtft{background:var(--c-ttft)}.iDtwVG_sliceThink{background:var(--c-think)}.iDtwVG_sliceOutput{background:var(--c-output)}.iDtwVG_sliceBash{background:var(--c-bash)}.iDtwVG_sliceFile{background:var(--c-file)}.iDtwVG_legendRow{color:var(--dsw-alias-label-secondary,#5f636d);flex-wrap:wrap;justify-content:space-between;align-items:center;gap:6px;font-size:11px;display:flex}.iDtwVG_legendGroup{flex-wrap:wrap;align-items:center;gap:12px;display:flex}.iDtwVG_legendItem{cursor:pointer;white-space:nowrap;align-items:center;gap:4px;transition:opacity .12s;display:flex}.iDtwVG_legendItem:hover{opacity:.75}.iDtwVG_dot{border-radius:2px;flex-shrink:0;width:7px;height:7px}.iDtwVG_statusPill{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;gap:4px;padding:1px 7px;font-size:10px;font-weight:600;display:inline-flex}.iDtwVG_statusOk{color:var(--dsw-static-green-500,#15803d)}.iDtwVG_statusWarn{color:#b45309;background:#f59e0b1f}.iDtwVG_statusDanger{color:#b91c1c;background:#ef44441f}.iDtwVG_popover{color:#f8fafc;pointer-events:none;z-index:50;background:#0f172a;border-radius:8px;width:240px;padding:10px 12px;font-size:11px;animation:.12s ease-out iDtwVG_popIn;position:absolute;top:-140px;box-shadow:0 8px 24px #0000004d}.iDtwVG_popover:after{content:\"\";border:5px solid #0000;border-top-color:#0f172a;border-bottom-width:0;position:absolute;bottom:-5px;left:50%;transform:translate(-50%)}.iDtwVG_popTitle{border-bottom:1px solid #ffffff26;justify-content:space-between;margin-bottom:6px;padding-bottom:4px;font-weight:600;display:flex}.iDtwVG_popList{flex-direction:column;gap:3px;display:flex}.iDtwVG_popRow{justify-content:space-between;align-items:center;gap:8px;padding:2px 0;display:flex}.iDtwVG_popLeft{color:#ffffffd9;align-items:center;gap:6px;display:flex}.iDtwVG_popRight{font-variant-numeric:tabular-nums;font-weight:500}.iDtwVG_activeVal{color:#fbbf24;font-weight:700}@keyframes iDtwVG_pulse{0%,to{opacity:1;transform:scale(1)}50%{opacity:.4;transform:scale(.85)}}@keyframes iDtwVG_popIn{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}";
		...
		function TimingPanel({ stats, scope, tokensPerSecond }) {
			const [hoverType, setHoverType] = (0, react.useState)(null);
			...
			const ttftLabel = samples > 1 ? `平均首响应 ${duration(samples ? ttftMs / samples : 0)} (共 ${samples} 次)` : `单次首响应 ${duration(ttftMs)}`;
			let bottleneck = "运行正常";
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						}), hoverType ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: TimingPanel_module_css_default.popover,
							style: { left: `${popoverLeft}px` },
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: TimingPanel_module_css_default.popTitle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: hoverType === "model" ? "模型请求各阶段拆解" : "工具执行耗时排行" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: hoverType === "model" ? `${duration(modelTotalMs)} (${Math.round(modelPct)}%)` : `${duration(toolTotalMs)} (${Math.round(toolPct)}%)` })]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: TimingPanel_module_css_default.popList,
								children: hoverType === "model" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "可见深度推导" })]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: `${TimingPanel_module_css_default.popRight} ${thinkMs >= ttftMs && thinkMs >= outputMs && thinkMs > 0 ? TimingPanel_module_css_default.activeVal : ""}`,
											children: [
												duration(thinkMs),
												" (",
												ttftSubPct + thinkSubPct + outputSubPct > 0 ? Math.round(thinkMs / modelTotalMs * 100) : 0,
												"%)"
											]
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											className: `${TimingPanel_module_css_default.popRight} ${ttftMs > thinkMs && ttftMs > outputMs ? TimingPanel_module_css_default.activeVal : ""}`,
											children: [
												duration(ttftMs),
												" (",
												ttftSubPct,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "正文与代码生成" })]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: `${TimingPanel_module_css_default.popRight} ${outputMs > thinkMs && outputMs > ttftMs ? TimingPanel_module_css_default.activeVal : ""}`,
											children: [
												duration(outputMs),
												" (",
												outputSubPct,
									...
									stats.reasoning ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", {
												className: TimingPanel_module_css_default.dot,
												style: { background: "var(--c-think)" }
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "思考消耗 Token" })]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: TimingPanel_module_css_default.popRight,
											children: [
												fmtNum(stats.reasoning),
												" (",
												stats.output > 0 ? Math.round(stats.reasoning / stats.output * 100) : 0,
												"% 输出)"
											]
										})]
									}) : null
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "终端命令 bash" })]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: `${TimingPanel_module_css_default.popRight} ${bashMs >= fileMs && bashMs > 0 ? TimingPanel_module_css_default.activeVal : ""}`,
											children: [
												duration(bashMs),
												" (",
												bashSubPct,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "文件读写与其它" })]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: `${TimingPanel_module_css_default.popRight} ${fileMs > bashMs ? TimingPanel_module_css_default.activeVal : ""}`,
											children: [
												duration(fileMs),
												" (",
												fileSubPct,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											className: TimingPanel_module_css_default.popLeft,
											children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "总计执行次数" })
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											className: TimingPanel_module_css_default.popRight,
											children: [
												stats.tools,
												" 次 (",
												stats.toolErrors > 0 ? `${stats.toolErrors} 次报错` : "全部成功",
												")"
											]
										})]
									})
		...
		*/
		...
		function Watcher(props) {
			...
			if (chat === void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					disabled: true,
					"aria-label": "Watcher，正在加载会话",
					title: "Watcher · 正在加载会话",
