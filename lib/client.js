window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function computeLineChart(daySeries, width = 560, height = 160) {
			const padding = {
				top: 20,
				right: 20,
				bottom: 28,
			...
			const points = daySeries.map((d, i) => {
				return {
					x: padding.left + i / Math.max(1, daySeries.length - 1) * plotW,
					y: padding.top + plotH - d.total / yMax * plotH,
					data: d,
					index: i
				};
			});
							...
							children: [
								...
								activeViewMode === "bar" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: analytics && analytics.daySeries.length > 0 && (() => {
										...
										const leftPos = hoveredPoint ? Math.min(Math.max(hoveredLineIdx / Math.max(1, lineData.points.length - 1) * 100, 18), 82) : 50;
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [hoveredPoint && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													lineData.points.map((p, idx) => {
														if (!(lineData.points.length <= 10 ? true : idx === 0 || idx === lineData.points.length - 1 || idx % Math.max(1, Math.floor(lineData.points.length / 5)) === 0)) return null;
														...
														return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
															...
															textAnchor: "middle",
															className: Insights_module_css_default.lineAxisText,
															fill: p.data.isToday ? "var(--dsw-static-deepseek-450, #5686fe)" : void 0,
															fontWeight: p.data.isToday ? "700" : void 0,
															children: text
														}, p.data.key);
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
														d: lineData.areaD,
														fill: "url(#dshWatcherLineGrad)"
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
														d: lineData.lineD,
														fill: "none",
													...
													lineData.points.map((p) => p.data.total > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
														cx: p.x,
														cy: p.y,
														r: "2.5",
														fill: "var(--dsw-static-deepseek-450, #5686fe)"
													}, p.data.key) : null),
													hoveredPoint && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
															x1: hoveredPoint.x,
															y1: lineData.padding.top,
															x2: hoveredPoint.x,
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
															...
															cy: hoveredPoint.y,
															r: "6",
															className: Insights_module_css_default.lineActiveOuter
														}),
														/* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
															cx: hoveredPoint.x,
															cy: hoveredPoint.y,
															r: "3.5",
															className: Insights_module_css_default.lineActiveInner
														})
													] })
												]
											})]
