window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region dshx-css-module:src/client/Watcher.module.css.mjs
		const css = ".HxDAdG_root{--watcher-panel-max-height:min(680px, calc(100vh - 112px));--watcher-motion-fast:.14s;--watcher-motion-panel:.18s;--watcher-ease-out:cubic-bezier(.2, .8, .2, 1);position:relative}.HxDAdG_trigger{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:32px;height:32px;color:var(--dsw-alias-label-primary);cursor:pointer;transition:background-color var(--watcher-motion-fast) ease, border-color var(--watcher-motion-fast) ease, color var(--watcher-motion-fast) ease, transform .1s ease;background:0 0;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.HxDAdG_trigger:hover:not(:disabled),.HxDAdG_trigger:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_trigger:active{transform:scale(.96)}.HxDAdG_trigger:focus-visible{outline:2px solid var(--dsw-static-deepseek-450);outline-offset:2px}.HxDAdG_trigger[data-open]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-static-deepseek-450)}.HxDAdG_trigger[data-live]{color:var(--dsw-static-deepseek-450)}.HxDAdG_trigger[data-alert]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_eye,.HxDAdG_eyeBlink,.HxDAdG_eyePupil{transform-box:fill-box;transform-origin:50%;display:block}.HxDAdG_trigger[data-live] .HxDAdG_eyePupil{animation:HxDAdG_watcher-eye-scan 2.8s var(--watcher-ease-out) infinite}.HxDAdG_trigger[data-live] .HxDAdG_eyeBlink{animation:5.2s ease-in-out infinite HxDAdG_watcher-eye-blink}@keyframes HxDAdG_watcher-eye-scan{0%,12%,92%,to{transform:translate(0)}30%{transform:translate(1.35px)}54%{transform:translate(-1.2px)}74%{transform:translate(.8px)}}@keyframes HxDAdG_watcher-eye-blink{0%,42%,44.5%,to{transform:scaleY(1)}43.2%{transform:scaleY(.12)}}.HxDAdG_menu{z-index:1100;--watcher-panel-max-height:min(680px, calc(100vh - 24px));--watcher-motion-fast:.14s;--watcher-motion-panel:.18s;--watcher-ease-out:cubic-bezier(.2, .8, .2, 1);box-sizing:border-box;max-width:calc(100vw - 24px);max-height:var(--watcher-panel-max-height);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-family);transform-origin:100% 0;animation:HxDAdG_watcher-panel-enter var(--watcher-motion-panel) var(--watcher-ease-out);isolation:isolate;border-radius:12px;align-items:stretch;font-size:13px;line-height:20px;display:flex;position:fixed;top:auto;left:auto;right:auto;overflow:hidden}@keyframes HxDAdG_watcher-panel-enter{0%{opacity:0;transform:translateY(-5px)scale(.992)}to{opacity:1;transform:translateY(0)scale(1)}}.HxDAdG_workPicture{width:374px;min-width:0;min-height:290px;max-height:var(--watcher-panel-max-height);background:var(--dsw-specific-menu);flex-direction:column;flex:none;display:flex}.HxDAdG_pictureHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:flex-start;gap:12px;padding:16px 14px 14px 16px;display:flex}.HxDAdG_nowBlock{min-width:0}.HxDAdG_eyebrow{color:var(--dsw-static-deepseek-450);text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:5px;font-size:12px;font-weight:500;line-height:18px;display:flex;overflow:hidden}.HxDAdG_eyebrow[data-alert]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_now{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin-top:2px;font-size:17px;font-weight:600;line-height:24px;overflow:hidden}.HxDAdG_summary{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex-wrap:wrap;align-items:center;margin-top:4px;font-size:12px;line-height:18px;display:flex}.HxDAdG_summary span+span:before{content:\"·\";color:var(--dsw-alias-label-dimmed);margin:0 6px}.HxDAdG_summary [data-partial]{color:var(--dsw-alias-state-warn-primary)}.HxDAdG_sessionTiming{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex:none;grid-template-columns:repeat(3,minmax(0,1fr));margin:0;padding:9px 10px;display:grid}.HxDAdG_sessionTimingMetric{min-width:0;padding:0 8px}.HxDAdG_sessionTimingMetric+.HxDAdG_sessionTimingMetric{border-left:1px solid var(--dsw-alias-border-l2)}.HxDAdG_sessionTimingMetric dt,.HxDAdG_sessionTimingMetric dd{text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.HxDAdG_sessionTimingMetric dt{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.HxDAdG_sessionTimingMetric dd{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;line-height:19px}.HxDAdG_viewToolbar{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);flex-wrap:wrap;flex:none;justify-content:space-between;align-items:center;gap:6px 14px;min-height:42px;padding:6px 14px;display:flex}.HxDAdG_viewControl{align-items:center;gap:6px;min-width:0;display:flex}.HxDAdG_viewToolbarLabel{color:var(--dsw-alias-label-tertiary);white-space:nowrap;font-size:12px;line-height:18px}.HxDAdG_viewMode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:7px;flex:none;grid-template-columns:repeat(2,minmax(42px,1fr));padding:2px;display:inline-grid}.HxDAdG_viewMode button{min-height:26px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:5px;padding:2px 9px;font-size:12px;line-height:18px}.HxDAdG_viewMode button:hover{color:var(--dsw-alias-label-primary)}.HxDAdG_viewMode button[data-active]{background:var(--dsw-specific-menu);box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);font-weight:600}.HxDAdG_historyNotice{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);flex:none;align-items:center;gap:10px;min-height:48px;padding:7px 14px 8px 16px;display:flex}.HxDAdG_historyNoticeCopy{flex-direction:column;flex:1;min-width:0;display:flex}.HxDAdG_historyNoticeCopy strong{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;line-height:18px;overflow:hidden}.HxDAdG_historyNoticeCopy span{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:16px;overflow:hidden}.HxDAdG_historyNotice button{border:1px solid var(--dsw-alias-button-ghost-active-border);background:var(--dsw-specific-menu);min-height:28px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:7px;flex:none;padding:3px 9px;font-size:12px;line-height:18px}.HxDAdG_historyNotice button:hover:not(:disabled){background:var(--dsw-alias-button-ghost-active-hover)}.HxDAdG_historyNotice button:disabled{color:var(--dsw-alias-label-tertiary);cursor:progress}.HxDAdG_follow{white-space:nowrap;flex:none;margin-top:2px}.HxDAdG_unread{border:1px solid var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);width:calc(100% - 28px);min-height:34px;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;border-radius:8px;justify-content:center;align-items:center;gap:6px;margin:10px 14px 0;font-size:12px;display:inline-flex}.HxDAdG_unread:hover{background:var(--dsw-alias-button-ghost-active-hover)}.HxDAdG_unread:focus-visible,.HxDAdG_turnToggle:focus-visible,.HxDAdG_phaseToggle:focus-visible,.HxDAdG_stepToggle:focus-visible,.HxDAdG_analysisClusterToggle:focus-visible,.HxDAdG_modelStageToggle:focus-visible,.HxDAdG_reasoningToggle:focus-visible,.HxDAdG_groupedModelToggle:focus-visible,.HxDAdG_viewMode button:focus-visible,.HxDAdG_historyNotice button:focus-visible,.HxDAdG_overviewOccurrence:focus-visible,.HxDAdG_inspectorBack:focus-visible,.HxDAdG_occurrence:focus-visible,.HxDAdG_tab:focus-visible,.HxDAdG_copyRaw:focus-visible{outline:2px solid var(--dsw-static-deepseek-450);outline-offset:-2px}.HxDAdG_railViewport{overscroll-behavior:contain;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex:1;min-height:0;overflow:auto}.HxDAdG_turns{padding:8px 10px 18px}.HxDAdG_turn+.HxDAdG_turn{border-top:1px solid var(--dsw-alias-border-l2);margin-top:12px;padding-top:12px}.HxDAdG_turnHeader{padding:0 2px 2px}.HxDAdG_turnHeader h2{margin:0}.HxDAdG_turnToggle{box-sizing:border-box;width:100%;min-height:50px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;grid-template-columns:14px minmax(0,1fr) auto;align-items:center;gap:7px;padding:6px 8px;display:grid}.HxDAdG_turnToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_turnChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out);transform:rotate(0)}.HxDAdG_turnToggle[aria-expanded=true] .HxDAdG_turnChevron{transform:rotate(90deg)}.HxDAdG_turnCopy{flex-direction:column;min-width:0;display:flex}.HxDAdG_turnTitleLine{align-items:center;gap:6px;min-width:0;display:flex}.HxDAdG_turnTitle{color:var(--dsw-alias-label-secondary);font-size:13px;font-weight:600;line-height:20px}.HxDAdG_turnSummary,.HxDAdG_turnDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:400;line-height:18px}.HxDAdG_turnSummary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.HxDAdG_turnPerformance{white-space:nowrap;flex-direction:column;align-items:flex-end;min-width:62px;display:flex}.HxDAdG_turnDuration{white-space:nowrap}.HxDAdG_turnSpeed{color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;font-size:12px;font-weight:500;line-height:18px}.HxDAdG_turnMetrics{background:var(--dsw-alias-bg-layer-2);border-radius:7px;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin:2px 8px 9px 36px;padding:7px 9px;display:grid}.HxDAdG_turnMetric{min-width:0}.HxDAdG_turnMetric dt,.HxDAdG_turnMetric dd{text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.HxDAdG_turnMetric dt{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:17px}.HxDAdG_turnMetric dd{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;font-size:13px;font-weight:600;line-height:19px}.HxDAdG_turnBody[hidden]{display:none}.HxDAdG_groupRail{padding-left:18px;position:relative}.HxDAdG_railLine{background:var(--dsw-alias-border-l2);pointer-events:none;width:1px;position:absolute;top:18px;bottom:18px;left:23px}.HxDAdG_phase{z-index:1;box-sizing:border-box;width:100%;padding:3px 0 11px;position:relative}.HxDAdG_phase+.HxDAdG_phase{margin-top:4px}.HxDAdG_phaseHeader{position:relative}.HxDAdG_phaseToggle{box-sizing:border-box;width:100%;min-height:42px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:7px;grid-template-columns:10px 12px minmax(0,1fr);align-items:center;gap:6px;padding:3px 8px 3px 0;display:grid;position:relative}.HxDAdG_phaseToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_phase[data-now]>.HxDAdG_phaseHeader .HxDAdG_phaseToggle{background:var(--dsw-alias-bg-layer-2);border-radius:7px}.HxDAdG_phaseChevron,.HxDAdG_stepChevron,.HxDAdG_analysisClusterChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out);transform:rotate(0)}.HxDAdG_phaseToggle[aria-expanded=true] .HxDAdG_phaseChevron,.HxDAdG_stepToggle[aria-expanded=true] .HxDAdG_stepChevron,.HxDAdG_analysisClusterToggle[aria-expanded=true] .HxDAdG_analysisClusterChevron{transform:rotate(90deg)}.HxDAdG_phaseMarker{box-sizing:border-box;background:var(--dsw-alias-label-tertiary);width:10px;height:10px;box-shadow:0 0 0 4px var(--dsw-specific-menu);border-radius:50%;display:block;position:relative}.HxDAdG_phaseMarker[data-state=active],.HxDAdG_phaseMarker[data-state=current]{background:var(--dsw-static-deepseek-450)}.HxDAdG_phaseMarker[data-state=waiting]{background:var(--dsw-alias-state-warn-primary)}.HxDAdG_phaseMarker[data-state=failure],.HxDAdG_phaseMarker[data-state=interrupted]{background:var(--dsw-alias-state-error-primary)}.HxDAdG_phaseMarker[data-state=partial]{border:1px dashed var(--dsw-alias-label-tertiary);background:var(--dsw-specific-menu)}.HxDAdG_neutralDot{border:1px solid var(--dsw-alias-label-tertiary);background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:10px;height:10px;display:inline-block;position:relative}.HxDAdG_neutralDot[data-status=unknown]{background:var(--dsw-specific-menu);border-style:dashed}.HxDAdG_phaseCopy,.HxDAdG_occurrenceCopy{flex-direction:column;min-width:0;display:flex}.HxDAdG_phaseTitleLine{align-items:center;gap:6px;min-width:0;display:flex}.HxDAdG_phaseTitle{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:550;line-height:21px;overflow:hidden}.HxDAdG_phaseMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;margin-top:1px;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_groupBadges{flex:none;align-items:center;gap:4px;display:inline-flex}.HxDAdG_groupBadges span,.HxDAdG_overviewTag,.HxDAdG_patternLabel,.HxDAdG_parallelLabel{border:1px solid var(--dsw-alias-border-l2);min-height:18px;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;border-radius:999px;align-items:center;padding:0 5px;font-size:11px;font-weight:500;line-height:16px;display:inline-flex}.HxDAdG_groupBadges [data-kind=retry]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_groupBadges [data-kind=parallel],.HxDAdG_overviewTag[data-state=active],.HxDAdG_overviewTag[data-state=current]{color:var(--dsw-static-deepseek-450)}.HxDAdG_overviewTag[data-state=waiting]{color:var(--dsw-alias-state-warn-primary)}.HxDAdG_overviewTag[data-state=failure],.HxDAdG_overviewTag[data-state=interrupted]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_overviewTag[data-state=partial]{color:var(--dsw-alias-label-tertiary)}.HxDAdG_occurrenceChevron{color:var(--dsw-alias-label-dimmed);opacity:0;transition:opacity var(--watcher-motion-fast) ease, transform var(--watcher-motion-fast) ease;flex:none;transform:translate(-2px)}.HxDAdG_occurrence:hover .HxDAdG_occurrenceChevron,.HxDAdG_occurrence[data-selected] .HxDAdG_occurrenceChevron,.HxDAdG_occurrence:focus-visible .HxDAdG_occurrenceChevron{opacity:1;transform:translate(0)}.HxDAdG_stepTimeline{border-left:1px solid var(--dsw-alias-border-l2);margin:1px 8px 0 28px;padding-left:11px;position:relative}.HxDAdG_overviewStep{min-width:0;position:relative}.HxDAdG_overviewStep+.HxDAdG_overviewStep{margin-top:10px;padding-top:8px}.HxDAdG_overviewStep:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:13px;left:-12px}.HxDAdG_overviewStepHeader{min-height:29px}.HxDAdG_stepToggle{box-sizing:border-box;width:100%;min-height:29px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:6px;grid-template-columns:12px minmax(0,1fr) auto;align-items:center;gap:5px;padding:2px 4px 2px 0;display:grid}.HxDAdG_stepToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_overviewStepLabel,.HxDAdG_overviewStepSignals{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px;line-height:18px}.HxDAdG_overviewStepLabel{min-width:0;font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.HxDAdG_overviewStepSignals{white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.HxDAdG_overviewOccurrences{position:relative}.HxDAdG_overviewStep[data-parallel] .HxDAdG_overviewOccurrences{border-left:1px solid var(--dsw-static-deepseek-450);padding-left:5px}.HxDAdG_modelStage{border-left:2px solid var(--dsw-static-deepseek-450);background:var(--dsw-alias-bg-layer-2);border-radius:0 7px 7px 0;min-width:0;margin:2px 2px 7px;overflow:hidden}.HxDAdG_modelStage[data-live]{box-shadow:inset 0 0 0 1px var(--dsw-alias-button-ghost-active-border)}.HxDAdG_modelStageToggle{box-sizing:border-box;width:100%;min-height:42px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px 8px minmax(0,1fr);align-items:center;gap:7px;padding:5px 9px 5px 7px;display:grid}.HxDAdG_modelStageToggle:hover,.HxDAdG_reasoningToggle:hover,.HxDAdG_groupedModelToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_modelStageChevron,.HxDAdG_reasoningChevron,.HxDAdG_groupedModelChevron{color:var(--dsw-alias-label-tertiary);transition:transform var(--watcher-motion-fast) var(--watcher-ease-out)}.HxDAdG_modelStageToggle[aria-expanded=true] .HxDAdG_modelStageChevron,.HxDAdG_reasoningToggle[aria-expanded=true] .HxDAdG_reasoningChevron,.HxDAdG_groupedModelToggle[aria-expanded=true] .HxDAdG_groupedModelChevron{transform:rotate(90deg)}.HxDAdG_modelStageGlyph{background:var(--dsw-static-deepseek-450);width:7px;height:7px;box-shadow:0 0 0 3px var(--dsw-alias-button-ghost-active-fill);border-radius:999px}.HxDAdG_modelStageCopy{grid-template-columns:auto minmax(0,1fr);align-items:baseline;gap:8px;min-width:0;display:grid}.HxDAdG_modelStageTitle{color:var(--dsw-alias-label-primary);white-space:nowrap;font-size:13px;font-weight:600;line-height:20px}.HxDAdG_modelStageSummary{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_modelStageBody{padding:2px 10px 10px 20px}.HxDAdG_modelStageBar{background:var(--dsw-alias-border-l2);border-radius:999px;gap:2px;height:5px;margin:2px 0 10px;display:flex;overflow:hidden}.HxDAdG_modelStageBar>span{border-radius:inherit;min-width:3px}.HxDAdG_modelStageBar [data-segment=wait],.HxDAdG_modelStageSwatch[data-segment=wait]{background:var(--dsw-alias-label-dimmed)}.HxDAdG_modelStageBar [data-segment=reasoning],.HxDAdG_modelStageSwatch[data-segment=reasoning]{background:var(--dsw-static-deepseek-450)}.HxDAdG_modelStageBar [data-segment=output],.HxDAdG_modelStageSwatch[data-segment=output]{background:var(--dsw-alias-label-secondary)}.HxDAdG_modelStageBar [data-segment=unattributed],.HxDAdG_modelStageSwatch[data-segment=unattributed]{background:var(--dsw-alias-state-warn-primary)}.HxDAdG_modelStageLedger{grid-template-columns:minmax(0,1fr);gap:5px 12px;margin:0;display:grid}.HxDAdG_modelStageMetric{min-width:0;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;justify-content:space-between;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.HxDAdG_modelStageMetric dt,.HxDAdG_modelStageMetric dd{margin:0}.HxDAdG_modelStageMetric dt{align-items:center;gap:6px;min-width:0;display:inline-flex}.HxDAdG_modelStageMetric dd{color:var(--dsw-alias-label-secondary);text-align:right;flex:none}.HxDAdG_modelStageSwatch{border-radius:999px;flex:none;width:6px;height:6px}.HxDAdG_modelStageNote{color:var(--dsw-alias-label-tertiary);margin:8px 0 0;font-size:12px;line-height:18px}.HxDAdG_reasoningAttempts{border-top:1px solid var(--dsw-alias-border-l2);margin-top:8px;padding-top:1px}.HxDAdG_reasoningDisclosure{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:6px;min-width:0;margin-top:5px;overflow:hidden}.HxDAdG_reasoningToggle{box-sizing:border-box;width:100%;min-height:34px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px minmax(0,1fr);align-items:center;gap:6px;padding:5px 8px;display:grid}.HxDAdG_reasoningLabel{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:550;line-height:20px}.HxDAdG_reasoningMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-align:left;white-space:normal;grid-column:2;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_reasoningBody{box-sizing:border-box;border-top:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);max-height:320px;color:var(--dsw-alias-label-primary);overflow-wrap:anywhere;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);margin:0;padding:10px 12px;font-size:13px;line-height:1.6;overflow:auto}.HxDAdG_reasoningBody>*{margin-top:0;margin-bottom:8px}.HxDAdG_reasoningBody>:last-child{margin-bottom:0}.HxDAdG_reasoningBody .md-code-block{max-width:100%}.HxDAdG_groupedModelStages{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);border-radius:7px;margin-bottom:9px;position:relative;overflow:hidden}.HxDAdG_groupedModelStages:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:20px;left:-12px}.HxDAdG_groupedModelToggle{box-sizing:border-box;width:100%;min-height:44px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;grid-template-columns:12px minmax(0,1fr);align-items:center;gap:7px;padding:5px 9px;display:grid}.HxDAdG_groupedModelToggle>span{justify-content:space-between;align-items:baseline;gap:10px;min-width:0;display:flex}.HxDAdG_groupedModelToggle strong{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.HxDAdG_groupedModelToggle small{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_groupedModelList{border-top:1px solid var(--dsw-alias-border-l2);padding:0 7px 8px 22px}.HxDAdG_groupedModelStep{min-width:0;padding-top:8px}.HxDAdG_groupedModelStep+.HxDAdG_groupedModelStep{border-top:1px solid var(--dsw-alias-border-l2)}.HxDAdG_groupedModelStepLabel{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);margin:0 2px 4px;font-size:12px;line-height:18px;display:block}.HxDAdG_analysisClusters{border-left:1px solid var(--dsw-alias-border-l2);margin:1px 8px 0 28px;padding-left:11px;position:relative}.HxDAdG_analysisCluster,.HxDAdG_analysisSingleton{min-width:0;position:relative}.HxDAdG_analysisCluster+.HxDAdG_analysisCluster,.HxDAdG_analysisCluster+.HxDAdG_analysisSingleton,.HxDAdG_analysisSingleton+.HxDAdG_analysisCluster,.HxDAdG_analysisSingleton+.HxDAdG_analysisSingleton{margin-top:6px}.HxDAdG_analysisCluster:before,.HxDAdG_analysisSingleton:before{background:var(--dsw-alias-border-l2);content:\"\";width:8px;height:1px;position:absolute;top:20px;left:-12px}.HxDAdG_analysisClusterToggle{box-sizing:border-box;width:100%;min-height:46px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:7px;grid-template-columns:12px 10px minmax(0,1fr) auto;align-items:center;gap:7px;padding:5px 6px 5px 4px;display:grid}.HxDAdG_analysisClusterToggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_analysisCluster[data-open]>.HxDAdG_analysisClusterToggle{border-color:var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2)}.HxDAdG_analysisClusterDotSlot{width:10px;height:10px;display:block;position:relative}.HxDAdG_analysisClusterDot{inset:0;position:absolute!important}.HxDAdG_analysisClusterCopy{flex-direction:column;min-width:0;display:flex}.HxDAdG_analysisClusterTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:550;line-height:20px;overflow:hidden}.HxDAdG_analysisClusterMeta{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_analysisClusterCount{min-width:28px;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;font-size:12px;font-weight:600;line-height:18px}.HxDAdG_analysisClusterItems{border-left:1px solid var(--dsw-alias-border-l2);margin:3px 0 8px 17px;padding-left:5px}.HxDAdG_overviewOccurrence{box-sizing:border-box;width:100%;min-height:45px;color:inherit;font:inherit;text-align:left;cursor:pointer;transition:background-color var(--watcher-motion-fast) var(--watcher-ease-out), border-color var(--watcher-motion-fast) var(--watcher-ease-out), box-shadow var(--watcher-motion-fast) var(--watcher-ease-out);animation:HxDAdG_watcher-live-append var(--watcher-motion-fast) var(--watcher-ease-out);background:0 0;border:1px solid #0000;border-radius:7px;grid-template-columns:22px 10px minmax(0,1fr) auto 12px;align-items:center;gap:7px;padding:5px 5px 5px 7px;display:grid;position:relative}.HxDAdG_overviewOccurrence+.HxDAdG_overviewOccurrence{margin-top:2px}.HxDAdG_overviewOccurrence:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_overviewOccurrence[data-current]:not([data-selected]){background:var(--dsw-alias-bg-layer-2)}.HxDAdG_overviewOccurrence[data-selected]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill);box-shadow:inset 2px 0 0 var(--dsw-static-deepseek-450)}.HxDAdG_overviewOccurrenceIndex{color:var(--dsw-alias-label-dimmed);font-family:var(--dsw-font-mono);font-variant-numeric:tabular-nums;text-align:right;font-size:11px;line-height:18px}.HxDAdG_overviewOccurrenceDotSlot{width:10px;height:10px;display:block;position:relative}.HxDAdG_overviewOccurrenceDot{inset:0;position:absolute!important}.HxDAdG_overviewOccurrenceCopy{flex-direction:column;min-width:0;display:flex}.HxDAdG_overviewOccurrenceTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:550;line-height:20px;overflow:hidden}.HxDAdG_overviewOccurrenceMeta{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_overviewOccurrenceDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:12px;line-height:18px}.HxDAdG_overviewOccurrenceChevron{color:var(--dsw-alias-label-dimmed);opacity:0;transition:opacity var(--watcher-motion-fast) ease, transform var(--watcher-motion-fast) ease;transform:translate(-2px)}.HxDAdG_overviewOccurrence:hover .HxDAdG_overviewOccurrenceChevron,.HxDAdG_overviewOccurrence[data-selected] .HxDAdG_overviewOccurrenceChevron,.HxDAdG_overviewOccurrence:focus-visible .HxDAdG_overviewOccurrenceChevron{opacity:1;transform:translate(0)}@keyframes HxDAdG_watcher-live-append{0%{opacity:.5;transform:translateY(-2px)}to{opacity:1;transform:translateY(0)}}.HxDAdG_empty{min-height:250px;color:var(--dsw-alias-label-tertiary);text-align:center;flex-direction:column;flex:1;justify-content:center;align-items:center;padding:28px;display:flex}.HxDAdG_emptyEye{color:var(--dsw-alias-label-secondary);margin-bottom:12px;display:inline-flex}.HxDAdG_empty strong{color:var(--dsw-alias-label-secondary);font-size:14px;font-weight:600;line-height:21px}.HxDAdG_empty>span:last-child{margin-top:4px;font-size:12px;line-height:18px}.HxDAdG_inspector{width:438px;min-width:0;max-height:var(--watcher-panel-max-height);border-right:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;display:flex}.HxDAdG_inspectorHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;padding:16px 16px 14px}.HxDAdG_inspectorBack{min-height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:5px;margin:-4px 0 8px -6px;padding:0 7px 0 5px;font-size:12px;display:none}.HxDAdG_inspectorBack:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_inspectorBack svg{transform:rotate(180deg)}.HxDAdG_statusLine,.HxDAdG_detailStatus{color:var(--dsw-alias-label-secondary);align-items:center;gap:7px;font-size:12px;line-height:18px;display:flex}.HxDAdG_statusLine[data-status=failure],.HxDAdG_statusLine[data-status=interrupted],.HxDAdG_detailStatus[data-status=failure],.HxDAdG_detailStatus[data-status=interrupted]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_statusLine[data-status=running],.HxDAdG_detailStatus[data-status=running]{color:var(--dsw-static-deepseek-450)}.HxDAdG_statusLine[data-status=waiting],.HxDAdG_detailStatus[data-status=waiting]{color:var(--dsw-alias-state-warn-primary)}.HxDAdG_location{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;margin-left:auto}.HxDAdG_inspectorTitle{color:var(--dsw-alias-label-primary);margin:8px 0 0;font-size:18px;font-weight:600;line-height:25px}.HxDAdG_inspectorSummary{color:var(--dsw-alias-label-tertiary);margin:3px 0 0;font-size:12px;line-height:18px}.HxDAdG_groupSignals{flex-wrap:wrap;gap:6px;margin-top:10px;display:flex}.HxDAdG_groupSignals span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px}.HxDAdG_groupSignals span+span:before{content:\"·\";color:var(--dsw-alias-label-dimmed);margin-right:6px}.HxDAdG_groupSignals [data-retry]{color:var(--dsw-alias-state-warn-primary)}.HxDAdG_groupSignals [data-error]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_inspectorBody{overscroll-behavior:contain;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex:1;min-height:0;overflow:auto}.HxDAdG_executionSection{border-bottom:1px solid var(--dsw-alias-border-l2);padding:14px 16px 16px}.HxDAdG_sectionHeading{justify-content:space-between;align-items:center;gap:12px;margin-bottom:8px;display:flex}.HxDAdG_sectionHeading h3{color:var(--dsw-alias-label-secondary);margin:0;font-size:13px;font-weight:600;line-height:20px}.HxDAdG_sectionHeading>span{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;font-size:12px}.HxDAdG_executionList{max-height:188px;padding-right:2px;overflow:auto}.HxDAdG_stepBlock+.HxDAdG_stepBlock{border-top:1px solid var(--dsw-alias-border-l2);margin-top:10px;padding-top:10px}.HxDAdG_stepHeading{min-height:22px;color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);font-variant-numeric:tabular-nums;justify-content:space-between;align-items:center;gap:8px;padding:0 3px;font-size:12px;display:flex}.HxDAdG_stepSignals{align-items:center;gap:6px;min-width:0;display:inline-flex}.HxDAdG_stepDuration{color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-family);font-variant-numeric:tabular-nums;white-space:nowrap}.HxDAdG_parallelLabel{color:var(--dsw-static-deepseek-450);font-family:var(--dsw-font-family)}.HxDAdG_occurrences{margin-top:4px;position:relative}.HxDAdG_stepBlock[data-parallel] .HxDAdG_occurrences{border-left:1px solid var(--dsw-static-deepseek-450);padding-left:10px}.HxDAdG_occurrence{box-sizing:border-box;width:100%;min-height:46px;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:8px;grid-template-columns:10px minmax(0,1fr) auto 13px;align-items:center;gap:8px;padding:6px 7px;transition:background-color .14s,border-color .14s;display:grid}.HxDAdG_occurrenceDuration{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;white-space:nowrap;font-size:12px;line-height:18px}.HxDAdG_occurrence+.HxDAdG_occurrence{margin-top:2px}.HxDAdG_occurrence:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_occurrence[data-selected]{border-color:var(--dsw-alias-button-ghost-active-border);background:var(--dsw-alias-button-ghost-active-fill)}.HxDAdG_occurrenceTitle{color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:550;line-height:19px;overflow:hidden}.HxDAdG_occurrenceMeta{color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.HxDAdG_detailSection{padding:16px}.HxDAdG_detailHeader{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:14px;display:grid}.HxDAdG_detailIdentity{min-width:0}.HxDAdG_detailIdentity h3{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);margin:6px 0 0;font-size:16px;font-weight:600;line-height:23px}.HxDAdG_detailIdentity p{overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font-family:var(--dsw-font-mono);margin:3px 0 0;font-size:12px;line-height:18px}.HxDAdG_patternLabel{color:var(--dsw-alias-state-warn-primary)}.HxDAdG_metrics{font-variant-numeric:tabular-nums;grid-template-columns:auto auto;gap:2px 8px;margin:0;font-size:12px;line-height:18px;display:grid}.HxDAdG_metrics dt{color:var(--dsw-alias-label-tertiary)}.HxDAdG_metrics dd{color:var(--dsw-alias-label-secondary);text-align:right;margin:0}.HxDAdG_metrics [data-error]{color:var(--dsw-alias-state-error-primary)}.HxDAdG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:end;gap:4px;margin-top:16px;display:flex}.HxDAdG_tab{min-width:56px;min-height:36px;color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:0 10px;font-size:13px;position:relative}.HxDAdG_tab:hover{color:var(--dsw-alias-label-primary)}.HxDAdG_tab[data-active]{color:var(--dsw-alias-label-primary);font-weight:600}.HxDAdG_tab[data-active]:after{content:\"\";background:var(--dsw-static-deepseek-450);border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:9px;right:9px}.HxDAdG_tabPanel{--dsl-terminal-font:400 13px/22px var(--dsw-font-mono);min-height:116px;padding-top:12px}.HxDAdG_tabPanel>*{margin-top:0;margin-bottom:0}.HxDAdG_jsonSurface{font-size:13px;overflow:auto}.HxDAdG_jsonSurface [role=tree]{font-size:13px;line-height:20px}.HxDAdG_rawPanel pre{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary);font-family:var(--dsw-font-mono);tab-size:2;margin:0;font-size:13px;line-height:20px;overflow:auto}.HxDAdG_documentResult{min-width:0;color:var(--dsw-alias-label-primary);padding:2px 2px 8px}.HxDAdG_documentResult .md-code-block{max-width:100%}.HxDAdG_documentResult blockquote{color:var(--dsw-alias-label-secondary)}.HxDAdG_documentResult table{font-variant-numeric:tabular-nums}.HxDAdG_rawPanel{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);border-radius:8px;overflow:hidden}.HxDAdG_rawToolbar{border-bottom:1px solid var(--dsw-alias-border-l2);min-height:38px;color:var(--dsw-alias-label-tertiary);justify-content:space-between;align-items:center;gap:12px;padding:0 10px 0 12px;font-size:12px;display:flex}.HxDAdG_copyRaw{min-height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:5px;padding:0 6px;font-size:12px;display:inline-flex}.HxDAdG_copyRaw:hover{background:var(--dsw-alias-interactive-bg-hover)}.HxDAdG_rawPanel pre{white-space:pre;max-height:320px;padding:12px}.HxDAdG_artifactResult,.HxDAdG_detailEmpty{border:1px solid var(--dsw-alias-border-l2);min-height:116px;color:var(--dsw-alias-label-tertiary);text-align:center;border-radius:8px;flex-direction:column;justify-content:center;align-items:center;padding:18px;font-size:13px;display:flex}.HxDAdG_artifactResult strong{color:var(--dsw-alias-label-secondary);margin-top:6px;font-size:14px}.HxDAdG_artifactResult>span{margin-top:2px;font-size:12px}.HxDAdG_artifactResult .HxDAdG_jsonSurface{text-align:left;width:100%;margin-top:12px}.HxDAdG_artifactGlyph{color:var(--dsw-static-deepseek-450);font-size:24px;line-height:28px}.HxDAdG_inspectorFooter{border-top:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);flex:none;padding:9px 16px;font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.HxDAdG_menu,.HxDAdG_trigger[data-live] .HxDAdG_eyePupil,.HxDAdG_trigger[data-live] .HxDAdG_eyeBlink{animation:none}.HxDAdG_trigger,.HxDAdG_overviewOccurrence,.HxDAdG_turnChevron,.HxDAdG_phaseChevron,.HxDAdG_stepChevron,.HxDAdG_analysisClusterChevron,.HxDAdG_modelStageChevron,.HxDAdG_reasoningChevron,.HxDAdG_groupedModelChevron,.HxDAdG_occurrence,.HxDAdG_overviewOccurrenceChevron,.HxDAdG_occurrenceChevron{transition-duration:.01ms}.HxDAdG_overviewOccurrence{animation:none}.HxDAdG_root [data-state=ongoing] rect,.HxDAdG_menu [data-state=ongoing] rect{opacity:.55;animation:none!important}}@media (width<=860px){.HxDAdG_menu{flex-direction:column-reverse;width:min(500px,100vw - 24px);max-height:calc(100vh - 88px)}.HxDAdG_workPicture{width:auto;min-height:250px;max-height:none}.HxDAdG_menu:not(:has(.HxDAdG_inspector)){height:min(680px,100vh - 88px)}.HxDAdG_menu:not(:has(.HxDAdG_inspector)) .HxDAdG_workPicture{flex:auto}.HxDAdG_inspector{border-right:0;width:auto;max-height:none}.HxDAdG_menu:has(.HxDAdG_inspector){height:min(680px,100vh - 88px)}.HxDAdG_menu:has(.HxDAdG_inspector) .HxDAdG_workPicture{display:none}.HxDAdG_menu:has(.HxDAdG_inspector) .HxDAdG_inspector{flex:auto;min-height:0;max-height:none}.HxDAdG_inspectorBack{display:inline-flex}.HxDAdG_inspectorHeader{padding-top:14px}.HxDAdG_executionList{max-height:150px}}@media (width<=520px){.HxDAdG_menu{width:calc(100vw - 24px)}.HxDAdG_pictureHeader{padding:14px 12px}.HxDAdG_now{font-size:16px}.HxDAdG_turns{padding-inline:6px}.HxDAdG_groupBadges span:nth-child(n+2){display:none}.HxDAdG_inspectorHeader,.HxDAdG_executionSection,.HxDAdG_detailSection{padding-inline:12px}.HxDAdG_detailHeader{grid-template-columns:1fr}.HxDAdG_metrics{grid-template-columns:auto 1fr}.HxDAdG_metrics dd{text-align:left}.HxDAdG_modelStageCopy{grid-template-columns:1fr;gap:0}.HxDAdG_modelStageSummary{white-space:normal}.HxDAdG_modelStageLedger{grid-template-columns:1fr}.HxDAdG_reasoningToggle{grid-template-columns:12px minmax(0,1fr)}.HxDAdG_reasoningMeta{text-align:left;white-space:normal;grid-column:2}.HxDAdG_groupedModelToggle>span{gap:0;display:grid}.HxDAdG_groupedModelToggle small{white-space:normal}.HxDAdG_groupedModelList{padding-left:12px}}";
		...
		var Watcher_module_css_default = {
			"analysisCluster": "HxDAdG_analysisCluster",
			"analysisClusterChevron": "HxDAdG_analysisClusterChevron",
			"analysisClusterCopy": "HxDAdG_analysisClusterCopy",
			"analysisClusterCount": "HxDAdG_analysisClusterCount",
			"analysisClusterDot": "HxDAdG_analysisClusterDot",
			"analysisClusterDotSlot": "HxDAdG_analysisClusterDotSlot",
			"analysisClusterItems": "HxDAdG_analysisClusterItems",
			"analysisClusterMeta": "HxDAdG_analysisClusterMeta",
			"analysisClusters": "HxDAdG_analysisClusters",
			"analysisClusterTitle": "HxDAdG_analysisClusterTitle",
			"analysisClusterToggle": "HxDAdG_analysisClusterToggle",
			"analysisSingleton": "HxDAdG_analysisSingleton",
			"artifactGlyph": "HxDAdG_artifactGlyph",
			"artifactResult": "HxDAdG_artifactResult",
			"copyRaw": "HxDAdG_copyRaw",
			"detailEmpty": "HxDAdG_detailEmpty",
			"detailHeader": "HxDAdG_detailHeader",
			"detailIdentity": "HxDAdG_detailIdentity",
			"detailSection": "HxDAdG_detailSection",
			"detailStatus": "HxDAdG_detailStatus",
			"documentResult": "HxDAdG_documentResult",
			"empty": "HxDAdG_empty",
			"emptyEye": "HxDAdG_emptyEye",
			"executionList": "HxDAdG_executionList",
			"executionSection": "HxDAdG_executionSection",
			"eye": "HxDAdG_eye",
			"eyeBlink": "HxDAdG_eyeBlink",
			"eyebrow": "HxDAdG_eyebrow",
			"eyePupil": "HxDAdG_eyePupil",
			"follow": "HxDAdG_follow",
			"groupBadges": "HxDAdG_groupBadges",
			"groupedModelChevron": "HxDAdG_groupedModelChevron",
			"groupedModelList": "HxDAdG_groupedModelList",
			"groupedModelStages": "HxDAdG_groupedModelStages",
			"groupedModelStep": "HxDAdG_groupedModelStep",
			"groupedModelStepLabel": "HxDAdG_groupedModelStepLabel",
			"groupedModelToggle": "HxDAdG_groupedModelToggle",
			"groupRail": "HxDAdG_groupRail",
			"groupSignals": "HxDAdG_groupSignals",
			"historyNotice": "HxDAdG_historyNotice",
			"historyNoticeCopy": "HxDAdG_historyNoticeCopy",
			"inspector": "HxDAdG_inspector",
			"inspectorBack": "HxDAdG_inspectorBack",
			"inspectorBody": "HxDAdG_inspectorBody",
			"inspectorFooter": "HxDAdG_inspectorFooter",
			"inspectorHeader": "HxDAdG_inspectorHeader",
			"inspectorSummary": "HxDAdG_inspectorSummary",
			"inspectorTitle": "HxDAdG_inspectorTitle",
			"jsonSurface": "HxDAdG_jsonSurface",
			"location": "HxDAdG_location",
			"menu": "HxDAdG_menu",
			"metrics": "HxDAdG_metrics",
			"modelStage": "HxDAdG_modelStage",
			"modelStageBar": "HxDAdG_modelStageBar",
			"modelStageBody": "HxDAdG_modelStageBody",
			"modelStageChevron": "HxDAdG_modelStageChevron",
			"modelStageCopy": "HxDAdG_modelStageCopy",
			"modelStageGlyph": "HxDAdG_modelStageGlyph",
			"modelStageLedger": "HxDAdG_modelStageLedger",
			"modelStageMetric": "HxDAdG_modelStageMetric",
			"modelStageNote": "HxDAdG_modelStageNote",
			"modelStageSummary": "HxDAdG_modelStageSummary",
			"modelStageSwatch": "HxDAdG_modelStageSwatch",
			"modelStageTitle": "HxDAdG_modelStageTitle",
			"modelStageToggle": "HxDAdG_modelStageToggle",
			"neutralDot": "HxDAdG_neutralDot",
			"now": "HxDAdG_now",
			"nowBlock": "HxDAdG_nowBlock",
			"occurrence": "HxDAdG_occurrence",
			"occurrenceChevron": "HxDAdG_occurrenceChevron",
			"occurrenceCopy": "HxDAdG_occurrenceCopy",
			"occurrenceDuration": "HxDAdG_occurrenceDuration",
			"occurrenceMeta": "HxDAdG_occurrenceMeta",
			"occurrences": "HxDAdG_occurrences",
			"occurrenceTitle": "HxDAdG_occurrenceTitle",
			"overviewOccurrence": "HxDAdG_overviewOccurrence",
			"overviewOccurrenceChevron": "HxDAdG_overviewOccurrenceChevron",
			"overviewOccurrenceCopy": "HxDAdG_overviewOccurrenceCopy",
			"overviewOccurrenceDot": "HxDAdG_overviewOccurrenceDot",
			"overviewOccurrenceDotSlot": "HxDAdG_overviewOccurrenceDotSlot",
			"overviewOccurrenceDuration": "HxDAdG_overviewOccurrenceDuration",
			"overviewOccurrenceIndex": "HxDAdG_overviewOccurrenceIndex",
			"overviewOccurrenceMeta": "HxDAdG_overviewOccurrenceMeta",
			"overviewOccurrences": "HxDAdG_overviewOccurrences",
			"overviewOccurrenceTitle": "HxDAdG_overviewOccurrenceTitle",
			"overviewStep": "HxDAdG_overviewStep",
			"overviewStepHeader": "HxDAdG_overviewStepHeader",
			"overviewStepLabel": "HxDAdG_overviewStepLabel",
			"overviewStepSignals": "HxDAdG_overviewStepSignals",
			"overviewTag": "HxDAdG_overviewTag",
			"parallelLabel": "HxDAdG_parallelLabel",
			"patternLabel": "HxDAdG_patternLabel",
			"phase": "HxDAdG_phase",
			"phaseChevron": "HxDAdG_phaseChevron",
			"phaseCopy": "HxDAdG_phaseCopy",
			"phaseHeader": "HxDAdG_phaseHeader",
			"phaseMarker": "HxDAdG_phaseMarker",
			"phaseMeta": "HxDAdG_phaseMeta",
			"phaseTitle": "HxDAdG_phaseTitle",
			"phaseTitleLine": "HxDAdG_phaseTitleLine",
			"phaseToggle": "HxDAdG_phaseToggle",
			"pictureHeader": "HxDAdG_pictureHeader",
			"railLine": "HxDAdG_railLine",
			"railViewport": "HxDAdG_railViewport",
			"rawPanel": "HxDAdG_rawPanel",
			"rawToolbar": "HxDAdG_rawToolbar",
			"reasoningAttempts": "HxDAdG_reasoningAttempts",
			"reasoningBody": "HxDAdG_reasoningBody",
			"reasoningChevron": "HxDAdG_reasoningChevron",
			"reasoningDisclosure": "HxDAdG_reasoningDisclosure",
			"reasoningLabel": "HxDAdG_reasoningLabel",
			"reasoningMeta": "HxDAdG_reasoningMeta",
			"reasoningToggle": "HxDAdG_reasoningToggle",
			"root": "HxDAdG_root",
			"sectionHeading": "HxDAdG_sectionHeading",
			"sessionTiming": "HxDAdG_sessionTiming",
			"sessionTimingMetric": "HxDAdG_sessionTimingMetric",
			"statusLine": "HxDAdG_statusLine",
			"stepBlock": "HxDAdG_stepBlock",
			"stepChevron": "HxDAdG_stepChevron",
			"stepDuration": "HxDAdG_stepDuration",
			"stepHeading": "HxDAdG_stepHeading",
			"stepSignals": "HxDAdG_stepSignals",
			"stepTimeline": "HxDAdG_stepTimeline",
			"stepToggle": "HxDAdG_stepToggle",
			"summary": "HxDAdG_summary",
			"tab": "HxDAdG_tab",
			"tabPanel": "HxDAdG_tabPanel",
			"tabs": "HxDAdG_tabs",
			"trigger": "HxDAdG_trigger",
			"turn": "HxDAdG_turn",
			"turnBody": "HxDAdG_turnBody",
			"turnChevron": "HxDAdG_turnChevron",
			"turnCopy": "HxDAdG_turnCopy",
			"turnDuration": "HxDAdG_turnDuration",
			"turnHeader": "HxDAdG_turnHeader",
			"turnMetric": "HxDAdG_turnMetric",
			"turnMetrics": "HxDAdG_turnMetrics",
			"turnPerformance": "HxDAdG_turnPerformance",
			"turns": "HxDAdG_turns",
			"turnSpeed": "HxDAdG_turnSpeed",
			"turnSummary": "HxDAdG_turnSummary",
			"turnTitle": "HxDAdG_turnTitle",
			"turnTitleLine": "HxDAdG_turnTitleLine",
			"turnToggle": "HxDAdG_turnToggle",
			"unread": "HxDAdG_unread",
			"viewControl": "HxDAdG_viewControl",
			"viewMode": "HxDAdG_viewMode",
			"viewToolbar": "HxDAdG_viewToolbar",
			"viewToolbarLabel": "HxDAdG_viewToolbarLabel",
			"watcher-eye-blink": "HxDAdG_watcher-eye-blink",
			"watcher-eye-scan": "HxDAdG_watcher-eye-scan",
			"watcher-live-append": "HxDAdG_watcher-live-append",
			"watcher-panel-enter": "HxDAdG_watcher-panel-enter",
			"workPicture": "HxDAdG_workPicture"
		};
		//#endregion
		...
		*/
		...
		function Watcher({ useSession, useConversation, useSessionPendingInteraction, useProjection, sessionId, loadAllHistory }) {
