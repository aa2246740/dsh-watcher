...
test('the Markdown reader is supplied through the declared client injection', async () => {
  ...
  assert.equal(pkg.peerDependencies['@deepseek-ai/dsh-client-ui-primitives'], '^0.1.5-rc.1')
})
